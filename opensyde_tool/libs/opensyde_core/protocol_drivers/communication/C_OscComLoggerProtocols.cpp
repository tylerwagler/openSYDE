 ...
 */
//----------------------------------------------------------------------------------------------------------------------
C_OscComLoggerProtocols::C_OscComLoggerProtocols(void) : C_CanMonProtocols() {
  // Reassign the openSYDE protocol with the derived variant with system
  // definition interpretation
  this->mapc_Protocols[eCMON_L7_PROTOCOL_OPEN_SYDE] =
      &mc_ProtocolOpenSydeExtended;
}

//----------------------------------------------------------------------------------------------------------------------
/*! \brief   Converts a CAN message to a protocol specific string

   If the message does not match the configured protocol, an empty string will
   be returned. No 'Layer 2 protocol' string conversion will be made if an
...
*/
//----------------------------------------------------------------------------------------------------------------------
QString C_OscComLoggerProtocols::MessageToStringProtocolOnly(
...
*/
//----------------------------------------------------------------------------------------------------------------------
void C_OscComLoggerProtocols::AddOsySysDef(
...
*/
//----------------------------------------------------------------------------------------------------------------------
void C_OscComLoggerProtocols::RemoveOsySysDef(
    const C_OscComMessageLoggerOsySysDefConfig *const opc_SysDefConfig) {
