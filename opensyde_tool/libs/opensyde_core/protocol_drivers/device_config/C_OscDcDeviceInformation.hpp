...
public:
  ...
  void SetDeviceName(const QString &orc_DeviceName);
  ...
  void SetExtendedInfo(const uint8_t ou8_SubNodeId,
                       const bool oq_SecurityActivated);
...
public:
  ...
  C_OscDcDeviceOldComConfig &
  operator=(const C_OscDcDeviceOldComConfig &orc_Source);
