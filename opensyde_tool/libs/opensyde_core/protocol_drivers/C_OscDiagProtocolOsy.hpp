...
//----------------------------------------------------------------------------------------------------------------------
/// interface class
class C_OscDiagProtocolOsy : public C_OscDiagProtocolBase,
...
private:
  ...
  C_OscDiagProtocolOsy &
  operator=(const C_OscDiagProtocolOsy
...
public:
  ...
  // this is intended to implement the pure virtual function from
