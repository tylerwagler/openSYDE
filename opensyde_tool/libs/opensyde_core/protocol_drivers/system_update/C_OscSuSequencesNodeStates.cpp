...
C_OscSuSequencesNodeFileStates::C_OscSuSequencesNodeFileStates(void)
    : c_FileName(""), e_FileExists(eSUSEQ_STATE_NOT_EXECUTED),
 ...
 */
//----------------------------------------------------------------------------------------------------------------------
C_OscSuSequencesNodeStwFlHexFileStates::C_OscSuSequencesNodeStwFlHexFileStates(
    void)
    : C_OscSuSequencesNodeFileStates(), e_FileSent(eSUSEQ_STATE_NOT_EXECUTED) {}
...
C_OscSuSequencesNodeStates::C_OscSuSequencesNodeStates(void)
    : q_Timeout(false), q_AuthenticationError(false),
      q_CouldNotReachedDueToRoutingError(false), q_RoutingNodeError(false) {}
...
C_OscSuSequencesNodeConnectStates::C_OscSuSequencesNodeConnectStates(void)
    : C_OscSuSequencesNodeStates(),
      ...
      q_AuthenticationNecessarySet(false), q_AuthenticationNecessary(false) {}
