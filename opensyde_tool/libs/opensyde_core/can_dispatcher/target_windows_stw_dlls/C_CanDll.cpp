...
/*!
   ...
   Class implementing an interface to communication driver DLLs in the
   STW-CAN-DLL format. Encapsulates dynamic loading and handling of the DLL.
   Concurrent access to the DLL from multiple threads is blocked by a critical
   section.

   The public functions are directly rerouted to the corresponding DLL
   functions. A return value of stw_errors::C_NOACT signals that the requested
   function is not available in the loaded DLL.

   For a detailed description of the underlying DLL-functions cf. the
   STW-comm-DLL specification.

   \copyright   Copyright 2008 Sensor-Technik Wiedemann GmbH. All rights
   reserved.
*/
//----------------------------------------------------------------------------------------------------------------------
...
// lint -esym(1565,"stw::can::C_CAN_DLL::mt_Lock") //properly initialized by
// constructor
...
int32_t C_CanDll::m_Init(const char_t *const opcn_DllPath) {
  ...
  {
    // Using intermediate casts to "void (*)(void)" is a workaround for a GCC
    // >= 8.1(?) compiler warning regarding
    //  incompatible function types (while still being compatible with other
    //  compilers)
    // lint -save -e929  //casting the result of GetProcAddress is the only way
    // to convert into a function pointer
    ...
    mpr_CAN_Bitrate =
        reinterpret_cast<PR_CAN_BITRATE>(reinterpret_cast<void (*)(void)>(
            GetProcAddress(mpv_DLL, "CAN_Bitrate")));
    mpr_CAN_Read_Msg =
        reinterpret_cast<PR_CAN_READ_MSG>(reinterpret_cast<void (*)(void)>(
            GetProcAddress(mpv_DLL, "CAN_Read_Msg")));
    mpr_CAN_Send_Msg =
        reinterpret_cast<PR_CAN_SEND_MSG>(reinterpret_cast<void (*)(void)>(
            GetProcAddress(mpv_DLL, "CAN_Send_Msg")));
    mpr_CAN_Send_RTR =
        reinterpret_cast<PR_CAN_SEND_RTR>(reinterpret_cast<void (*)(void)>(
            GetProcAddress(mpv_DLL, "CAN_Send_RTR")));
    ...
    mpr_CAN_InterfaceSetup = reinterpret_cast<PR_CAN_INTERFACESETUP>(
        reinterpret_cast<void (*)(void)>(
            GetProcAddress(mpv_DLL, "CAN_InterfaceSetup")));

    //"optional" functions:
    mpr_CAN_Status =
        reinterpret_cast<PR_CAN_STATUS>(reinterpret_cast<void (*)(void)>(
            GetProcAddress(mpv_DLL, "CAN_Status")));
    mpr_CAN_DLL_Info =
        reinterpret_cast<PR_CAN_DLL_INFO>(reinterpret_cast<void (*)(void)>(
            GetProcAddress(mpv_DLL, "CAN_DLL_Info")));
    mpr_CAN_Read_extMsg =
        reinterpret_cast<PR_CAN_READ_EXTMSG>(reinterpret_cast<void (*)(void)>(
            GetProcAddress(mpv_DLL, "CAN_Read_extMsg")));
    mpr_CAN_Send_extMsg =
        reinterpret_cast<PR_CAN_SEND_EXTMSG>(reinterpret_cast<void (*)(void)>(
            GetProcAddress(mpv_DLL, "CAN_Send_extMsg")));
    mpr_CAN_Send_extRTR =
        reinterpret_cast<PR_CAN_SEND_EXTRTR>(reinterpret_cast<void (*)(void)>(
            GetProcAddress(mpv_DLL, "CAN_Send_extRTR")));
    mpr_CAN_Init_One_ID =
        reinterpret_cast<PR_CAN_INIT_ONE_ID>(reinterpret_cast<void (*)(void)>(
            GetProcAddress(mpv_DLL, "CAN_Init_One_ID")));

    // new style "ext" functions:
    mpr_CANext_Init =
        reinterpret_cast<PR_CANext_Init>(reinterpret_cast<void (*)(void)>(
            GetProcAddress(mpv_DLL, "CANext_Init")));
    mpr_CANext_Exit =
        reinterpret_cast<PR_CANext_Exit>(reinterpret_cast<void (*)(void)>(
            GetProcAddress(mpv_DLL, "CANext_Exit")));
    mpr_CANext_Bitrate =
        reinterpret_cast<PR_CANext_Bitrate>(reinterpret_cast<void (*)(void)>(
            GetProcAddress(mpv_DLL, "CANext_Bitrate")));
    mpr_CANext_Read_Msg =
        reinterpret_cast<PR_CANext_Read_Msg>(reinterpret_cast<void (*)(void)>(
            GetProcAddress(mpv_DLL, "CANext_Read_Msg")));
    mpr_CANext_Send_Msg =
        reinterpret_cast<PR_CANext_Send_Msg>(reinterpret_cast<void (*)(void)>(
            GetProcAddress(mpv_DLL, "CANext_Send_Msg")));
    mpr_CANext_InterfaceSetup = reinterpret_cast<PR_CANext_InterfaceSetup>(
        reinterpret_cast<void (*)(void)>(
            GetProcAddress(mpv_DLL, "CANext_InterfaceSetup")));
    mpr_CANext_Status =
        reinterpret_cast<PR_CANext_Status>(reinterpret_cast<void (*)(void)>(
            GetProcAddress(mpv_DLL, "CANext_Status")));
    mpr_CANext_Init_One_ID = reinterpret_cast<PR_CANext_Init_One_ID>(
        reinterpret_cast<void (*)(void)>(
            GetProcAddress(mpv_DLL, "CANext_Init_One_ID")));
    mpr_CANext_DLL_Info =
        reinterpret_cast<PR_CANext_DLL_Info>(reinterpret_cast<void (*)(void)>(
            GetProcAddress(mpv_DLL, "CANext_DLL_Info")));
    mpr_CANext_Get_Num_Channels = reinterpret_cast<PR_CANext_Get_Num_Channels>(
        reinterpret_cast<void (*)(void)>(
            GetProcAddress(mpv_DLL, "CANext_Get_Num_Channels")));
    mpr_CANext_Get_System_Time = reinterpret_cast<PR_CANext_Get_System_Time>(
        reinterpret_cast<void (*)(void)>(
            GetProcAddress(mpv_DLL, "CANext_Get_System_Time")));
    mpr_CANext_Get_Num_Supported_Bitrates =
        reinterpret_cast<PR_CANext_Get_Num_Supported_Bitrates>(
            reinterpret_cast<void (*)(void)>(
                GetProcAddress(mpv_DLL, "CANext_Get_Num_Supported_Bitrates")));
    mpr_CANext_Get_Supported_Bitrate =
        reinterpret_cast<PR_CANext_Get_Supported_Bitrate>(
            reinterpret_cast<void (*)(void)>(
                GetProcAddress(mpv_DLL, "CANext_Get_Supported_Bitrate")));
    // lint -restore

    if ((mpr_CAN_Init == NULL) || (mpr_CAN_Exit == NULL) ||
        (mpr_CAN_Bitrate == NULL) || (mpr_CAN_Read_Msg == NULL) ||
        (mpr_CAN_Send_Msg == NULL) || (mpr_CAN_Send_RTR == NULL) ||
    ...
    mq_ExtFunctionsAvailable =
        ((mpr_CANext_Init != NULL) && (mpr_CANext_Exit != NULL) &&
         (mpr_CANext_Bitrate != NULL) && (mpr_CANext_Read_Msg != NULL) &&
         (mpr_CANext_Send_Msg != NULL) && (mpr_CANext_InterfaceSetup != NULL) &&
         (mpr_CANext_Status != NULL) && (mpr_CANext_Init_One_ID != NULL) &&
...
int32_t C_CanDll::CAN_Init_One_ID(const int32_t os32_BitrateKBitS,
...
int32_t C_CanDll::CANext_Bitrate(const uint8_t ou8_Channel,
                                 const int32_t os32_BitrateKBitS) {
  int32_t s32_Return;
...
int32_t C_CanDll::CANext_Read_Msg(const uint8_t ou8_Channel,
...
int32_t C_CanDll::CANext_Send_Msg(const uint8_t ou8_Channel,
                                  const T_STWCAN_Msg_TX &orc_Message) {
  int32_t s32_Return;
...
int32_t C_CanDll::CANext_Status(const uint8_t ou8_Channel,
                                T_STWCAN_Status &orc_Status) {
  int32_t s32_Return;
...
int32_t C_CanDll::CANext_Init_One_ID(const uint8_t ou8_Channel,
                                     const int32_t os32_BitrateKBitS,
                                     const uint32_t ou32_ID) {
  int32_t s32_Return;
  ...
  EnterCriticalSection(&mt_Lock);
  s32_Return =
      (*mpr_CANext_Init_One_ID)(ou8_Channel, os32_BitrateKBitS, ou32_ID);
  LeaveCriticalSection(&mt_Lock);
  return s32_Return;
}
...
int32_t C_CanDll::CANext_DLL_Info(const uint8_t ou8_Channel,
                                  T_STWCAN_DLLInfo &orc_Info) {
  int32_t s32_Return;
...
int32_t C_CanDll::CANext_Get_Num_Supported_Bitrates(
    uint32_t &oru32_MultiplicationFactor) {
  int32_t s32_Return;
  ...
  EnterCriticalSection(&mt_Lock);
  s32_Return =
      (*mpr_CANext_Get_Num_Supported_Bitrates)(&oru32_MultiplicationFactor);
  LeaveCriticalSection(&mt_Lock);
  return s32_Return;
}
...
int32_t C_CanDll::CANext_Get_Supported_Bitrate(const uint16_t ou16_BitrateIndex,
  ...
  EnterCriticalSection(&mt_Lock);
  s32_Return =
      (*mpr_CANext_Get_Supported_Bitrate)(ou16_BitrateIndex, &oru32_Bitrate);
  LeaveCriticalSection(&mt_Lock);
  return s32_Return;
}
...
void C_CanDll::STWCANMSG_to_CANMSGRX(T_STWCAN_Msg_RX &orc_Target,
                                     const STW_CAN_MSG &orc_Source) {
...
void C_CanDll::STWCANEXTMSG_to_CANMSGRX(T_STWCAN_Msg_RX &orc_Target,
                                        const STW_CAN_EXTMSG &orc_Source) {
...
void C_CanDll::CANMSGTX_to_STWCANMSG(STW_CAN_MSG &orc_Target,
                                     const T_STWCAN_Msg_TX &orc_Source) {
...
void C_CanDll::CANMSGTX_to_STWCANEXTMSG(STW_CAN_EXTMSG &orc_Target,
                                        const T_STWCAN_Msg_TX &orc_Source) {
