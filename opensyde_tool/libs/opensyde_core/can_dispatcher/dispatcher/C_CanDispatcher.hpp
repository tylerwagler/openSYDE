...
// Also we limit the maximum size, to make sure we don't waste all of the heap
...
public:
  ...
  void PassAll(void);
  void PassOneID(const uint32_t ou32_ID, const bool oq_ExtID,
                 const bool oq_RTR);
...
class C_CanDispatcher : public C_CanBase {
private:
