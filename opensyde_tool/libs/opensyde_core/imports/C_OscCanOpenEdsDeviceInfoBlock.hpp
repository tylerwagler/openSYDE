...
public:
  ...
  QString c_VendorNumber;  ///< Vendor number, also see object dictionary index
                           ///< 1018, sub-index 1
  QString c_ProductName;   ///< Product name, max 243 characters
  QString c_ProductNumber; ///< Product number, also see object dictionary index
                           ///< 1018, sub-index 2
  QString c_RevisionNumber;  ///< Revision number, also see object dictionary
                             ///< index 1018, sub-index 3
  ...
  uint8_t u8_Granularity;    ///< Minimum size of a mappable object in bits,
                             ///< allowed for the PDO mapping
                             // on
  ///< this CANopen device
  QString c_DynamicChannelsSupported; ///< The value indicates the facility of
                                      ///< dynamic variable
  ///< generation. If the value is unequal to "0", the additional section
  ///< DynamicChannels exists
  bool q_GroupMessaging;  ///< The value indicates, if multiplexed PDOs
                          ///< configuration is supported
  uint16_t u16_NrOfRxPdo; ///< Number of supported receive PDOs
  uint16_t u16_NrOfTxPdo; ///< Number of supported transmit PDOs
  bool q_LssSupported;    ///< The value indicates information whether LSS
  ...
  static int32_t h_LoadStringValueFromIniFile(
  ...
  static int32_t h_LoadU16ValueFromIniFile(
      QSettings &orc_File, const QString &orc_SectionName,
      const QString &orc_KeyName, uint16_t &oru16_OutputValue,
      QString &orc_ErrorMessage, const uint16_t ou16_DefaultValue = 0);
