...
public:
  ...
  bool AreKeysAvailable(QString &orc_ErrorMessage,
                        const bool oq_CheckSerialNumber) const;
  ...
  void
  SetKeyUsageInformation(const C_CertificateKeyUsageInformation &orc_KeyUsage);
