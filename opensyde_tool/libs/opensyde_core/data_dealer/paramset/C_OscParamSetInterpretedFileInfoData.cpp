...
/*!
   \file
   \brief       Storage for interpreted param set file info data
   (implementation)
 ...
 */
//----------------------------------------------------------------------------------------------------------------------
C_OscParamSetInterpretedFileInfoData::C_OscParamSetInterpretedFileInfoData(
    void) {
  this->Clear();
}
...
/*! \brief   Add some general information for one param set file
   ...
   \param[in] orc_ToolName       Name of tool used for creating this param set
   file \param[in] orc_ToolVersion    Version of tool used for creating this
   param set file \param[in] orc_ProjectName    Name of project used for
   creating this param set file \param[in] orc_ProjectVersion Version of project
   used for creating this param set file \param[in] orc_UserComment    Optional
   user comment for this param set file
*/
//----------------------------------------------------------------------------------------------------------------------
void C_OscParamSetInterpretedFileInfoData::AddInterpretedFileData(
    const QString &orc_DateTime, const QString &orc_Creator,
    const QString &orc_ToolName, const QString &orc_ToolVersion,
    const QString &orc_ProjectName, const QString &orc_ProjectVersion,
