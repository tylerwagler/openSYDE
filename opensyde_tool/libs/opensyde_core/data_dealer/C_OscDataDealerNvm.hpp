...
protected:
   int32_t m_NvmReadListRaw(const C_OscNodeDataPoolList & orc_List, QByteArray & orc_Values,
                            uint8_t * const opu8_NrCode);
   int32_t m_SaveDumpToList(const QByteArray & orc_Values, C_OscNodeDataPoolList & orc_List) const;
