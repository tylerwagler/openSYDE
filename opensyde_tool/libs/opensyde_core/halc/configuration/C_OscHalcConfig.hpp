...
class C_OscHalcConfig : public C_OscHalcDefBase {
public:
  ...
  GetDomainConfigDataConst(const uint32_t ou32_Index) const;
  ...
  int32_t SetDomainConfig(const uint32_t ou32_Index,
                          const C_OscHalcConfigDomain &orc_Domain);
  int32_t SetDomainChannelConfig(const uint32_t ou32_DomainIndex,
  ...
  int32_t ResetDomainChannelConfig(const uint32_t ou32_DomainIndex,
                                   const uint32_t ou32_ChannelIndex,
                                   const bool oq_UseChannelIndex);
  int32_t ResetDomainChannelUseCase(const uint32_t ou32_DomainIndex,
                                    const uint32_t ou32_ChannelIndex,
                                    const bool oq_UseChannelIndex);
  int32_t SetDomainChannelConfigName(const uint32_t ou32_DomainIndex,
                                     const uint32_t ou32_ChannelIndex,
                                     const bool oq_UseChannelIndex,
                                     const QString &orc_Name);
  int32_t SetDomainChannelConfigComment(const uint32_t ou32_DomainIndex,
                                        const uint32_t ou32_ChannelIndex,
                                        const bool oq_UseChannelIndex,
                                        const QString &orc_Comment);
  int32_t SetDomainChannelConfigSafety(const uint32_t ou32_DomainIndex,
                                       const uint32_t ou32_ChannelIndex,
                                       const bool oq_UseChannelIndex,
                                       const bool oq_SafetyRelevant);
  int32_t SetDomainChannelConfigUseCase(const uint32_t ou32_DomainIndex,
                                        const uint32_t ou32_ChannelIndex,
                                        const bool oq_UseChannelIndex,
                                        const uint32_t ou32_UseCaseIndex);
  int32_t SetDomainChannelParameterConfig(
  ...
  int32_t SetDomainChannelParameterConfigElement(
      const uint32_t ou32_DomainIndex, const uint32_t ou32_ChannelIndex,
  ...
  int32_t SetDomainChannelParameterConfigElementPlain(
      const uint32_t ou32_DomainIndex, const uint32_t ou32_ChannelIndex,
      const uint32_t ou32_ParameterIndex, const uint32_t ou32_ElementIndex,
      const bool oq_UseChannelIndex, const C_OscHalcDefContent &orc_Value);
  int32_t SetDomainChannelParameterConfigElementEnum(
      const uint32_t ou32_DomainIndex, const uint32_t ou32_ChannelIndex,
      const uint32_t ou32_ParameterIndex, const uint32_t ou32_ElementIndex,
      const bool oq_UseChannelIndex, const QString &orc_DisplayName);
  int32_t SetDomainChannelParameterConfigElementBitmask(
      const uint32_t ou32_DomainIndex, const uint32_t ou32_ChannelIndex,
      const uint32_t ou32_ParameterIndex, const uint32_t ou32_ElementIndex,
      const bool oq_UseChannelIndex, const QString &orc_DisplayName,
      const bool oq_Value);
  int32_t SetDomainChannelParameterConfigElementString(
      const uint32_t ou32_DomainIndex, const uint32_t ou32_ChannelIndex,
      const uint32_t ou32_ParameterIndex, const uint32_t ou32_ElementIndex,
      const bool oq_UseChannelIndex, const QString &orc_Value);
  int32_t GetRelevantIndicesForSelectedUseCase(
      const uint32_t ou32_DomainIndex, const uint32_t ou32_ChannelIndex,
      const bool oq_UseChannelIndex,
