...
//----------------------------------------------------------------------------------------------------------------------
int32_t C_OscHalcConfig::ToQDomDocument(QDomDocument &orc_Doc, const QString &orc_ElementName) const {
   using namespace stw::errors;
...
//----------------------------------------------------------------------------------------------------------------------
int32_t C_OscHalcConfig::FromQDomDocument(const QDomElement &orc_Element) {
   using namespace stw::errors;
