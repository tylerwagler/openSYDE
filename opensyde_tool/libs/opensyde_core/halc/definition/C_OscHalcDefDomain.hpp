...
public:
  enum E_VariableSelector { eVA_PARAM, eVA_INPUT, eVA_OUTPUT, eVA_STATUS };

  enum E_Category { eCA_INPUT, eCA_OUTPUT, eCA_OTHER };
  ...
  QList<C_OscHalcDefChannelDef>
      c_Channels; ///< All available channels for this domain
  QList<C_OscHalcDefChannelUseCase>
      c_ChannelUseCases; ///< All available channel use-cases for this domain
