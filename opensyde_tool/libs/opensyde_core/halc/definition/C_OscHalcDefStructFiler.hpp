...
public:
   ...
   static int32_t h_ParseSimplestTypeValue(const QString & orc_TypeStr,
                                           C_OscNodeDataPoolContent & orc_Content,
                                           const C_OscXmlParserBase & orc_XmlParser,
                                           const QString & orc_AttributeName);
   static int32_t h_GetTypeForSimplestTypeString(const QString & orc_TypeStr,
                                                 C_OscNodeDataPoolContent::E_Type & ore_Type,
                                                 const C_OscXmlParserBase & orc_XmlParser);
   static QString h_GetTypeString(const C_OscNodeDataPoolContent::E_Type oe_Type);
   static int32_t h_SaveSimpleValueAsAttribute(const QString & orc_Node,
