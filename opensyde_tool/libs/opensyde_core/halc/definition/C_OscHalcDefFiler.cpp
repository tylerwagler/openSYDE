...
*/
//----------------------------------------------------------------------------------------------------------------------
int32_t C_OscHalcDefFiler::h_LoadFile(C_OscHalcDefBase & orc_IoData, const QString & orc_Path)
{
...
*/
//----------------------------------------------------------------------------------------------------------------------
int32_t C_OscHalcDefFiler::h_SaveFile(const C_OscHalcDefBase & orc_IoData, const QString & orc_Path)
{
...
int32_t C_OscHalcDefFiler::h_SaveData(const C_OscHalcDefBase & orc_IoData, C_OscXmlParserBase & orc_XmlParser)
{
   ...
   if (orc_IoData.q_NvmBasedConfig)
   {
      ...
      {
         const QString c_AttributeName = "address-offset-datapool-" + QString::number(
            u32_It + 1U) + "-non-safe";
                                              ...
                                              const uint32_t ou32_NumChannels, const C_OscXmlParserBase & orc_XmlParser)
{
   ...
   if (s32_Retval == C_NO_ERR)
   {
      std::vector<QString> c_SubElements;
                                                       ...
                                                       const uint8_t ou8_NumConfigCopies, const bool oq_IsSafeVector)
{
   ...
   for (uint8_t u8_It = 0U; u8_It < ou8_NumConfigCopies; ++u8_It)
   {
      ...
      const QString c_CompleteAttributeName = c_StartingPart +
                                                            QString::number(u8_It + 1U) +
                                                            c_ClosingPart;
                                               ...
                                               C_OscXmlParserBase & orc_XmlParser)
{
   ...
   if (s32_Retval == C_NO_ERR)
   {
      ...
      if (s32_Retval == C_NO_ERR)
      {
         ...
         if (static_cast<uint32_t>(orc_IoDataDomain.c_SingularName.length()) > (C_OscHalcDefStructFiler::
                                                         ...
                                                         u32_LONGEST_CONST_VAR_NAME_OFFSET))
         {
            orc_XmlParser.ReportErrorForNodeContentStartingWithXmlContext(
               ...
               QString::number(C_OscHalcDefStructFiler::hu32_MAX_ALLOWED_COMBINED_VARIABLE_LENGTH -
                                     u32_LONGEST_CONST_VAR_NAME_OFFSET) +
               " (Current: " +
               QString::number(orc_IoDataDomain.
   ...
   if (s32_Retval == C_NO_ERR)
   {
      s32_Retval = C_OscHalcDefStructFiler::h_LoadStructs(orc_IoDataDomain.c_DomainValues.c_Parameters, orc_XmlParser,
                                                          ...
                                                          false, static_cast<uint32_t>(orc_IoDataDomain.c_SingularName.length()));
   }
   if (s32_Retval == C_NO_ERR)
   {
      if (orc_XmlParser.SelectNodeChild("domain-values") == "domain-values")
      {
         ...
         if (s32_Retval == C_NO_ERR)
         {
            s32_Retval = C_OscHalcDefStructFiler::h_LoadStructs(orc_IoDataDomain.c_DomainValues.c_OutputValues,
                                                                ...
                                                                "value-element",
                                                                false, false, static_cast<uint32_t>(orc_IoDataDomain.c_SingularName.length()));
         }
         if (s32_Retval == C_NO_ERR)
         {
                                           ...
                                           C_OscXmlParserBase & orc_XmlParser)
{
   ...
   if (s32_Retval == C_NO_ERR)
   {
      ...
      if ((u32_ExpectedCount > 0UL) && (s32_Retval == C_NO_ERR))
      {
         ...
         {
            const QString c_Error = "Expected " + QString::number(u32_ExpectedCount) +
                                        " channels, got " + QString::number(orc_Channels.size()) + " channels";
...
*/
//----------------------------------------------------------------------------------------------------------------------
int32_t C_OscHalcDefFiler::mh_SplitAvailabilityString(const QString & orc_AvailabilityString,
                                                      ...
                                                      const QString & orc_AttributeName)
{
   ...
   //Parse subelements
   for (int32_t s32_ItChar = 0; (s32_ItChar < orc_AvailabilityString.length()) && (s32_Retval == C_NO_ERR);
        ++s32_ItChar)
   {
...
*/
//----------------------------------------------------------------------------------------------------------------------
int32_t C_OscHalcDefFiler::mh_ParseAvailabilityStringSubElements(const std::vector<QString> & orc_SubElements,
                                                                 ...
                                                                 const QString & orc_AttributeName)
{
        ...
        ++u32_ItSubStr)
   {
      ...
      else
      {
         ...
         for (int32_t s32_ItChar = 0; (s32_ItChar < rc_CurSubStr.length()) && (s32_Retval == C_NO_ERR); ++s32_ItChar)
         {
...
*/
//----------------------------------------------------------------------------------------------------------------------
int32_t C_OscHalcDefFiler::mh_ConvertStringToNumber(const QString & orc_Number, int32_t & ors32_Number,
                                                    const C_OscXmlParserBase & orc_XmlParser,
                                                    const QString & orc_AttributeName)
{
   int32_t s32_Retval = C_NO_ERR;
   ...
   for (uint32_t u32_ItNum = 0UL; u32_ItNum < orc_FoundNumbers.size(); ++u32_ItNum)
   {
      if (orc_FoundNumbers[u32_ItNum] >= static_cast<int32_t>(ou32_NumChannels))
      {
         orc_XmlParser.ReportErrorForAttributeContentStartingWithXmlContext(orc_AttributeName, "has number " +
                                                                            QString::number(orc_FoundNumbers[
                                                                                                     u32_ItNum]) +
...
*/
//----------------------------------------------------------------------------------------------------------------------
QString C_OscHalcDefFiler::mh_DomainCategoryEnumToString(const C_OscHalcDefDomain::E_Category oe_Category)
{
   QString c_Retval;
...
*/
//----------------------------------------------------------------------------------------------------------------------
int32_t C_OscHalcDefFiler::mh_DomainCategoryStringToEnum(const QString & orc_Category,
...
*/
//----------------------------------------------------------------------------------------------------------------------
int32_t C_OscHalcDefFiler::mh_CheckDuplicateNames(const QString & orc_Section,
...
*/
//----------------------------------------------------------------------------------------------------------------------
int32_t C_OscHalcDefFiler::mh_StringToSafetyMode(const QString & orc_String,
