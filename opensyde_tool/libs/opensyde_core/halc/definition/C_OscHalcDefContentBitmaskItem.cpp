...
C_OscHalcDefContentBitmaskItem::C_OscHalcDefContentBitmaskItem(void)
    : q_ApplyValueSetting(false), u64_Value(0ULL) {}
...
//----------------------------------------------------------------------------------------------------------------------
int32_t
C_OscHalcDefContentBitmaskItem::SetValueByString(const QString &orc_Item) {
  return C_OscHalcDefContentBitmaskItem::mh_ParseUintFromString(
      orc_Item, this->u64_Value);
}
...
*/
//----------------------------------------------------------------------------------------------------------------------
void C_OscHalcDefContentBitmaskItem::CalcHashStructure(
...
//----------------------------------------------------------------------------------------------------------------------
int32_t
C_OscHalcDefContentBitmaskItem::mh_ParseUintFromString(const QString &orc_Item,
