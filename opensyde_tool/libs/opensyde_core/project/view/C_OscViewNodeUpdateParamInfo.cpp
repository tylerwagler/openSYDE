...
void C_OscViewNodeUpdateParamInfo::CalcHash(uint32_t & oru32_HashValue) const
{
   ...
   C_SclChecksums::CalcCRC32(this->mc_FilePath.toUtf8().constData(), this->mc_FilePath.length(), oru32_HashValue);
}
...
*/
//----------------------------------------------------------------------------------------------------------------------
void C_OscViewNodeUpdateParamInfo::SetContent(const QString & orc_FilePath, const uint32_t ou32_LastKnownCrc)
{
