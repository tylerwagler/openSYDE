...
public:
  ...
  QString c_DeviceName;        ///< full device name used for checks
  QString c_DeviceNameAlias;   ///< full displayed name of device
  QString c_DeviceDescription; ///< text describing device
  QString c_ImagePath;         ///< path to file with image of device (e.g. JPG)
  QString c_FilePath;          ///< used for service update package (#24474)
  ...
  QString c_ManufacturerDisplayValue; ///< manufacturer string, displayed in
                                      ///< device configuration, also
                                      // used for Toolbox Eco-Partners
  QString c_CompanyLogoLink;          ///< link to company logo (Eco-Partners)
