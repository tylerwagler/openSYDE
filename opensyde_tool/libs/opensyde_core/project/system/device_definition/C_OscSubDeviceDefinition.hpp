...
public:
  ...
  bool IsConnected(const C_OscSystemBus::E_Type oe_Type,
                   const uint8_t ou8_InterfaceNumber) const;
  static QString h_GetInterfaceNameLower(const C_OscSystemBus::E_Type oe_Type,
  ...
  /// minimal times in ms to reset from the application to the Flashloader or
  /// reset the Flashloader itself. possible scenario: Reset from Application to
  /// Flashloader or from Flashloader to Flashloader no communication relevant
  /// configuration was changed.
  uint32_t u32_FlashloaderResetWaitTimeNoChangesCan; ///< CAN is used. default
                                                     ///< time is 1000ms
  uint32_t
      u32_FlashloaderResetWaitTimeNoChangesEthernet; ///< Eth is used. default
                                                     ///< time is 5500ms

  /// Single scenario: From Flashloader to Flashloader
  /// no fundamental communication relevant configuration was changed (Bus-Id or
  /// Node Id).
  uint32_t
      u32_FlashloaderResetWaitTimeNoFundamentalChangesCan; ///< CAN is used.
                                                           ///< default time is
                                                           ///< 1000ms
  uint32_t
      u32_FlashloaderResetWaitTimeNoFundamentalChangesEthernet; ///< Eth is
                                                                ///< used.
                                                                ///< default
                                                                ///< time is
                                                                ///< 5500ms
  ...
  /// Single scenario: From Flashloader to Flashloader
  /// fundamental communication relevant configuration was changed (CAN bitrate
  /// or IP address).
  uint32_t u32_FlashloaderResetWaitTimeFundamentalChangesCan; ///< CAN is used.
                                                              ///< default time
                                                              ///< is 1000ms
  uint32_t
      u32_FlashloaderResetWaitTimeFundamentalChangesEthernet; ///< Eth is used.
                                                              ///< default time
                                                              ///< is 5500ms
