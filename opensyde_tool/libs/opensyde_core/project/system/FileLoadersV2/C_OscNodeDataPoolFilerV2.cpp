...
//----------------------------------------------------------------------------------------------------------------------
int32_t
C_OscNodeDataPoolFilerV2::h_LoadDataPool(const uint16_t ou16_XmlFormatVersion,
  ...
  if ((orc_XmlParser.SelectNodeChild("lists") == "lists") &&
      (s32_Retval == C_NO_ERR)) {
    s32_Retval = h_LoadDataPoolLists(ou16_XmlFormatVersion,
                                     orc_NodeDataPool.c_Lists, orc_XmlParser);
...
*/
//----------------------------------------------------------------------------------------------------------------------
void C_OscNodeDataPoolFilerV2::h_SaveDataPool(
...
*/
//----------------------------------------------------------------------------------------------------------------------
int32_t C_OscNodeDataPoolFilerV2::h_LoadDataPoolList(
  ...
  if (s32_Retval == C_NO_ERR) {
    if (orc_XmlParser.SelectNodeChild("data-elements") == "data-elements") {
      s32_Retval = h_LoadDataPoolListElements(ou16_XmlFormatVersion,
                                              orc_NodeDataPoolList.c_Elements,
                                              orc_XmlParser);
      if (s32_Retval == C_NO_ERR) {
        // Return
        Q_ASSERT(orc_XmlParser.SelectNodeParent() == "list");
...
*/
//----------------------------------------------------------------------------------------------------------------------
void C_OscNodeDataPoolFilerV2::h_SaveDataPoolList(
...
*/
//----------------------------------------------------------------------------------------------------------------------
int32_t C_OscNodeDataPoolFilerV2::h_LoadDataPoolElement(
    const uint16_t ou16_XmlFormatVersion,
  ...
  if (ou16_XmlFormatVersion == 1U) {
    if (orc_XmlParser.SelectNodeChild("min-value") == "min-value") {
      if (s32_Retval == C_NO_ERR) {
        s32_Retval = h_LoadDataPoolContentV1(
            orc_NodeDataPoolListElement.c_MinValue, orc_XmlParser);
    ...
    if (orc_XmlParser.SelectNodeChild("max-value") == "max-value") {
      if (s32_Retval == C_NO_ERR) {
        s32_Retval = h_LoadDataPoolContentV1(
            orc_NodeDataPoolListElement.c_MaxValue, orc_XmlParser);
      }
      // Return
      Q_ASSERT(orc_XmlParser.SelectNodeParent() == "data-element");
    } else {
    ...
    if (orc_XmlParser.SelectNodeChild("value") == "value") {
      if (s32_Retval == C_NO_ERR) {
        s32_Retval = h_LoadDataPoolContentV1(
            orc_NodeDataPoolListElement.c_Value, orc_XmlParser);
      }
      // Return
      Q_ASSERT(orc_XmlParser.SelectNodeParent() == "data-element");
    } else {
    ...
    if (s32_Retval == C_NO_ERR) {
      s32_Retval = h_LoadDataPoolElementType(
          orc_NodeDataPoolListElement.c_Value, orc_XmlParser);
    }
    if (s32_Retval == C_NO_ERR) {
      if (orc_XmlParser.SelectNodeChild("min-value") == "min-value") {
  ...
  if (s32_Retval == C_NO_ERR) {
    if (orc_XmlParser.SelectNodeChild("data-set-values") == "data-set-values") {
      s32_Retval = h_LoadDataPoolListElementDataSetValues(
          ou16_XmlFormatVersion, orc_NodeDataPoolListElement.c_Value,
...
*/
//----------------------------------------------------------------------------------------------------------------------
void C_OscNodeDataPoolFilerV2::h_SaveDataPoolElement(
...
int32_t C_OscNodeDataPoolFilerV2::h_LoadDataPoolLists(
  ...
  if (c_CurNodeList == "list") {
    do {
      ...
      if (s32_Retval == C_NO_ERR) {
        s32_Retval =
            h_LoadDataPoolList(ou16_XmlFormatVersion, c_CurList, orc_XmlParser);
      }
...
int32_t C_OscNodeDataPoolFilerV2::h_LoadDataPoolListElements(
  ...
  if (c_CurNodeDataElement == "data-element") {
    do {
      ...
      if (s32_Retval == C_NO_ERR) {
        s32_Retval = h_LoadDataPoolElement(ou16_XmlFormatVersion,
                                           c_CurDataElement, orc_XmlParser);
      }
...
/*! \brief   Load node data pool list element data set values
   ...
   \param[in]     ou16_XmlFormatVersion                     version of XML
   format
   \param[in]     orc_ContType                              content type
  ...
  if (c_CurNodeDataSetValue == "data-set-value") {
    do {
      C_OscNodeDataPoolContent c_CurDataSetValue =
          orc_ContType; // pre set content type

      if (s32_Retval == C_NO_ERR) {
        if (ou16_XmlFormatVersion == 1U) {
          s32_Retval =
              h_LoadDataPoolContentV1(c_CurDataSetValue, orc_XmlParser);
        } else if (ou16_XmlFormatVersion == 2U) {
          s32_Retval =
              h_LoadDataPoolElementValue(c_CurDataSetValue, orc_XmlParser);
        } else {
          Q_ASSERT(false); // undefined version
        }
      }
...
/*! \brief   Load data pool element type
   ...
   \param[in,out] orc_XmlParser           XML with unknown (Node to store data
   pool variable) active
...
*/
//----------------------------------------------------------------------------------------------------------------------
int32_t C_OscNodeDataPoolFilerV2::h_LoadDataPoolElementType(
...
*/
//----------------------------------------------------------------------------------------------------------------------
void C_OscNodeDataPoolFilerV2::h_SaveDataPoolElementType(
...
*/
//----------------------------------------------------------------------------------------------------------------------
int32_t C_OscNodeDataPoolFilerV2::h_LoadDataPoolElementValue(
    C_OscNodeDataPoolContent &orc_NodeDataPoolContent,
    C_OscXmlParserBase &orc_XmlParser) {
  int32_t s32_Retval = C_NO_ERR;
...
/*! \brief   Save node data pool content
   ...
   \param[in]     orc_NodeDataPoolContent data storage
   \param[in,out] orc_XmlParser           XML with variable (Node to store data
   pool content) active
*/
//----------------------------------------------------------------------------------------------------------------------
void C_OscNodeDataPoolFilerV2::h_SaveDataPoolContentV1(
    const C_OscNodeDataPoolContent &orc_NodeDataPoolContent,
    C_OscXmlParserBase &orc_XmlParser) {
...
*/
//----------------------------------------------------------------------------------------------------------------------
int32_t C_OscNodeDataPoolFilerV2::h_LoadDataPoolContentV1(
    C_OscNodeDataPoolContent &orc_NodeDataPoolContent,
    C_OscXmlParserBase &orc_XmlParser) {
  int32_t s32_Retval = C_NO_ERR;
