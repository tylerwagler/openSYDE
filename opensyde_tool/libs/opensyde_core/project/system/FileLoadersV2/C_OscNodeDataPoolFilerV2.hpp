...
public:
  ...
  /// load functions
  static int32_t h_LoadDataPool(const uint16_t ou16_XmlFormatVersion,
                                C_OscNodeDataPool &orc_NodeDataPool,
                                C_OscXmlParserBase &orc_XmlParser);
  static int32_t h_LoadDataPoolList(const uint16_t ou16_XmlFormatVersion,
  ...
  static int32_t h_LoadDataPoolElement(
      ...
      C_OscXmlParserBase &orc_XmlParser);
  static int32_t
  h_LoadDataPoolLists(const uint16_t ou16_XmlFormatVersion,
  ...
  h_LoadDataPoolElementType(C_OscNodeDataPoolContent &orc_NodeDataPoolContent,
                            C_OscXmlParserBase &orc_XmlParser);
  static int32_t
  h_LoadDataPoolElementValue(C_OscNodeDataPoolContent &orc_NodeDataPoolContent,
                             C_OscXmlParserBase &orc_XmlParser);
  static int32_t
  ...
  static void h_SaveDataPoolLists(
      ...
      C_OscXmlParserBase &orc_XmlParser);
  static void
  h_SaveDataPoolListElements(const std::vector<C_OscNodeDataPoolListElement>
