...
public:
  static int32_t h_LoadNode(const uint16_t ou16_XmlFormatVersion,
                            C_OscNode &orc_Node,
                            C_OscXmlParserBase &orc_XmlParser);
  static void h_SaveNode(const C_OscNode &orc_Node,
                         C_OscXmlParserBase &orc_XmlParser);
  static int32_t
  ...
  static int32_t h_LoadNodeComMessage(C_OscCanMessage &orc_NodeComMessage,
                                      C_OscXmlParserBase &orc_XmlParser);
  static void h_SaveNodeComMessage(const C_OscCanMessage &orc_NodeComMessage,
                                   C_OscXmlParserBase &orc_XmlParser);
  ...
  static int32_t h_LoadNodeComSignal(C_OscCanSignal &orc_NodeComSignal,
                                     C_OscXmlParserBase &orc_XmlParser);
  static void h_SaveNodeComSignal(const C_OscCanSignal &orc_NodeComSignal,
                                  C_OscXmlParserBase &orc_XmlParser);
...
private:
  ...
  mh_SaveApplications(const QList<C_OscNodeApplication> &orc_NodeApplications,
                      C_OscXmlParserBase &orc_XmlParser);
  static int32_t mh_LoadDataPools(const uint16_t ou16_XmlFormatVersion,
                                  C_OscNode &orc_Node,
                                  C_OscXmlParserBase &orc_XmlParser);
  static void
