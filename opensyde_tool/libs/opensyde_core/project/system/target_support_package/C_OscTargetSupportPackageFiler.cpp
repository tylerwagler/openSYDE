...
/*! \brief   Load target support package.
   ...
   read from file \param[in,out]  orc_NodePath              Node path \param[in]
   orc_Path                  path to file
...
*/
//----------------------------------------------------------------------------------------------------------------------
int32_t C_OscTargetSupportPackageFiler::h_Load(
    C_OscTargetSupportPackage &orc_TargetSupportPackage, QString &orc_NodePath,
...
/*! \brief   Load data from xml file.
   ...
   \param[in]      orc_TargetSupportPackage  target support package information
   to write to file \param[in,out]  orc_NodePath              Node path
...
*/
//----------------------------------------------------------------------------------------------------------------------
int32_t C_OscTargetSupportPackageFiler::mh_Load(
    C_OscTargetSupportPackage &orc_TargetSupportPackage, QString &orc_NodePath,
  ...
  if (s32_Return == C_NO_ERR) {
    ...
    if (c_Text != "node-definition") {
      osc_write_log_error("Loading target support package",
                          "XML node \"node-definition\" not found.");
      s32_Return = C_CONFIG;
    } else {
