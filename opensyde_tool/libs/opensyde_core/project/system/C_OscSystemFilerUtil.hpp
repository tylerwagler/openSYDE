...
public:
  ...
  static int32_t h_BusTypeStringToEnum(const QString &orc_Type,
                                       C_OscSystemBus::E_Type &ore_Type);
  static int32_t h_GetParserForExistingFile(C_OscXmlParser &orc_FileXmlParser,
                                            const QString &orc_Path,
                                            const QString &orc_RootNode);
  static int32_t h_GetParserForNewFile(C_OscXmlParser &orc_FileXmlParser,
                                       const QString &orc_Path,
                                       const QString &orc_RootNode);
  ...
  static void
  h_AdaptProjectPathToSystemDefinition(const QString &orc_ProjectPath,
  ...
  static QString h_CodeExportScalingTypeToString(
      const C_OscNodeCodeExportSettings::E_Scaling &ore_Scaling);
  static int32_t h_StringToCodeExportScalingType(
      const QString &orc_String,
      C_OscNodeCodeExportSettings::E_Scaling &ore_Scaling);
  static int32_t h_CheckVersion(C_OscXmlParserBase &orc_XmlParser,
                                const uint16_t ou16_ExpectedFileVersion,
                                const QString &orc_TagName,
