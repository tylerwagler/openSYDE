...
public:
  ...
  static int32_t h_LoadDataElementId(C_OscNodeDataPoolListElementId &orc_Config,
                                     C_OscXmlParserBase &orc_XmlParser);
  static void
  h_SaveDataElementId(const C_OscNodeDataPoolListElementId &orc_Config,
                      C_OscXmlParserBase &orc_XmlParser);
...
private:
  ...
  static int32_t mh_LoadJobProperties(C_OscDataLoggerJobProperties &orc_Config,
                                      C_OscXmlParserBase &orc_XmlParser);
  static void
  mh_SaveJobProperties(const C_OscDataLoggerJobProperties &orc_Config,
                       C_OscXmlParserBase &orc_XmlParser);
  ...
  static void mh_SaveConfiguredDataElements(
      ...
      C_OscXmlParserBase &orc_XmlParser);
  static int32_t
  mh_LoadConfiguredDataElement(C_OscDataLoggerDataElementReference &orc_Config,
                               C_OscXmlParserBase &orc_XmlParser);
  ...
  static int32_t
  mh_StringToUseCaseType(const QString &orc_String,
