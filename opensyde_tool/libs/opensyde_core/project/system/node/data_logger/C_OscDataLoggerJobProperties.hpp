...
public:
  ...
  QString c_Name;                      ///< data logger job name
  QString c_Comment;                   ///< data logger job comment
  ...
  QString c_LogDestinationDirectory;   ///< log destination directory
  C_OscDataLoggerJobAdditionalTriggerProperties
      c_AdditionalTriggerProperties; ///< additional trigger config
};
