 ...
 * ---------------------------------------------------------------------------------------
 */
const uint8_t C_OscNodeComInterfaceSettings::C_IpAddress::hu8_IP_FIRST_BYTE =
    192U;
const uint8_t C_OscNodeComInterfaceSettings::C_IpAddress::hu8_IP_SECOND_BYTE =
    168U;
const uint8_t C_OscNodeComInterfaceSettings::C_IpAddress::hu8_IP_THIRD_BYTE =
    0U;
const uint8_t C_OscNodeComInterfaceSettings::C_IpAddress::hu8_IP_FOURTH_BYTE =
    2U;
...
C_OscNodeComInterfaceSettings::C_OscNodeComInterfaceSettings(void)
    : e_InterfaceType(C_OscSystemBus::eCAN), u8_InterfaceNumber(0),
      u8_NodeId(0), q_IsUpdateEnabled(false), q_IsRoutingEnabled(false),
      q_IsDiagnosisEnabled(false), u32_BusIndex(0), mq_IsBusConnected(false),
...
*/
//----------------------------------------------------------------------------------------------------------------------
void C_OscNodeComInterfaceSettings::AddConnection(
...
*/
//----------------------------------------------------------------------------------------------------------------------
bool C_OscNodeComInterfaceSettings::GetInterfaceConnectedInDeviceRawValue()
    const {
...
*/
//----------------------------------------------------------------------------------------------------------------------
void C_OscNodeComInterfaceSettings::SetInterfaceConnectedInDevice(
    const bool oq_Value) {
