 ...
 * ---------------------------------------------------------------------------------------
 */
const float64_t C_OscNodeDataPoolContentUtil::mhf64_EPSILON =
    1e-5; // to check for a 6 digit precision (openSYDE
          // default)
...
*/
//----------------------------------------------------------------------------------------------------------------------
void C_OscNodeDataPoolContentUtil::h_ZeroContent(
  ...
  if (orc_Content.GetArray() == false) {
    ...
    for (uint32_t u32_ItElem = 0; u32_ItElem < orc_Content.GetArraySize();
         ++u32_ItElem) {
      switch (orc_Content.GetType()) {
      case C_OscNodeDataPoolContent::eUINT8:
...
/*! \brief  Sets a float value in the content class
   ...
   The of64_Value value will be casted to the current type of the orc_Content
   ...
   configuration \param[in]     ou32_ArrayIndex Optional index for array
   position if content class has an array
*/
//----------------------------------------------------------------------------------------------------------------------
void C_OscNodeDataPoolContentUtil::h_SetValueInContent(
    const float64_t of64_Value, C_OscNodeDataPoolContent &orc_Content,
  ...
  const float64_t f64_IntegerValue =
      std::floor((of64_Value * 10.0) + 0.5) / 10.0;
  ...
  case C_OscNodeDataPoolContent::eUINT8:
    if (of64_Value <=
      ...
      if (orc_Content.GetArray() == true) {
        orc_Content.SetValueArrU8Element(std::numeric_limits<uint8_t>::min(),
                                         ou32_ArrayIndex);
      } else {
  ...
  case C_OscNodeDataPoolContent::eUINT16:
    if (of64_Value <=
      ...
      if (orc_Content.GetArray() == true) {
        orc_Content.SetValueArrU16Element(std::numeric_limits<uint16_t>::min(),
                                          ou32_ArrayIndex);
      } else {
  ...
  case C_OscNodeDataPoolContent::eUINT32:
    if (of64_Value <=
      ...
      if (orc_Content.GetArray() == true) {
        orc_Content.SetValueArrU32Element(std::numeric_limits<uint32_t>::min(),
                                          ou32_ArrayIndex);
      } else {
  ...
  case C_OscNodeDataPoolContent::eUINT64:
    if (of64_Value <=
      ...
      if (orc_Content.GetArray() == true) {
        orc_Content.SetValueArrU64Element(std::numeric_limits<uint64_t>::min(),
                                          ou32_ArrayIndex);
      } else {
  ...
  case C_OscNodeDataPoolContent::eSINT16:
    if (of64_Value <=
      ...
      if (orc_Content.GetArray() == true) {
        orc_Content.SetValueArrS16Element(std::numeric_limits<int16_t>::min(),
                                          ou32_ArrayIndex);
      } else {
  ...
  case C_OscNodeDataPoolContent::eSINT32:
    if (of64_Value <=
      ...
      if (orc_Content.GetArray() == true) {
        orc_Content.SetValueArrS32Element(std::numeric_limits<int32_t>::min(),
                                          ou32_ArrayIndex);
      } else {
  ...
  case C_OscNodeDataPoolContent::eSINT64:
    if (of64_Value <=
      ...
      if (orc_Content.GetArray() == true) {
        orc_Content.SetValueArrS64Element(std::numeric_limits<int64_t>::min(),
                                          ou32_ArrayIndex);
      } else {
  ...
  if (q_ValueAssigned == false) {
    if (orc_Content.GetArray() == true) {
      switch (orc_Content.GetType()) {
      case C_OscNodeDataPoolContent::eUINT8:
        orc_Content.SetValueArrU8Element(static_cast<uint8_t>(f64_IntegerValue),
                                         ou32_ArrayIndex);
        break;
      case C_OscNodeDataPoolContent::eUINT16:
        orc_Content.SetValueArrU16Element(
            static_cast<uint16_t>(f64_IntegerValue), ou32_ArrayIndex);
        break;
      case C_OscNodeDataPoolContent::eUINT32:
        orc_Content.SetValueArrU32Element(
            static_cast<uint32_t>(f64_IntegerValue), ou32_ArrayIndex);
        break;
      case C_OscNodeDataPoolContent::eUINT64:
        orc_Content.SetValueArrU64Element(
            static_cast<uint64_t>(f64_IntegerValue), ou32_ArrayIndex);
        break;
      case C_OscNodeDataPoolContent::eSINT8:
        orc_Content.SetValueArrS8Element(static_cast<int8_t>(f64_IntegerValue),
                                         ou32_ArrayIndex);
        break;
      case C_OscNodeDataPoolContent::eSINT16:
        orc_Content.SetValueArrS16Element(
            static_cast<int16_t>(f64_IntegerValue), ou32_ArrayIndex);
        break;
      case C_OscNodeDataPoolContent::eSINT32:
        orc_Content.SetValueArrS32Element(
            static_cast<int32_t>(f64_IntegerValue), ou32_ArrayIndex);
        break;
      case C_OscNodeDataPoolContent::eSINT64:
        orc_Content.SetValueArrS64Element(
            static_cast<int64_t>(f64_IntegerValue), ou32_ArrayIndex);
        break;
      case C_OscNodeDataPoolContent::eFLOAT32:
        orc_Content.SetValueArrF32Element(static_cast<float32_t>(of64_Value),
                                          ou32_ArrayIndex);
        break;
      case C_OscNodeDataPoolContent::eFLOAT64:
...
/*! \brief  Sets a value in range of minimum and maximum value.
   ...
   If value is out of range, the value is set to closer extremum (min or max
   value).

   Examples:
   * min: -1.0, max: 2.0, value: 1.0, eLeaveValue   ; after function call value
   is: 1.0    (was in range: eNoChange)
   * min: -1.0, max: 2.0, value: 1.0, eToZero       ; after function call value
   is: 0.0    (was in range: eZero)
   * min: -1.0, max: 1.0, value: 2.0, eLeaveValue   ; after function call value
   is: 1.0    (was out of range: eMax)
   * min: -1.0, max: 1.0, value: 2.0, eToZero       ; after function call value
   is: 1.0    (was out of range: eMax)
   * min: -1.0, max: 1.0, value: -2.0, eLeaveValue  ; after function call value
   is: -1.0   (was out of range: eMin)
   * min: -1.0, max: 1.0, value: -2.0, eToZero      ; after function call value
   is: -1.0   (was out of range: eMin)
   ...
   * max value is greater than min value
   ...
   Hints:
   * to avoid numerical problems the range check is done with a precision of 6
   decimal points
   ...
   * Also works with arrays!
   ...
   \param[in,out] orc_Value          specific value which is should be set in
   range \param[out]    ore_ValueChangedTo flag for what was done with value:
                                     value was in range (eNoChange or eZero)
   respectively out of range (eMin or eMax \param[in]     oe_SetValue flag for
   user choice if value should be left in range as it is or set to zero
...
*/
//----------------------------------------------------------------------------------------------------------------------
int32_t C_OscNodeDataPoolContentUtil::h_SetValueInMinMaxRange(
    const C_OscNodeDataPoolContent &orc_Min,
    const C_OscNodeDataPoolContent &orc_Max,
    C_OscNodeDataPoolContent &orc_Value, E_ValueChangedTo &ore_ValueChangedTo,
    const E_SetValue oe_SetValue) {
  int32_t s32_Return = C_NO_ERR;

  if (((orc_Min.GetArray() != orc_Max.GetArray()) ||
       (orc_Min.GetArray() != orc_Value.GetArray())) ||
      ((orc_Min.GetArraySize() != orc_Max.GetArraySize()) ||
       (orc_Min.GetArraySize() != orc_Value.GetArraySize()))) {
    s32_Return = C_CONFIG;
  } else {
    for (uint32_t u32_ItElement = 0; u32_ItElement < orc_Min.GetArraySize();
         ++u32_ItElement) {
      float64_t f64_Min;
      float64_t f64_Max;
      float64_t f64_Value;
      ...
      if ((orc_Min.GetType() != orc_Max.GetType()) ||
          (orc_Min.GetType() != orc_Value.GetType())) {
        s32_Return = C_CONFIG;
      }
      ...
      if (s32_Return == C_NO_ERR) {
        if (oe_SetValue == C_OscNodeDataPoolContentUtil::eTO_ZERO) {
          C_OscNodeDataPoolContentUtil::h_SetValueInContent(0.0, orc_Value,
                                                            u32_ItElement);
        }
        orc_Value.GetAnyValueAsFloat64(f64_Value, u32_ItElement);

        // check if value is between min and max value
        // because of possible numeric problems (1.25987e-321) it is checked in
        // an epsilon environment precision is 6 decimal points (should be
        // enough and is openSYDE default)

        if (((f64_Value < f64_Min) &&
             (std::abs(f64_Value - f64_Min) >= mhf64_EPSILON)) ||
            ((f64_Value > f64_Max) &&
             (std::abs(f64_Value - f64_Max) >= mhf64_EPSILON))) {
          // initial value not in min and max range, take closer min or max
          // value
          if (std::abs(f64_Value - f64_Min) <= std::abs(f64_Value - f64_Max)) {
            ore_ValueChangedTo = C_OscNodeDataPoolContentUtil::eMIN;
            // set value, special handling for signed/unsigned 64-bit integer
            // because of bit masks and accuracy problems
            if ((orc_Value.GetType() != C_OscNodeDataPoolContent::eSINT64) &&
              ...
              C_OscNodeDataPoolContentUtil::h_SetValueInContent(
                  f64_Min, orc_Value, u32_ItElement);
            } else if (orc_Value.GetType() ==
                       C_OscNodeDataPoolContent::eSINT64) {
              if (orc_Min.GetArray() == true) {
                orc_Value.SetValueArrS64Element(
                    orc_Min.GetValueArrS64Element(u32_ItElement),
                    u32_ItElement);
              } else {
              ...
              if (orc_Min.GetArray() == true) {
                orc_Value.SetValueArrU64Element(
                    orc_Min.GetValueArrU64Element(u32_ItElement),
                    u32_ItElement);
              } else {
            ...
            if ((orc_Value.GetType() != C_OscNodeDataPoolContent::eSINT64) &&
                (orc_Value.GetType() != C_OscNodeDataPoolContent::eUINT64)) {
              C_OscNodeDataPoolContentUtil::h_SetValueInContent(
                  f64_Max, orc_Value, u32_ItElement);
            } else if (orc_Value.GetType() ==
                       C_OscNodeDataPoolContent::eSINT64) {
              if (orc_Min.GetArray() == true) {
                orc_Value.SetValueArrS64Element(
                    orc_Max.GetValueArrS64Element(u32_ItElement),
                    u32_ItElement);
              } else {
              ...
              if (orc_Min.GetArray() == true) {
                orc_Value.SetValueArrU64Element(
                    orc_Max.GetValueArrU64Element(u32_ItElement),
                    u32_ItElement);
              } else {
...
*/
//----------------------------------------------------------------------------------------------------------------------
uint32_t C_OscNodeDataPoolContentUtil::h_GetDataTypeSizeInByte(
