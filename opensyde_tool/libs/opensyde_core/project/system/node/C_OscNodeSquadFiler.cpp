 ...
 */
 //----------------------------------------------------------------------------------------------------------------------
 int32_t C_OscNodeSquadFiler::h_SaveFile(const QList<C_OscNodeSquad> &orc_NodeGroups,
                                             const QString &orc_Path) {
     const QString c_Extension = QFileInfo(orc_Path).suffix().toLower();
 ...
 */
 //----------------------------------------------------------------------------------------------------------------------
 int32_t C_OscNodeSquadFiler::h_LoadNodeGroup(C_OscNodeSquad &orc_NodeGroup,
                                                  C_OscXmlParserBase &orc_XmlParser) {
