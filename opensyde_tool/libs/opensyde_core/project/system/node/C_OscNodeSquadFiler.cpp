...
//----------------------------------------------------------------------------------------------------------------------
int32_t
C_OscNodeSquadFiler::h_LoadNodeGroups(QList<C_OscNodeSquad> &orc_NodeGroups,
    ...
    if (s32_Retval == C_NO_ERR) {
      ...
      if (c_NodeName == "node-group") {
        do {
          ...
          s32_Retval = C_OscNodeSquadFiler::h_LoadNodeGroup(c_NewNodeGroup,
                                                            orc_XmlParser);
          if (s32_Retval == C_NO_ERR) {
...
//----------------------------------------------------------------------------------------------------------------------
int32_t
C_OscNodeSquadFiler::h_LoadNodeGroup(C_OscNodeSquad &orc_NodeGroup,
                                     C_OscXmlParserBase &orc_XmlParser) {
...
*/
//----------------------------------------------------------------------------------------------------------------------
void C_OscNodeSquadFiler::h_SaveNodeGroups(
    const QList<C_OscNodeSquad> &orc_NodeGroups,
    C_OscXmlParserBase &orc_XmlParser) {
...
*/
//----------------------------------------------------------------------------------------------------------------------
void C_OscNodeSquadFiler::h_SaveNodeGroup(const C_OscNodeSquad &orc_NodeGroup,
                                          C_OscXmlParserBase &orc_XmlParser) {
