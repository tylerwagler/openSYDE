...
public:
  ...
  int32_t InsertDataPool(const uint32_t ou32_DataPoolIndex,
  ...
  int32_t
  InsertMessage(const C_OscCanProtocol::E_Type oe_ComProtocol,
  ...
  int32_t SetMessage(const C_OscCanProtocol::E_Type oe_ComProtocol,
                     const uint32_t ou32_InterfaceIndex,
                     ...
                     const QList<C_OscNodeDataPoolListElement> &orc_SignalData);
  int32_t DeleteMessage(const C_OscCanProtocol::E_Type oe_ComProtocol,
                        const uint32_t ou32_InterfaceIndex,
                        const uint32_t ou32_DatapoolIndex,
                        const bool oq_MessageIsTx,
                        const uint32_t ou32_MessageIndex);
  int32_t InsertSignal(const C_OscCanProtocol::E_Type oe_ComProtocol,
                       const uint32_t ou32_InterfaceIndex,
                       const uint32_t ou32_DatapoolIndex,
                       const bool oq_MessageIsTx,
                       const uint32_t ou32_MessageIndex,
  ...
  int32_t SetSignal(const C_OscCanProtocol::E_Type oe_ComProtocol,
                    const uint32_t ou32_InterfaceIndex,
                    const uint32_t ou32_DatapoolIndex,
                    ...
                    const C_OscCanSignal &orc_Signal,
                    const C_OscNodeDataPoolListElement &orc_SignalData);
  int32_t SetSignalPosition(const C_OscCanProtocol::E_Type oe_ComProtocol,
                            const uint32_t ou32_InterfaceIndex,
                            const uint32_t ou32_DatapoolIndex,
                            const bool oq_MessageIsTx,
                            const uint32_t ou32_MessageIndex,
                            const uint32_t ou32_SignalIndex,
                            const C_OscCanSignal &orc_Signal);
  int32_t SetSignalMuxValue(const C_OscCanProtocol::E_Type oe_ComProtocol,
                            const uint32_t ou32_InterfaceIndex,
                            const uint32_t ou32_DatapoolIndex,
                            const bool oq_MessageIsTx,
                            const uint32_t ou32_MessageIndex,
  ...
  int32_t DeleteSignal(const C_OscCanProtocol::E_Type oe_ComProtocol,
                       const uint32_t ou32_InterfaceIndex,
                       const uint32_t ou32_DatapoolIndex,
                       const bool oq_MessageIsTx,
                       const uint32_t ou32_MessageIndex,
  ...
  uint32_t GetDataPoolCount(const stw::opensyde_core::C_OscNodeDataPool::E_Type
                                oe_DataPoolType) const;

  static bool h_CompareNameGreater(const C_OscNode &orc_Node1,
  ...
  uint32_t GetListAbsoluteAddress(const uint32_t ou32_DataPoolIndex,
                                  const uint32_t ou32_ListIndex) const;
  uint32_t GetElementAbsoluteAddress(const uint32_t ou32_DataPoolIndex,
                                     const uint32_t ou32_ListIndex,
                                     const uint32_t ou32_ElementIndex) const;
  const C_OscNodeDataPool *
  GetHalDataPoolConst(const bool oq_SafeDatapool) const;
  const C_OscNodeDataPool *
  GetComDataPoolConst(const C_OscCanProtocol::E_Type oe_ComProtocol,
                      const uint32_t ou32_DataPoolIndex) const;
  C_OscNodeDataPool *
  GetComDataPool(const C_OscCanProtocol::E_Type oe_ComProtocol,
                 const uint32_t ou32_DataPoolIndex);
  QList<const C_OscNodeDataPool *>
  GetComDatapoolsConst(const C_OscCanProtocol::E_Type oe_ComProtocol) const;
  QList<C_OscNodeDataPool *>
  GetComDataPools(const C_OscCanProtocol::E_Type oe_ComProtocol);
  const C_OscCanProtocol *
  GetCanProtocolConst(const C_OscCanProtocol::E_Type oe_ComProtocol,
                      const uint32_t ou32_DataPoolIndex) const;
  C_OscCanProtocol *
  GetCanProtocol(const C_OscCanProtocol::E_Type oe_ComProtocol,
                 const uint32_t ou32_DataPoolIndex);
  QList<const C_OscCanProtocol *>
  GetCanProtocolsConst(const C_OscCanProtocol::E_Type oe_ComProtocol) const;
  QList<C_OscCanProtocol *>
  GetCanProtocols(const C_OscCanProtocol::E_Type oe_ComProtocol);
  const C_OscCanProtocol *
  GetRelatedCanProtocolConst(const uint32_t ou32_DataPoolIndex) const;
  C_OscCanProtocol *GetRelatedCanProtocol(const uint32_t ou32_DataPoolIndex);
  void CheckErrorCanProtocol(const C_OscCanProtocol::E_Type oe_ComProtocol,
                             const bool oq_ComProtocolUsedByInterface,
                             bool &orq_InvalidMaxRxSignalCount,
                             bool &orq_InvalidMaxTxSignalCount,
                             bool &orq_InvalidCoRxPdoCount,
                             bool &orq_InvalidCoTxPdoCount,
                             bool &orq_InvalidMinSignalCount) const;
  void CheckErrorCanProtocol(const uint32_t ou32_InterfaceIndex,
  ...
  void
  CheckErrorDataPoolNumListsAndElements(const uint32_t ou32_DataPoolIndex,
                                        bool &orq_TooFewListsOrElements,
                                        bool &orq_TooManyListsOrElements) const;
  void CheckErrorDataPool(const uint32_t ou32_DataPoolIndex,
                          bool *const opq_NameConflict,
                          bool *const opq_NameInvalid,
                          bool *const opq_IsErrorInListOrMessage,
  ...
  void CheckMessageName(
      ...
      const bool *const opq_SkipMessageIsTxFlag = NULL,
      const uint32_t *const opu32_SkipMessageIndex = NULL) const;
  int32_t CheckApplicationProcessIdValid(const uint32_t ou32_ApplicationIndex,
                                         bool &orq_Valid) const;
  void
  CheckHalcConfigValid(bool *const opq_ConfigInvalid,
  ...
  GetDataPoolListElement(const uint32_t ou32_DataPoolIndex,
                         const uint32_t ou32_ListIndex,
...
private:
  void m_GetAllMessages(
      ...
      const bool *const opq_SkipMessageIsTxFlag = NULL,
      const uint32_t *const opu32_SkipMessageIndex = NULL) const;
  void m_AppendAllProtocolMessages(
      const uint32_t ou32_InterfaceIndex,
      const C_OscCanProtocol::E_Type oe_ComProtocol,
      QList<const C_OscCanMessage *> &orc_Messages,
      const C_OscCanProtocol::E_Type *const ope_SkipComProtocol = NULL,
      ...
      const bool *const opq_SkipMessageIsTxFlag = NULL,
      const uint32_t *const opu32_SkipMessageIndex = NULL) const;
  uint32_t m_GetListHash(const uint32_t ou32_DataPoolIndex,
                         const uint32_t ou32_ListIndex) const;
  uint32_t m_GetContainerHash(const uint32_t ou32_DataPoolIndex,
                              const uint32_t ou32_ContainerIndex) const;
  static void mh_CheckErrorCanProtocolDirection(
