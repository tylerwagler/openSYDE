...
public:
  ...
  const C_OscNodeComInterfaceSettings *
  GetComInterface(const C_OscSystemBus::E_Type oe_InterfaceType,
  ...
  QList<C_OscNodeComInterfaceSettings>
      c_ComInterfaces; ///< List of all present com interfaces
  C_OscNodeOpenSydeServerSettings
      c_OpenSydeServerSettings; ///< Optional openSYDE server settings
  C_OscNodeStwFlashloaderSettings
      c_StwFlashloaderSettings; ///< Optional STW flashloader settings
  C_OscNodeCodeExportSettings
      c_CodeExportSettings; ///< Optional code export settings
  bool q_XappSupport;       ///< Flag to indicate X_App support of node

private:
  QList<C_OscNodeComInterfaceSettings>
  m_GetInterfaces(const C_OscSystemBus::E_Type oe_Type) const;
};
