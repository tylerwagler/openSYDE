...
public:
  ...
  void CalcHashElement(uint32_t &oru32_HashValue,
  ...
  C_OscNodeDataPoolContent
      c_MinValue; ///< Minimum value(s) for complete data element
  C_OscNodeDataPoolContent
      c_MaxValue;           ///< Maximum value(s) for complete data element
  ...
  bool q_InterpretAsString; ///< Flag if data type should be interpreted as
                            ///< string
  bool q_DiagEventCall;     ///< Flag if there is an event call
  QList<C_OscNodeDataPoolContent>
      c_DataSetValues; ///< Dataset value(s) for complete data element
  C_OscNodeDataPoolContent
      c_Value; ///< Current value(s) for complete data element
  C_OscNodeDataPoolContent
      c_NvmValue;         ///< Current value(s) for complete data element in NVM
