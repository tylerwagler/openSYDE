...
int32_t C_OscCanOpenManagerFiler::h_LoadData(
  ...
  if (s32_Retval == C_NO_ERR) {
    ...
    if (s32_Retval == C_NO_ERR) {
      QString c_NodeName = orc_XmlParser.SelectNodeChild("can-open-manager");
      if (c_NodeName == "can-open-manager") {
        do {
          uint32_t u32_Interface;
          s32_Retval =
              orc_XmlParser.GetAttributeUint32Error("interface", u32_Interface);
          if (s32_Retval == C_NO_ERR) {
            C_OscCanOpenManagerInfo c_CanOpenManager;
            s32_Retval = C_OscCanOpenManagerFiler::mh_LoadManagerData(
                c_CanOpenManager, orc_XmlParser, orc_BasePath);
            if (s32_Retval == C_NO_ERR) {
              orc_Config[static_cast<uint8_t>(u32_Interface)] =
                  c_CanOpenManager;
            }
          }
          c_NodeName = orc_XmlParser.SelectNodeNext("can-open-manager");
        } while ((c_NodeName == "can-open-manager") &&
                 (s32_Retval == C_NO_ERR));
      ...
      if (u32_ExpectedSize != orc_Config.size()) {
        orc_XmlParser.ReportErrorForAttributeContentAppendXmlContext(
            "length",
            QString("Unexpected CANopen manager count, expected: %1, got %2")
                .arg(u32_ExpectedSize)
                .arg(static_cast<uint32_t>(orc_Config.size())));
      }
    }
...
int32_t C_OscCanOpenManagerFiler::h_SaveData(
  ...
  Q_ASSERT(orc_XmlParser.CreateAndSelectNodeChild("can-open-managers") ==
           "can-open-managers");
...
*/
//----------------------------------------------------------------------------------------------------------------------
int32_t C_OscCanOpenManagerFiler::mh_LoadManagerData(
    C_OscCanOpenManagerInfo &orc_Config, C_OscXmlParserBase &orc_XmlParser,
    const QString &orc_BasePath) {
  int32_t s32_Retval = C_OscCanOpenManagerFiler::mh_LoadManagerProperties(
      orc_Config, orc_XmlParser);

  if (s32_Retval == C_NO_ERR) {
    s32_Retval = C_OscCanOpenManagerFiler::mh_LoadManagerSubDevices(
...
*/
//----------------------------------------------------------------------------------------------------------------------
int32_t C_OscCanOpenManagerFiler::mh_LoadManagerProperties(
    C_OscCanOpenManagerInfo &orc_Config, C_OscXmlParserBase &orc_XmlParser) {
  ...
  if (s32_Retval == C_NO_ERR) {
    ...
    s32_Retval = orc_XmlParser.GetAttributeBoolError(
        "use-opensyde-id", orc_Config.q_UseOpenSydeNodeId);
    ...
    if (s32_Retval == C_NO_ERR) {
      s32_Retval = orc_XmlParser.GetAttributeUint32Error(
          "global-sdo-timeout-ms", u32_Value);
      if (s32_Retval == C_NO_ERR) {
    ...
    if (s32_Retval == C_NO_ERR) {
      s32_Retval = orc_XmlParser.GetAttributeBoolError(
          "autostart-can-open-manager", orc_Config.q_AutostartCanOpenManager);
    }
    if (s32_Retval == C_NO_ERR) {
      s32_Retval = orc_XmlParser.GetAttributeBoolError(
          "start-devices", orc_Config.q_StartDevices);
    }
    if (s32_Retval == C_NO_ERR) {
      s32_Retval = orc_XmlParser.GetAttributeBoolError(
          "NMT-start-all", orc_Config.q_NmtStartAll);
    }
    if (s32_Retval == C_NO_ERR) {
      s32_Retval = orc_XmlParser.GetAttributeBoolError(
    ...
    if (s32_Retval == C_NO_ERR) {
      s32_Retval = orc_XmlParser.GetAttributeUint32Error(
          "heartbeat-producer-time-ms", u32_Value);
      if (s32_Retval == C_NO_ERR) {
        orc_Config.u16_HeartbeatProducerTimeMs =
            static_cast<uint16_t>(u32_Value);
      }
    }
    if (s32_Retval == C_NO_ERR) {
      s32_Retval = C_OscCanOpenManagerFiler::mh_LoadManagerSyncProperties(
          orc_Config, orc_XmlParser);
    }
    if (s32_Retval == C_NO_ERR) {
      s32_Retval = orc_XmlParser.SelectNodeChildError("nmt-error-behaviour");
      if (s32_Retval == C_NO_ERR) {
        const QString c_Text = orc_XmlParser.GetNodeContent();
        s32_Retval =
            C_OscCanOpenManagerFiler::mh_StringToCanOpenManagerInfoType(
                c_Text, orc_Config.e_NmtErrorBehaviour);
        if (s32_Retval == C_NO_ERR) {
          Q_ASSERT(orc_XmlParser.SelectNodeParent() == "properties");
        } else {
          orc_XmlParser.ReportErrorForNodeContentAppendXmlContext(
              "Could not interpret \"" + c_Text +
              "\" as a valid NMT error behaviour type");
        }
      }
    }
...
*/
//----------------------------------------------------------------------------------------------------------------------
void C_OscCanOpenManagerFiler::mh_SaveManagerProperties(
    const C_OscCanOpenManagerInfo &orc_Config,
    C_OscXmlParserBase &orc_XmlParser) {
  orc_XmlParser.CreateAndSelectNodeChild("properties");
  orc_XmlParser.SetAttributeBool("use-opensyde-id",
                                 orc_Config.q_UseOpenSydeNodeId);
  orc_XmlParser.SetAttributeUint32(
      "node-id-value", static_cast<uint32_t>(orc_Config.u8_NodeIdValue));
  orc_XmlParser.SetAttributeUint32(
      "global-sdo-timeout-ms",
      static_cast<uint32_t>(orc_Config.u16_GlobalSdoTimeoutMs));
  orc_XmlParser.SetAttributeBool("autostart-can-open-manager",
  ...
  orc_XmlParser.SetAttributeBool("enable-heartbeat-producing",
  ...
  orc_XmlParser.CreateNodeChild(
      "nmt-error-behaviour",
      C_OscCanOpenManagerFiler::mh_CanOpenManagerInfoTypeToString(
          orc_Config.e_NmtErrorBehaviour));
  C_OscCanOpenManagerFiler::mh_SaveManagerSyncProperties(orc_Config,
                                                         orc_XmlParser);
  Q_ASSERT(orc_XmlParser.SelectNodeParent() == "can-open-manager");
}
...
*/
//----------------------------------------------------------------------------------------------------------------------
int32_t C_OscCanOpenManagerFiler::mh_LoadManagerSyncProperties(
    C_OscCanOpenManagerInfo &orc_Config, C_OscXmlParserBase &orc_XmlParser) {
  int32_t s32_Retval = C_NO_ERR;

  if (orc_XmlParser.SelectNodeChild("sync-message") == "sync-message") {
    s32_Retval = orc_XmlParser.GetAttributeBoolError(
        "produce", orc_Config.q_ProduceSyncMessage);
    if (s32_Retval == C_NO_ERR) {
      s32_Retval = orc_XmlParser.GetAttributeUint32Error(
          "cycle-period-us", orc_Config.u32_SyncCyclePeriodUs);
    }
    if (s32_Retval == C_NO_ERR) {
      s32_Retval = orc_XmlParser.GetAttributeUint32Error(
          "window-length-us", orc_Config.u32_SyncWindowLengthUs);
    }
    if (s32_Retval == C_NO_ERR) {
      Q_ASSERT(orc_XmlParser.SelectNodeParent() == "properties");
    }
...
*/
//----------------------------------------------------------------------------------------------------------------------
void C_OscCanOpenManagerFiler::mh_SaveManagerSyncProperties(
    const C_OscCanOpenManagerInfo &orc_Config,
    C_OscXmlParserBase &orc_XmlParser) {
  ...
  orc_XmlParser.SetAttributeUint32("cycle-period-us",
                                   orc_Config.u32_SyncCyclePeriodUs);
  orc_XmlParser.SetAttributeUint32("window-length-us",
...
int32_t C_OscCanOpenManagerFiler::mh_LoadManagerSubDevices(
  ...
  if (s32_Retval == C_NO_ERR) {
    ...
    s32_Retval =
        orc_XmlParser.GetAttributeUint32Error("length", u32_ExpectedSize);
    if (s32_Retval == C_NO_ERR) {
      QString c_NodeName = orc_XmlParser.SelectNodeChild("can-open-device");
      if (c_NodeName == "can-open-device") {
        do {
          ...
          if (s32_Retval == C_NO_ERR) {
            uint32_t u32_Value;
            s32_Retval =
                orc_XmlParser.GetAttributeUint32Error("node-index", u32_Value);
            if (s32_Retval == C_NO_ERR) {
              C_OscCanInterfaceId c_InterfaceId;
              c_InterfaceId.u32_NodeIndex = u32_Value;
              s32_Retval = orc_XmlParser.GetAttributeUint32Error("interface-id",
                                                                 u32_Value);
              if (s32_Retval == C_NO_ERR) {
                C_OscCanOpenManagerDeviceInfo c_DeviceInfo;
                c_InterfaceId.u8_InterfaceNumber =
                    static_cast<uint8_t>(u32_Value);
                Q_ASSERT(orc_XmlParser.SelectNodeParent() == "can-open-device");
                s32_Retval = C_OscCanOpenManagerFiler::mh_LoadManagerSubDevice(
                    c_DeviceInfo, orc_XmlParser, orc_BasePath);
                if (s32_Retval == C_NO_ERR) {
      ...
      if (u32_ExpectedSize != orc_Config.size()) {
        orc_XmlParser.ReportErrorForAttributeContentAppendXmlContext(
            "length",
            QString("Unexpected can open device count, expected: %1, got %2")
                .arg(u32_ExpectedSize)
                .arg(static_cast<uint32_t>(orc_Config.size())));
      }
    }
...
*/
//----------------------------------------------------------------------------------------------------------------------
int32_t C_OscCanOpenManagerFiler::mh_LoadManagerSubDevice(
  ...
  if (s32_Retval == C_NO_ERR) {
    uint32_t u32_Value;
    s32_Retval = orc_XmlParser.GetAttributeBoolError(
        "device-optional", orc_Config.q_DeviceOptional);
    if (s32_Retval == C_NO_ERR) {
      s32_Retval = orc_XmlParser.GetAttributeBoolError(
          "no-initialization", orc_Config.q_NoInitialization);
    }
    if (s32_Retval == C_NO_ERR) {
      s32_Retval = orc_XmlParser.GetAttributeBoolError(
          "factory-settings-active", orc_Config.q_FactorySettingsActive);
    }
    if (s32_Retval == C_NO_ERR) {
      s32_Retval = orc_XmlParser.GetAttributeUint32Error(
          "reset-node-object-dictionary-sub-index", u32_Value);
      orc_Config.u8_ResetNodeObjectDictionarySubIndex =
          static_cast<uint8_t>(u32_Value);
    }
    if (s32_Retval == C_NO_ERR) {
      s32_Retval = orc_XmlParser.GetAttributeBoolError(
    ...
    if (s32_Retval == C_NO_ERR) {
      s32_Retval = orc_XmlParser.GetAttributeUint32Error(
          "heartbeat-consumer-time-ms", u32_Value);
      orc_Config.u16_HeartbeatConsumerTimeMs = static_cast<uint16_t>(u32_Value);
    }
    if (s32_Retval == C_NO_ERR) {
      s32_Retval = orc_XmlParser.GetAttributeBoolError(
          "enable-heartbeat-consuming-auto-calculation",
          orc_Config.q_EnableHeartbeatConsumingAutoCalculation);
    }
    if (s32_Retval == C_NO_ERR) {
      s32_Retval = C_OscCanOpenManagerFiler::mh_LoadManagerSubDeviceEdsPart(
          orc_Config, orc_XmlParser, orc_BasePath);
    }
    if (s32_Retval == C_NO_ERR) {
      s32_Retval = C_OscCanOpenManagerFiler::mh_LoadManagerMappedSignals(
          orc_Config.c_EdsFileMappableSignals, orc_XmlParser);
    }
    Q_ASSERT(orc_XmlParser.SelectNodeParent() == "can-open-device");
  }
  return s32_Retval;
...
int32_t C_OscCanOpenManagerFiler::mh_SaveManagerSubDevice(
  ...
  orc_XmlParser.SetAttributeBool("no-initialization",
                                 orc_Config.q_NoInitialization);
  orc_XmlParser.SetAttributeBool("factory-settings-active",
                                 orc_Config.q_FactorySettingsActive);
  orc_XmlParser.SetAttributeUint32(
      "reset-node-object-dictionary-sub-index",
  ...
  orc_XmlParser.SetAttributeUint32(
      "node-id-value", static_cast<uint32_t>(orc_Config.u8_NodeIdValue));
  orc_XmlParser.SetAttributeBool("enable-heartbeat-consuming",
                                 orc_Config.q_EnableHeartbeatConsuming);
  orc_XmlParser.SetAttributeUint32(
      "heartbeat-consumer-time-ms",
      static_cast<uint32_t>(orc_Config.u16_HeartbeatConsumerTimeMs));
  orc_XmlParser.SetAttributeBool(
      "enable-heartbeat-consuming-auto-calculation",
      orc_Config.q_EnableHeartbeatConsumingAutoCalculation);
  s32_Retval = C_OscCanOpenManagerFiler::mh_SaveManagerSubDeviceEdsPart(
      orc_Config, orc_XmlParser, orc_BasePath, opc_CreatedFiles, orc_NodeName,
      ou8_InterfaceNumber);
  C_OscCanOpenManagerFiler::mh_SaveManagerMappedSignals(
      orc_Config.c_EdsFileMappableSignals, orc_XmlParser);
  Q_ASSERT(orc_XmlParser.SelectNodeParent() == "can-open-device");
  return s32_Retval;
}
...
*/
//----------------------------------------------------------------------------------------------------------------------
int32_t C_OscCanOpenManagerFiler::mh_LoadManagerSubDeviceEdsPart(
    C_OscCanOpenManagerDeviceInfo &orc_Config,
    C_OscXmlParserBase &orc_XmlParser, const QString &orc_BasePath) {
  int32_t s32_Retval = orc_XmlParser.SelectNodeChildError("eds-file-name");

  if (s32_Retval == C_NO_ERR) {
    const QString c_EdsFileName = orc_XmlParser.GetNodeContent();
    Q_ASSERT(orc_XmlParser.SelectNodeParent() == "properties");

    if (orc_BasePath.isEmpty()) {
      s32_Retval = orc_XmlParser.SelectNodeChildError("eds-file-content");
      if (s32_Retval == C_NO_ERR) {
      ...
      const QString c_CompleteFileName =
          C_OscSystemFilerUtil::h_CombinePaths(orc_BasePath, c_EdsFileName);
      // EDS file is only loaded on demand, remember path:
      orc_Config.c_ProjectEdsFilePath = c_CompleteFileName;

      if (!(QFileInfo(c_CompleteFileName).exists() &&
            QFileInfo(c_CompleteFileName).isFile())) {
        // Issue a warning if file does not exist. Do not consider a hard error.
        // As long as the content is not needed
  ...
  if (s32_Retval == C_NO_ERR) {
    s32_Retval = orc_XmlParser.SelectNodeChildError("eds-original-file-name");
...
int32_t C_OscCanOpenManagerFiler::mh_SaveManagerSubDeviceEdsPart(
  ...
  const QString c_ItemPrefixUnprepared =
      orc_NodeName + "_can_" + QString::number(ou8_InterfaceNumber) + "_";
  const QString c_ItemPrefixPrepared =
      C_OscSystemFilerUtil::h_PrepareItemNameForFileName(
          c_ItemPrefixUnprepared);
  const QString c_FileNameWithPrefix =
      c_ItemPrefixPrepared + orc_Config.c_OriginalEdsFileName;
  const QString c_CombinedPath =
  ...
  orc_XmlParser.CreateNodeChild("eds-original-file-name",
                                orc_Config.c_OriginalEdsFileName);
  if (orc_BasePath.isEmpty()) {
    ...
    if (c_CombinedPath == orc_Config.c_ProjectEdsFilePath) {
      ...
      // As EDS file content cannot be changed in the GUI there's no need to use
      // "GetEdsFileContent"
      //  (which would re-read the already present file).
      // Just leave the file system contents as they are.
      osc_write_log_info("CANopen Manager project saving",
                         "Location of EDS file \"" + c_CombinedPath +
                             "\" not changed. No need to re-save.");
    } else {
      // Load content and save it to the project path
      const C_OscCanOpenObjectDictionary &rc_EdsFileContent =
          orc_Config.GetEdsFileContent();
...
int32_t C_OscCanOpenManagerFiler::mh_LoadManagerMappedSignals(
  ...
  if (orc_XmlParser.SelectNodeChild("mappable-signals") == "mappable-signals") {
    ...
    s32_Retval =
        orc_XmlParser.GetAttributeUint32Error("length", u32_ExpectedSize);
    if (s32_Retval == C_NO_ERR) {
      QString c_NodeName = orc_XmlParser.SelectNodeChild("mappable-signal");
      if (c_NodeName == "mappable-signal") {
        orc_Config.reserve(u32_ExpectedSize);
        do {
          C_OscCanOpenManagerMappableSignal c_Signal;
          s32_Retval = C_OscCanOpenManagerFiler::mh_LoadManagerMappedSignal(
              c_Signal, orc_XmlParser);
          if (s32_Retval == C_NO_ERR) {
      ...
      if (u32_ExpectedSize != orc_Config.size()) {
        QString c_Tmp;
        c_Tmp =
            QString("Unexpected mappable signal count, expected: %1, got %2")
                .arg(u32_ExpectedSize)
                .arg(static_cast<uint32_t>(orc_Config.size()));
...
*/
//----------------------------------------------------------------------------------------------------------------------
int32_t C_OscCanOpenManagerFiler::mh_LoadManagerMappedSignal(
    C_OscCanOpenManagerMappableSignal &orc_Config,
    C_OscXmlParserBase &orc_XmlParser) {
  ...
  if (s32_Retval == C_NO_ERR) {
    ...
    if (s32_Retval == C_NO_ERR) {
      s32_Retval = C_OscNodeCommFiler::h_LoadNodeComSignal(
          orc_Config.c_SignalData, orc_XmlParser, true);
    }
  ...
  if (s32_Retval == C_NO_ERR) {
    ...
    if (s32_Retval == C_NO_ERR) {
      s32_Retval = C_OscNodeDataPoolFiler::h_LoadDataPoolElement(
          orc_Config.c_DatapoolData, orc_XmlParser);
    }
    Q_ASSERT(orc_XmlParser.SelectNodeParent() == "mappable-signal");
  }
  return s32_Retval;
...
*/
//----------------------------------------------------------------------------------------------------------------------
void C_OscCanOpenManagerFiler::mh_SaveManagerMappedSignal(
    const C_OscCanOpenManagerMappableSignal &orc_Config,
    C_OscXmlParserBase &orc_XmlParser) {
  orc_XmlParser.SetAttributeBool("is-auto-min-max-used",
                                 orc_Config.q_AutoMinMaxUsed);
  orc_XmlParser.CreateAndSelectNodeChild("com-signal");
  C_OscNodeCommFiler::h_SaveNodeComSignal(
      orc_Config.c_SignalData, orc_XmlParser, C_OscCanProtocol::eCAN_OPEN);
  Q_ASSERT(orc_XmlParser.SelectNodeParent() == "mappable-signal");
  orc_XmlParser.CreateAndSelectNodeChild("data-element");
  C_OscNodeDataPoolFiler::h_SaveDataPoolElement(
      orc_Config.c_DatapoolData, orc_XmlParser, C_OscNodeDataPool::eCOM);
  Q_ASSERT(orc_XmlParser.SelectNodeParent() == "mappable-signal");
}
