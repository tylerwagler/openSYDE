...
int32_t C_OscCanOpenManagerFiler::mh_LoadManagerMappedSignal(
  ...
  if (s32_Retval == C_NO_ERR) {
    ...
    if (s32_Retval == C_NO_ERR) {
      s32_Retval = C_OscNodeFilerV2::h_LoadNodeComSignal(
          orc_Config.c_SignalData, orc_XmlParser);
    }
  ...
  if (s32_Retval == C_NO_ERR) {
    ...
    if (s32_Retval == C_NO_ERR) {
      s32_Retval = C_OscNodeDataPoolFilerV2::h_LoadDataPoolElement(
          mhu16_FILE_VERSION_1, orc_Config.c_DatapoolData, orc_XmlParser);
    }
    Q_ASSERT(orc_XmlParser.SelectNodeParent() == "mappable-signal");
  }
  return s32_Retval;
...
void C_OscCanOpenManagerFiler::mh_SaveManagerMappedSignal(
  ...
  C_OscNodeFilerV2::h_SaveNodeComSignal(
      orc_Config.c_SignalData, orc_XmlParser);
  Q_ASSERT(orc_XmlParser.SelectNodeParent() == "mappable-signal");
  orc_XmlParser.CreateAndSelectNodeChild("data-element");
  C_OscNodeDataPoolFilerV2::h_SaveDataPoolElement(
