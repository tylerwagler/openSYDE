...
public:
  ...
  enum E_MultiplexerType ///< Enum for multiplexer signal types
  {
    ...
    eMUX_MULTIPLEXER_SIGNAL, ///< Multiplexer signal which defines the multiplex
                             ///< group by its value. Maximum one
  ...
  uint16_t
  GetDataBytesBitPosOfSignalBit(const uint16_t ou16_SignalBitPosition) const;
  uint16_t
  GetDataBytesBitPosOfSignalBit(const uint16_t ou16_StartBit,
                                const uint16_t ou16_SignalBitPosition) const;
  void
  GetDataBytesBitPositionsOfSignal(QSet<uint16_t> &orc_SetPositions) const;
  ...
  ///< Reserved for other protocols
  uint32_t
      u32_ComDataElementIndex; ///< Index of data element this signal refers to.
  ...
  ///< Multiplexer value if this signal should be present and represents the
  ///< associated multiplex group
  uint16_t
      u16_CanOpenManagerObjectDictionaryIndex; ///< CANopen manager specific
                                               ///< information about object
  ///< dictionary index
  uint8_t
      u8_CanOpenManagerObjectDictionarySubIndex; ///< CANopen manager specific
                                                 ///< information about object
