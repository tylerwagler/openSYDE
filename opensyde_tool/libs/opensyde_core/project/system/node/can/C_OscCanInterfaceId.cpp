...
C_OscCanInterfaceId::C_OscCanInterfaceId()
    : u32_NodeIndex(0), u8_InterfaceNumber(0) {}
...
*/
//----------------------------------------------------------------------------------------------------------------------
C_OscCanInterfaceId::C_OscCanInterfaceId(const uint32_t ou32_NodeIndex,
                                         const uint8_t ou8_InterfaceNumber)
    : u32_NodeIndex(ou32_NodeIndex), u8_InterfaceNumber(ou8_InterfaceNumber) {}
