...
public:
  ...
  uint32_t
  GetMessageSignalDataStartIndex(const bool &orq_IsTx,
  ...
  bool
  CheckLocalError(const C_OscNodeDataPoolList &orc_ListTx,
                  ...
                  QList<uint32_t> *const opc_InvalidTxMessages = NULL,
  ...
  bool q_IsComProtocolUsedByInterface; ///< Flag whether com protocol is used on
...
private:
  ...
  static bool
  mh_CheckMinSignalErrorPerVector(const QList<C_OscCanMessage> &orc_Messages);
};
