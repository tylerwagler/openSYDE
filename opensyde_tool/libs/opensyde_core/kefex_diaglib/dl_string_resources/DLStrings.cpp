...
const C_SclResourceString gac_DIAG_LIB_RESOURCE_STRINGS[] = {
    ...
    //  STR_FM_ERR_SNR_FORMAT     "Error: SNR must be in the format:
    //  00.112233.4455 !"
    ...
    //  STR_FM_ERR_READ_NO_RESPONSE "Error during reading: No response from
    //  node" STR_FM_ERR_READ_INVALID_ADDRESS "Error during reading: Invalid
    //  address" STR_FM_ERR_READ_CHECKSUM  "Error during reading: Checksum
    //  error" STR_FM_ERR_READ_UNDEF     "Error during reading: Undefined error"
    ...
    //  STR_FM_ERR_QUEUE_FULL         "CAN Hardware Error: Could not send
    //  message (possibly wrong baudrate) !!" STR_FM_ERR_TOO_MANY_NODES     "Too
    //  many nodes with same ID !!"
    ...
    //  STR_DFM_SNS_SH_NO_ECU_SELECTED "No server selected ! Select a server
    //  with click on Checklist !" STR_DFM_SNS_SELECT_ECU         "Select one of
    //  the listed servers by cursor click !"
    ...
    //   { STR_FW_ERR_DIVERT_NOT_SUPP           ,
    //   STR_TEXT_FW_ERR_DIVERT_NOT_SUPP },
    ...
    //   { STR_FW_CONFIRM_SET_COMP_MODE         ,
    //   STR_TEXT_FW_CONFIRM_SET_COMP_MODE },
    ...
    //  STR_XFL_ERR_WAKE_UP_SNR_LONG   "Error: wake up SNR not supported
    //  (LONG_SNR_MODE) !!" STR_XFL_ERR_NUM_SELECTED_ECU   "Error: number of
    //  selected nodes must be 1 !" STR_XFL_ERR_NO_INIT_PROGRAM_FLASH "Error:
    //  program flash components are not initialized !"
    ...
    //  STR_XFL_ERR_NUM_ECU_BIG_0      "Error: number of found ECUs must be
    //  bigger than 0 !"
    ...
    //  { STR_DS_ERR_UNKNOWN_LIST_NAME         ,
    //  STR_TEXT_DS_ERR_UNKNOWN_LIST_NAME },
    //   { STR_DS_ERR_UNKNOWN_LIST_NAME_RAM     ,
    //   STR_TEXT_DS_ERR_UNKNOWN_LIST_NAME_RAM }, { STR_DS_ERR_UNKNOWN_CRC_INFO
    //   , STR_TEXT_DS_ERR_UNKNOWN_CRC_INFO }, { STR_DS_ERR_NO_LISTS_FOUND_FILE
    //   , STR_TEXT_DS_ERR_NO_LISTS_FOUND_FILE },
    ...
    //   { STR_DS_ERR_REFERENCES_REMOVE         ,
    //   STR_TEXT_DS_ERR_REFERENCES_REMOVE }, { STR_DS_ERR_IMP_INVALID_TYPE ,
    //   STR_TEXT_DS_ERR_IMP_INVALID_TYPE }, { STR_DS_ERR_IMP_INVALID_STR_LEN ,
    //   STR_TEXT_DS_ERR_IMP_INVALID_STR_LEN }, { STR_DS_ERR_AARGHH ,
    //   STR_TEXT_DS_ERR_AARGHH }, { STR_DS_ERR_SEND_ABORT_RQ             ,
    //   STR_TEXT_DS_ERR_SEND_ABORT_RQ }, { STR_DS_ERR_ADD_CYCLIC_LIST ,
    //   STR_TEXT_DS_ERR_ADD_CYCLIC_LIST },
    ...
    // KFXProcess
    //    { STR_KFX_NO_DONGLE_PASSWORD           ,
    //    STR_TEXT_KFX_NO_DONGLE_PASSWORD }, { STR_KFX_BGROUP_RANGE ,
    //    STR_TEXT_KFX_BGROUP_RANGE },
    ...
    //  STR_KFX_NO_DYNAMIC_LANGUAGE  "Dynamic language switching is only
    //  possible using dynamic loading of packages (use
    // VisLibRT.bpl) !"

    // XFLDownload
    {STR_FDL_VERSION_ERR, STR_TEXT_FDL_VERSION_ERR},
    //  STR_FDL_VERSION_ERR_NO_SUPP  "Error: Flashloader version not supported
    //  !" STR_FDL_VERSION_ERR_UNDEF_CODE "Error: Flashloader version could not
    //  be read: Undefined error code !" STR_FDL_VERSION_ERR_UNDEF    "Error:
    //  Flashloader version could not be read: Undefined error !"
    ...
    {STR_FDL_VERSION_BBB_ERR_UNDEF_CODE,
     STR_TEXT_FDL_VERSION_BBB_ERR_UNDEF_CODE},
    ...
    //  STR_FDL_ERR_WRITE_NO_RESP    "Error writing: No response or TX error
    //  (line" STR_FDL_ERR_WRITE_NO_ACT     "Error writing: Programming error
    //  (line"
    ...
    //  STR_FDL_ERR_WRITE_VERIFY     "Error writing: Server reports checksum
    //  different from checksum in hex file (line"
    ...
    {STR_FDL_WARN_COULD_NOT_CALC_APPL_CHK,
     STR_TEXT_FDL_WARN_COULD_NOT_CALC_APPL_CHK},
    {STR_FDL_WARN_COULD_NOT_WR_APPL_CHK,
     STR_TEXT_FDL_WARN_COULD_NOT_WR_APPL_CHK},
    ...
    //  STR_DFM_XW_CMP             "CMP  Block Nr / Calc CRC / CRC in EE / Start
    //  Add / End Add" STR_DFM_XW_SET_CRC         "Set CRC"
...
uint16_t gu16_DIAGLIB_NR_RES_STRNGS =
    sizeof(gac_DIAG_LIB_RESOURCE_STRINGS) / sizeof(C_SclResourceString);
