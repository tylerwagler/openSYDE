...
// The .rc format string table is maintained as there are existing applications
// relying
...
//- add the set of index and text define to the target indepentend const table
//-> DLStrings.cpp

// Note: do not add "U" suffix to constants. GCC ressource compiler does not
// like that.

// general texts
#define STR_VERSION_CHECK 0

//   #define STR_BASE_GENERAL             0 //do not add "0" to strings to
//   prevent PC-Lint warning
#define STR_ERROR (1)
