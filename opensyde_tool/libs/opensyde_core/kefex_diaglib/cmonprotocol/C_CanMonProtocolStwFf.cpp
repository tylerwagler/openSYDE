...
/*!
   ...
   STW-FF CAN protocol specification.
...
//----------------------------------------------------------------------------------------------------------------------
QString
C_CanMonProtocolStwFf::MessageToString(const T_STWCAN_Msg_RX &orc_Msg) const {
  QString c_Text;
  bool q_IsRequest;
  uint8_t u8_NodeId;
  int32_t s32_Start;
    ...
    case FF_CONFIG_SERVICE_SET_SEG_PARAMS_VERSION:
      ...
      c_Text += (" Ver:" +
                 m_GetValueDecHex(orc_Msg.au8_Data[3] +
                                  (((uint16_t)orc_Msg.au8_Data[4]) << 8U)) +
...
*/
//----------------------------------------------------------------------------------------------------------------------
QString C_CanMonProtocolStwFf::GetProtocolName(void) const { return "STW FF"; }
