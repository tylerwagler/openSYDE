...
public:
  ...
  QString
      c_INIDirective; ///< directive for storing parameter value in an INI file
...
public:
  ...
  C_KFXCommConfigurationBase &
  operator=(const C_KFXCommConfigurationBase &orc_Source);
