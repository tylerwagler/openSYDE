...
private:
  static int32_t m_LoadRAMListFromFile(const QString &orc_FilePath,
  ...
  static void m_VarStringsToMinMax(const QString &orc_Min,
...
public:
  ...
  static int32_t LoadComments(const QString &orc_FileName,
                              const QString &orc_DeviceName,
