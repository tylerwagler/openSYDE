...
void C_KFXCommunicationBase::m_StaticResetHandler(
    void *const opv_InstancePointer) {
  // call "real" non-static callback handler
  (reinterpret_cast<C_KFXCommunicationBase *>(opv_InstancePointer))
      ->m_ResetHandler();
}
...
void C_KFXCommunicationBase::InstallECUResetHandler(
    const PR_KFXCommECUResetCallBack opr_Callback, void *const opv_Instance) {
...
void C_KFXCommunicationBase::InstallCyclicTransmissionCallback(
...
int32_t C_KFXCommunicationBase::GetConfig(
    C_KFXCommConfiguration *const opt_Config) const {
  if (opt_Config == NULL) {
    return C_CONFIG;
  }
...
int32_t C_KFXCommunicationBase::SetConfig(
...
void C_KFXCommunicationBase::GetProtocolFeatures(
    T_KFXProtocolFeatures *const opt_Features) {
...
int32_t C_KFXCommunicationBase::LoadConfigFromINI(QSettings *const opc_File,
...
int32_t
C_KFXCommunicationBase::SaveConfigToINI(QSettings *const opc_File,
...
// Implement all comm functions to return C_CONFIG, so we don't need to overload
// them if they are not implemented. Drawback: we don't get a compiler error if
// we accidentally ferget to implement one, as we would
//  if keeping them pure virtual in the base class.
int32_t C_KFXCommunicationBase::Logon(const uint64_t ou64_ProjectChecksum,
...
int32_t C_KFXCommunicationBase::ReadService(const uint32_t ou32_Index,
...
int32_t C_KFXCommunicationBase::WriteService(const uint32_t ou32_Index,
...
int32_t C_KFXCommunicationBase::ReadEEPROM(const uint32_t ou32_Address,
...
int32_t C_KFXCommunicationBase::WriteEEPROM(const uint32_t ou32_Address,
                                            const uint32_t ou32_NumBytes,
...
int32_t C_KFXCommunicationBase::WriteEEPROMSSLStart(
...
int32_t C_KFXCommunicationBase::WriteEEPROMSSLEnd(void) { return C_CONFIG; }

//---------------------------------------------------------------------------

int32_t C_KFXCommunicationBase::ReadROM(const uint32_t ou32_Address,
                                        const uint32_t ou32_NumBytes,
                                        uint8_t *const opu8_Data) {
  (void)ou32_Address;
  (void)ou32_NumBytes;
...
int32_t C_KFXCommunicationBase::ReadNumericVariable(const uint32_t ou32_Index,
...
int32_t C_KFXCommunicationBase::WriteNumericVariable(const uint32_t ou32_Index,
                                                     const uint8_t ou8_NumBytes,
...
int32_t
C_KFXCommunicationBase::ReadAggregateVariable(const uint32_t ou32_Index,
                                              const uint32_t ou32_NumBytes,
                                              uint8_t *const opu8_Data) {
  (void)ou32_Index;
  (void)ou32_NumBytes;
...
int32_t
C_KFXCommunicationBase::WriteAggregateVariable(const uint32_t ou32_Index,
                                               const uint32_t ou32_NumBytes,
                                               const uint8_t *const opu8_Data) {
  (void)ou32_Index;
  (void)ou32_NumBytes;
...
int32_t
C_KFXCommunicationBase::SendChangeNotification(const uint32_t ou32_Index) {
  (void)ou32_Index;
  return C_CONFIG;
}
...
int32_t C_KFXCommunicationBase::RequestTimeTriggeredTransmission(
...
int32_t C_KFXCommunicationBase::RequestChangeTriggeredTransmission(
...
int32_t
C_KFXCommunicationBase::TerminateCyclicTransmission(const uint32_t ou32_Index) {
  (void)ou32_Index;
  return C_CONFIG;
}
...
int32_t C_KFXCommunicationBase::TerminateAllCyclicTransmissions(
...
int32_t C_KFXCommunicationBase::WaitForStartupIndication(
...
C_KFXCommunicationIV::C_KFXCommunicationIV(void) : C_KFXCommunicationBase() {}
