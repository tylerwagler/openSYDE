...
class C_KFXCommunicationKEFEX : public C_KFXCommunicationBase {
private:
...
public:
  C_KFXCommunicationKEFEX(
      const C_KFXCommunicationKEFEX &orc_Source); // not implemented -> prevent
                                                  //  copying
  C_KFXCommunicationKEFEX &operator=(
      const C_KFXCommunicationKEFEX &orc_Source); // not implemented -> prevent
                                                  //  assignment
  ...
  virtual void
  SetCommDispatcher(stw::can::C_CanDispatcher *const opc_Dispatcher);
  ...
  void SetKEFEXVariableInfo(const C_KFXVariableLists *opt_KFXLists,
