...
public:
  ...
  void CalcCRCOverList(uint16_t &oru16_CRC, const bool oq_SkipValues = false)
      const; ///< uses "classic" STW CRC16
  ...
  GetVariableByName(const QString &orc_VariableName) const;
