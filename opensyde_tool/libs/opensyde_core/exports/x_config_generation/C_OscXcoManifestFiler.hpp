...
public:
  static int32_t h_LoadFile(C_OscXcoManifest &orc_Config,
                            const QString &orc_Path);
  static int32_t h_SaveFile(const C_OscXcoManifest &orc_Config,
                            const QString &orc_Path);
  static int32_t h_LoadData(C_OscXcoManifest &orc_Config,
                            C_OscXmlParserBase &orc_XmlParser);
  static void h_SaveData(const C_OscXcoManifest &orc_Config,
                         C_OscXmlParserBase &orc_XmlParser);
