...
*/
//----------------------------------------------------------------------------------------------------------------------
int32_t C_OscXcoCreate::h_CreatePackage(const QString & orc_PackagePath,
                                        ...
                                        const QString & orc_TemporaryDirectory)
{
   ...
   const QString c_TargetZipArchive = orc_PackagePath; // complete path of target zip
                                                           // archive
   std::set<QString> c_XcfgFiles;            // unique container with
   ...
   if (s32_Return == C_NO_ERR)
   {
      const QString c_ManifestPath = c_PackagePathTmp + C_OscXcoManifestFiler::hc_FILE_NAME;
   ...
   if (s32_Return == C_NO_ERR)
   {
      const QString c_SysDefPath = stw::opensyde_core::C_OscUtils::h_IncludeTrailingDelimiter(
   ...
   if (s32_Return == C_NO_ERR)
   {
      const QString c_DevDefPath = stw::opensyde_core::C_OscUtils::h_IncludeTrailingDelimiter(c_PackagePathTmp + hc_INI_DEV_FOLDER);
...
*/
//----------------------------------------------------------------------------------------------------------------------
int32_t C_OscXcoCreate::mh_CheckParamsToCreatePackage(const QString & orc_PackagePath,
                                                      const C_OscSystemDefinition & orc_SystemDefinition,
                                                      const C_OscXcoManifest & orc_Manifest)
{
