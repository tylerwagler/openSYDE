...
*/
//----------------------------------------------------------------------------------------------------------------------
#ifndef C_OSCXCOMANIFESTFILER_NEW_HPP
#define C_OSCXCOMANIFESTFILER_NEW_HPP
...
public:
   ...
   */
   //----------------------------------------------------------------------------------------------------------------------
   static int32_t h_LoadFile(C_OscXcoManifest& orc_Config, const QString& orc_Path);
   ...
   */
   //----------------------------------------------------------------------------------------------------------------------
   static int32_t h_SaveFile(const C_OscXcoManifest& orc_Config, const QString& orc_Path);
   ...
   */
   //----------------------------------------------------------------------------------------------------------------------
   static int32_t h_LoadBinary(C_OscXcoManifest& orc_Config, const QByteArray& orc_Data);
   ...
   */
   //----------------------------------------------------------------------------------------------------------------------
   static QByteArray h_SaveBinary(const C_OscXcoManifest& orc_Config);
   ...
   */
   //----------------------------------------------------------------------------------------------------------------------
   static int32_t h_LoadJson(C_OscXcoManifest& orc_Config, const QJsonObject& orc_Object);
   ...
   */
   //----------------------------------------------------------------------------------------------------------------------
   static QJsonObject h_SaveJson(const C_OscXcoManifest& orc_Config);
   ...
   */
   //----------------------------------------------------------------------------------------------------------------------
   static int32_t h_LoadXml(C_OscXcoManifest& orc_Config, const QDomElement& orc_Element);
   ...
   */
   //----------------------------------------------------------------------------------------------------------------------
   static QDomElement h_SaveXml(const C_OscXcoManifest& orc_Config, QDomDocument& orc_Doc);
   ...
   */
   //----------------------------------------------------------------------------------------------------------------------
   static int32_t h_LoadData(C_OscXcoManifest& orc_Config, class C_OscXmlParserBase& orc_XmlParser);
   ...
   */
   //----------------------------------------------------------------------------------------------------------------------
   static void h_SaveData(const C_OscXcoManifest& orc_Config, class C_OscXmlParserBase& orc_XmlParser);
...
#endif // C_OSCXCOMANIFESTFILER_NEW_HPP
