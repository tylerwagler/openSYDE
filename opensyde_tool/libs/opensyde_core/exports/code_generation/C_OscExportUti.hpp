...
public:
  ...
  static void h_AddProjectIdDef(QStringList &orc_Data,
  ...
  static QString h_GetTypePrefix(const C_OscNodeDataPoolContent::E_Type oe_Type,
                                 const bool oq_IsArray);
  static QString
  h_GetElementTypeAsString(const C_OscNodeDataPoolContent::E_Type oe_Type);
  static QString
  h_GetElementCeName(const QString &orc_Name, const bool oq_IsArray,
                     const C_OscNodeDataPoolContent::E_Type oe_Type,
                     const QString &orc_ArrayPos = "0");

  static QString h_FloatToStrGe(const float32_t of32_Value,
                                bool *const opq_InfOrNan = NULL);
  static QString h_FloatToStrGe(const float64_t of64_Value,
                                bool *const opq_InfOrNan = NULL);
