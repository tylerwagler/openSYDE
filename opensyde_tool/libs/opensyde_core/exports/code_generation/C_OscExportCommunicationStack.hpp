...
public:
   ...
   static QString h_GetConfigurationName(const uint8_t ou8_InterfaceIndex,
                                         const C_OscCanProtocol::E_Type & ore_ProtocolType);
...
protected:
   ...
   static void mh_AddCeIncludes(QStringList & orc_Data, const C_OscNodeDataPool & orc_DataPool,
                                const uint8_t ou8_InterfaceIndex, const C_OscCanProtocol::E_Type & ore_Protocol,
                                const bool oq_NullRequired);
   static void mh_AddDefines(QStringList & orc_Data, const C_OscCanMessageContainer & orc_ComMessage,
                             const uint8_t ou8_InterfaceIndex, const C_OscCanProtocol::E_Type & ore_Protocol,
                             const QString & orc_ProjectId, const uint16_t ou16_GenCodeVersion,
                             const bool oq_FileType);
   static void mh_AddCeModuleGlobal(QStringList & orc_Data, const bool oq_SafeData,
   ...
   static void mh_AddCeGlobalVariables(QStringList & orc_Data,
                                       const QString & orc_DataPoolName, const uint8_t ou8_InterfaceIndex,
