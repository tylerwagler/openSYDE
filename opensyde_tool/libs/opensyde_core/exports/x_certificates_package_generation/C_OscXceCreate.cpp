                                        ...
                                        const QString & orc_TemporaryDirectory)
{
   ...
   if (s32_Return == C_NO_ERR)
   {
      ...
      const QString c_ManifestPath = c_PackagePathTmp + C_OscXceManifestFiler::hc_FILE_NAME;
                                                            ...
                                                            const QString & orc_TargetFolder)
{
   ...
   const QString c_Retval = stw::opensyde_core::C_OscUtils::h_IncludeTrailingDelimiter(orc_TargetFolder) + c_FileName;
...
{
   int32_t s32_Return;
   const QString c_OutFile = C_OscXceCreate::mh_GetUniqueFileName(orc_InPath,
...
*/
//----------------------------------------------------------------------------------------------------------------------
QString C_OscXceCreate::mh_GetUniqueFileName(const QString & orc_InPath,
                                                           const QString & orc_OutFolder,
                                                           std::map<QString, bool> & orc_ExistingFiles)
{
   const QString c_Extension = "." + QFileInfo(orc_InPath).suffix();
   const QString c_OutPart = C_OscXceCreate::mh_GenOutFilePathPart(orc_InPath,
                                                                                 orc_OutFolder);
   const QString c_OutPartWithoutExt =
      c_OutPart.left(c_OutPart.length() - c_Extension.length());
   const QString c_OutFileWithoutExt = C_OscUtils::h_GetUniqueName(orc_ExistingFiles, c_OutPartWithoutExt,
                                                                                 0UL);
