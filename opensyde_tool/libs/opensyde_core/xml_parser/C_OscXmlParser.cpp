 ...
 */
//----------------------------------------------------------------------------------------------------------------------
C_OscXmlParserBase::C_OscXmlParserBase(void) { m_Init(); }
...
void C_OscXmlParserBase::m_Init(void) {
  ...
  if (mc_Document.documentElement().isNull()) {
    // create header:
    mc_Document.appendChild(mc_Document.createProcessingInstruction(
 ...
 */
//----------------------------------------------------------------------------------------------------------------------
C_OscXmlParser::C_OscXmlParser(void) : C_OscXmlParserBase() {}
...
int32_t C_OscXmlParser::LoadFromFile(const QString &orc_FileName) {
  ...
  if (!c_File.open(QIODevice::ReadOnly | QIODevice::Text)) {
    ...
    QDomDocument::ParseResult c_ParseResult =
        mc_Document.setContent(&c_File, QDomDocument::ParseOption::Default);
    if (!c_ParseResult) {
      s32_Return = C_NOACT;
      m_Init();
    }
...
//----------------------------------------------------------------------------------------------------------------------
QString
C_OscXmlParserBase::GetAttributeString(const QString &orc_Name,
...
//----------------------------------------------------------------------------------------------------------------------
int32_t
C_OscXmlParserBase::GetAttributeSint32(const QString &orc_Name,
                                       const int32_t os32_Default) const {
...
//----------------------------------------------------------------------------------------------------------------------
uint32_t
C_OscXmlParserBase::GetAttributeUint32(const QString &orc_Name,
                                       const uint32_t ou32_Default) const {
...
//----------------------------------------------------------------------------------------------------------------------
int64_t
C_OscXmlParserBase::GetAttributeSint64(const QString &orc_Name,
                                       const int64_t os64_Default) const {
...
//----------------------------------------------------------------------------------------------------------------------
uint64_t
C_OscXmlParserBase::GetAttributeUint64(const QString &orc_Name,
                                       const uint64_t ou64_Default) const {
 ...
 */
//----------------------------------------------------------------------------------------------------------------------
bool C_OscXmlParserBase::GetAttributeBool(const QString &orc_Name,
                                          const bool oq_Default) const {
...
//----------------------------------------------------------------------------------------------------------------------
float32_t
C_OscXmlParserBase::GetAttributeFloat32(const QString &orc_Name,
                                        const float32_t of32_Default) const {
...
//----------------------------------------------------------------------------------------------------------------------
float64_t
C_OscXmlParserBase::GetAttributeFloat64(const QString &orc_Name,
                                        const float64_t of64_Default) const {
 ...
 */
//----------------------------------------------------------------------------------------------------------------------
int32_t C_OscXmlParserBase::GetAttributeStringError(const QString &orc_Name,
...
//----------------------------------------------------------------------------------------------------------------------
int32_t
C_OscXmlParserBase::GetAttributeSint32Error(const QString &orc_Name,
                                            int32_t &ors32_Value) const {
  int32_t s32_Retval = C_NO_ERR;
...
//----------------------------------------------------------------------------------------------------------------------
int32_t
C_OscXmlParserBase::GetAttributeUint32Error(const QString &orc_Name,
                                            uint32_t &oru32_Value) const {
  int32_t s32_Retval = C_NO_ERR;
...
//----------------------------------------------------------------------------------------------------------------------
int32_t
C_OscXmlParserBase::GetAttributeSint64Error(const QString &orc_Name,
...
//----------------------------------------------------------------------------------------------------------------------
int32_t
C_OscXmlParserBase::GetAttributeUint64Error(const QString &orc_Name,
                                            uint64_t &oru64_Value) const {
  int32_t s32_Retval = C_NO_ERR;
 ...
 */
//----------------------------------------------------------------------------------------------------------------------
int32_t C_OscXmlParserBase::GetAttributeBoolError(const QString &orc_Name,
                                                  bool &orq_Value) const {
  int32_t s32_Retval = C_NO_ERR;
...
//----------------------------------------------------------------------------------------------------------------------
int32_t
C_OscXmlParserBase::GetAttributeFloat32Error(const QString &orc_Name,
...
//----------------------------------------------------------------------------------------------------------------------
int32_t
C_OscXmlParserBase::GetAttributeFloat64Error(const QString &orc_Name,
 ...
 */
//----------------------------------------------------------------------------------------------------------------------
void C_OscXmlParserBase::ReportErrorForNodeContentAppendXmlContext(
 ...
 */
//----------------------------------------------------------------------------------------------------------------------
void C_OscXmlParserBase::ReportErrorForAttributeContentAppendXmlContext(
    const QString &orc_Attribute, const QString &orc_ErrorMessage) const {
  (void)orc_Attribute;
  (void)orc_ErrorMessage;
}
 ...
 */
//----------------------------------------------------------------------------------------------------------------------
void C_OscXmlParserBase::ReportErrorForNodeContentStartingWithXmlContext(
    const QString &orc_ErrorMessage) const {
  (void)orc_ErrorMessage;
}
 ...
 */
//----------------------------------------------------------------------------------------------------------------------
void C_OscXmlParserBase::ReportErrorForAttributeContentStartingWithXmlContext(
    const QString &orc_Attribute, const QString &orc_ErrorMessage) const {
  (void)orc_Attribute;
  (void)orc_ErrorMessage;
}
 ...
 */
//----------------------------------------------------------------------------------------------------------------------
void C_OscXmlParserBase::ReportErrorForNodeMissing(
    const QString &orc_MissingNodeName) const {
 ...
 */
//----------------------------------------------------------------------------------------------------------------------
void C_OscXmlParserBase::CreateNodeChild(const QString &orc_Name,
 ...
 */
//----------------------------------------------------------------------------------------------------------------------
void C_OscXmlParserBase::SetAttributeString(const QString &orc_Name,
                                            const QString &orc_Value) {
  if (!mc_CurrentElement.isNull()) {
    mc_CurrentElement.setAttribute(orc_Name, orc_Value);
  }
}
 ...
 */
//----------------------------------------------------------------------------------------------------------------------
void C_OscXmlParserBase::SetAttributeSint32(const QString &orc_Name,
 ...
 */
//----------------------------------------------------------------------------------------------------------------------
void C_OscXmlParserBase::SetAttributeUint32(const QString &orc_Name,
 ...
 */
//----------------------------------------------------------------------------------------------------------------------
void C_OscXmlParserBase::SetAttributeSint64(const QString &orc_Name,
                                            const int64_t os64_Value) {
  if (!mc_CurrentElement.isNull()) {
    mc_CurrentElement.setAttribute(orc_Name,
                                   static_cast<long long>(os64_Value));
  }
}
 ...
 */
//----------------------------------------------------------------------------------------------------------------------
void C_OscXmlParserBase::SetAttributeUint64(const QString &orc_Name,
                                            const uint64_t ou64_Value) {
  if (!mc_CurrentElement.isNull()) {
    mc_CurrentElement.setAttribute(orc_Name,
                                   static_cast<unsigned long long>(ou64_Value));
  }
}
 ...
 */
//----------------------------------------------------------------------------------------------------------------------
void C_OscXmlParserBase::SetAttributeBool(const QString &orc_Name,
                                          const bool oq_Value) {
  if (!mc_CurrentElement.isNull()) {
 ...
 */
//----------------------------------------------------------------------------------------------------------------------
void C_OscXmlParserBase::SetAttributeFloat32(const QString &orc_Name,
                                             const float32_t of32_Value) {
  if (!mc_CurrentElement.isNull()) {
 ...
 */
//----------------------------------------------------------------------------------------------------------------------
void C_OscXmlParserBase::SetAttributeFloat64(const QString &orc_Name,
...
int32_t C_OscXmlParser::LoadFromString(const QString &orc_String) {
  ...
  QDomDocument::ParseResult c_ParseResult =
      mc_Document.setContent(orc_String, QDomDocument::ParseOption::Default);
  if (!c_ParseResult) {
    s32_Return = C_NOACT;
    m_Init();
  }
