...
public:
  ...
  void SetNextRecentColorButtonNumber(
  ...
  void
  SetScreenshotGifSucessTimeout(const int32_t os32_ScreenshotGifSucessTimer);
  ...
  void SetProjSdNodeSelectedDatapoolName(const QString &orc_NodeName,
                                         const QString &orc_DatapoolName);
  void SetProjSdNodeSelectedProtocol(
      const QString &orc_NodeName,
      const stw::opensyde_core::C_OscCanProtocol::E_Type oe_Protocol);
  void SetProjSdNodeSelectedInterface(const QString &orc_NodeName,
  ...
  void SetProjSdNodeSelectedHalcChannel(const QString &orc_NodeName,
                                        const QString &orc_Value);
  void
  SetProjSdNodeSelectedDataLoggerLogJobIndex(const QString &orc_NodeName,
                                             const int32_t os32_LogJobIndex);
  void
  SetProjSdNodeIsOverviewWidgetSelected(const QString &orc_NodeName,
                                        const bool oq_IsOverviewWidgetSelected);
  void SetProjSdBusSelectedMessage(
  ...
  void SetProjSvSetupViewZoom(const QString &orc_ViewName,
                              const int32_t os32_New);
  void SetProjSvSetupViewPos(const QString &orc_ViewName,
                             const QPoint &orc_New);
  void SetProjSvUpdateViewZoom(const QString &orc_ViewName,
                               const int32_t os32_New);
  void SetProjSvUpdateViewPos(const QString &orc_ViewName,
                              const QPoint &orc_New);
  void SetProjSvParamExport(const QString &orc_ViewName,
                            const QString &orc_Path);
  void SetProjSvParamImport(const QString &orc_ViewName,
                            const QString &orc_Path);
  void SetProjSvParamRecord(const QString &orc_ViewName,
                            const QString &orc_Path,
                            const QString &orc_FileName);
  void AddProjSvNodeUpdateDataRate(const QString &orc_ViewName,
                                   const QString &orc_NodeName,
                                   const uint32_t ou32_Checksum,
                                   const float64_t of64_DataRateBytesPerMs);
  void SetProjSvUpdateSplitterHorizontal(const QString &orc_ViewName,
                                         const int32_t os32_Value);
  void SetProjSvUpdateHorizontalSplitterVertical(const QString &orc_ViewName,
                                                 const int32_t os32_Value);
  void SetProjSvUpdateProgressLog(const QString &orc_ViewName,
                                  const QPoint &orc_Position,
                                  const QSize &orc_Size,
                                  const bool &orq_Maximized);
  void SetProjSvUpdateSummaryBig(const QString &orc_ViewName,
                                 const bool oq_BigVisible);
  void SetProjSvUpdateEmptyOptionalSectionsVisible(const QString &orc_ViewName,
                                                   const bool oq_Visible);
  void SetProjSvUpdateSectionsExpandedFlags(
      const QString &orc_ViewName, const QString &orc_NodeName,
      const QVector<bool> &orc_SectionsExpanded);
  void SetProjSvDashboardToolbox(const QString &orc_ViewName,
                                 const QPoint &orc_Position,
                                 const QSize &orc_Size,
                                 const bool &orq_Maximized);
  void SetProjSvDashboardSelectedTabIndex(const QString &orc_ViewName,
                                          const int32_t os32_Index);
  void SetProjSvDashboardMainTab(const QString &orc_ViewName,
                                 const QString &orc_DashboardName);
  void SetProjSvDashboardTearOffPosition(const QString &orc_ViewName,
                                         const QString &orc_DashboardName,
                                         const QPoint &orc_Position,
                                         const QSize &orc_Size,
                                         const bool oq_TornOffWindowMinimized,
                                         const bool oq_TornOffWindowMaximized);
  void SetProjSvDashboardScenePositionAndZoom(const QString &orc_ViewName,
                                              const QString &orc_DashboardName,
                                              const QPoint &orc_Position,
                                              const int32_t os32_Zoom);
  void SetProjLastScreenMode(const int32_t os32_SysDefSubMode,
  ...
  void CopyProjSvSettings(const QString &orc_SourceViewName,
                          const QString &orc_TargetViewName);
  void SetViewPermission(const QString &orc_ViewName,
  ...
  static int32_t h_GetParentFolder(const QString &orc_CompletePath,
                                   QString &orc_Parent,
...
private:
  ...
  QString
      mc_ActualProject; ///< Project specific settings for this concrete project
  static const uint8_t
      mhu8_MAX_RECENT_PROJECTS; ///< Maximum number of entries in unique history
                                ///< of recent
  // projects
  ...
  const QString mc_DefaultProjectsFolder; ///< Default openSYDE projects
                                          ///< location if no recent projects
                                          // are available
  bool mq_PerformanceMeasurementActive; ///< Flag if performance measurement is
                                        ///< active (log entries)

  // Environment Section
  QString mc_PathHandlingSelection;  ///< Currently chosen option (Relative or
                                     ///< Absolute)
  QString mc_SkipTspImportSelection; ///< Flag if TSP Import on Node Adding
                                     ///< shall always be skipped

  QString mc_CurrentSaveAsPath;             ///< Current save as base path
  QVector<QColor> mc_RecentColors;          ///< Recent colors from color picker
  int32_t ms32_NextRecentColorButtonNumber; ///< Next recent color button for
  ...
  uint32_t mu32_ScreenIndex; ///< History of last known screen (multiple monitor
                             ///< setup)
  QPoint mc_SdTopologyToolboxPos; ///< History of last known sys def toolbox
                                  ///< position
  QSize
      mc_SdTopologyToolboxSize; ///< History of last known sys def toolbox size
  int32_t ms32_NaviBarSize;     ///< Last known navi bar size
  int32_t
      ms32_NaviBarNodeSectionSize; ///< Last known navi bar node section size
  int32_t ms32_SdNodeEditSplitterHorizontal; ///< History of last known node
                                             ///< edit splitter position x
  // value
  int32_t ms32_SdNodEditHalcSplitterHorizontal; ///< History of last known halc
                                                ///< splitter position x value
  int32_t ms32_SdNodEditCoManagerSplitterHorizontal; ///< History of last known
                                                     ///< CANopen Manager
                                                     ///< splitter position
  // x value
  int32_t ms32_SdNodeEditDataLoggerSplitterHorizontal; ///< History of last
                                                       ///< known data logger
                                                       ///< splitter position
  // x value
  int32_t ms32_SdBusEditTreeSplitterHorizontal; ///< History of last known bus
                                                ///< edit tree splitter
  // position x value
  int32_t ms32_SdBusEditTreeSplitterHorizontal2; ///< History of last known sys
                                                 ///< def bus edit tree splitter
  // position 2 x value
  int32_t
      ms32_SdBusEditLayoutSplitterHorizontal; ///< History of last known sys def
                                              ///< bus edit layout splitter
  // position x value
  bool mq_SdTopologyToolboxMaximized;  ///< History of sys def toolbox state
  int32_t ms32_ProjLastKnownMode;      ///< History of last known project mode
                                       ///< (SD/SC/Main)
  int32_t ms32_ProjSdTopologyViewZoom; ///< History of last known zoom value for
                                       ///< specific project
  QPoint mc_ProjSdTopologyViewPos; ///< History of last known viewport pos for
                                   ///< specific project
  QString mc_ProjSdTopologyLastKnownTspPath; ///< History of last known TSP path
  QString mc_ProjSdTopologyLastKnownCodeExportPath; ///< History of last known
                                                    ///< code export path
  QString mc_ProjSdTopologyLastKnownExportPath;     ///< History of last known
                                                    ///< export path
  QString mc_ProjSdTopologyLastKnownImportPath;     ///< History of last known
                                                    ///< import path
  QString mc_ProjSdTopologyLastKnownCanOpenEdsPath; ///< History of last known
                                                    ///< CAN open path
  QString
      mc_ProjSdTopologyLastKnownDeviceDefPath; ///< History of last known import
                                               ///< path for a syde_devdef-file
  QString mc_ProjSdTopologyLastKnownRtfPath; ///< History of last known rtf file
                                             ///< export path
  QString
      mc_ProjSdTopologyLastKnownRtfCompanyName; ///< History of last known rtf
                                                ///< file export company name
  QString
      mc_ProjSdTopologyLastKnownRtfCompanyLogoPath; ///< History of last known
                                                    ///< rtf file export company
                                                    ///< logo path
  QString mc_LastKnownHalcDefPath;    ///< History of last known HALC definition
                                      ///< file path
  QString mc_LastKnownHalcImportPath; ///< History of last known HALC import
                                      ///< file path
  QString mc_LastKnownHalcExportPath; ///< History of last known HALC export
                                      ///< file path
  QString mc_LastKnownServiceProjectPath; ///< History of last known service
                                          ///< project path
  QString mc_LastKnownRamViewProjectPath; ///< History of last known RAMView
                                          ///< project import path
  QString mc_LastKnownJ1939CatalogPath; ///< History of last known J1939 catalog
                                        ///< import path
  QString mc_LastKnownCsvExportPath;  ///< History of last known CSV export path
  QString mc_LastKnownPrivateKeyPath; ///< History of last known private key
                                      ///< path (PEM file for
  ///< secure update)
  QString
      mc_LastKnownAddPemFilePath; ///< History of last known Add Pem file path
  QStringList mc_PemFilePaths;    ///< History of last known Pem file paths
  QString mc_LastKnownPublicPemFilePath; ///< History of last known public Pem
                                         ///< file path
  QString
      mc_LastKnownPemFilePassword; ///< History of last known Pem file password
  bool
      mq_LastKnownAddPemFileState; ///< History of last known Add Pem file state
  bool mq_LastKnownSecureUpdateConfigState; ///< History of last known secure
                                            ///< update config state
  QString mc_LastKnownSecureCertificatePackagePath; ///< History of last known
                                                    ///< secure certificate
                                                    ///< package path
  QMap<QString, C_UsSystemView>
      mc_ProjSvSetupView; ///< History of last known view user settings
  QMap<QString, C_UsNode>
      mc_ProjSdNode; ///< History of last known node user settings
  QMap<QString, C_UsCommunication>
      mc_ProjSdBus; ///< History of last known bus user settings
  int32_t
      ms32_SysDefSubMode; ///< History of last known system definition sub mode
  ...
  int32_t ms32_SysDefNodeEditTabIndex; ///< History of last known tab index in
                                       ///< node edit
  int32_t ms32_SysDefBusEditTabIndex;  ///< History of last known tab index in
                                       ///< bus edit
