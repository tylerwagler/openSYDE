...
*/
//----------------------------------------------------------------------------------------------------------------------
QString C_PuiBsLineArrow::h_ArrowHeadTypeToString(const E_ArrowHeadType & ore_Type)
{
   QString c_Retval;
   switch (ore_Type)
   {
...
*/
//----------------------------------------------------------------------------------------------------------------------
QString C_PuiBsLineArrow::h_LineTypeToString(const E_LineType & ore_Type)
{
   QString c_Retval;
   switch (ore_Type)
   {
...
*/
//----------------------------------------------------------------------------------------------------------------------
C_PuiBsLineArrow::E_ArrowHeadType C_PuiBsLineArrow::h_ArrowHeadTypeFromString(const QString & orc_Str)
{
...
*/
//----------------------------------------------------------------------------------------------------------------------
C_PuiBsLineArrow::E_LineType C_PuiBsLineArrow::h_LineTypeFromString(const QString & orc_Str)
{
