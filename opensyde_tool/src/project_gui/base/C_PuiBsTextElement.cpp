...
void C_PuiBsTextElement::CalcHash(uint32_t & oru32_HashValue) const
{
   ...
   stw::scl::C_SclChecksums::CalcCRC32(c_Font.toStdString(), c_Font.length(), oru32_HashValue);
   ...
   stw::scl::C_SclChecksums::CalcCRC32(this->c_UiText.toStdString(), this->c_UiText.length(), oru32_HashValue);
