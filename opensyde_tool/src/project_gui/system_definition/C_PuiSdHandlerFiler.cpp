                                             ...
                                             std::vector<C_OscNodeDataPool> * const opc_OscDataPools)
{
   ...
   if (orc_XmlParser.SelectNodeChild("data-pools") == "data-pools")
   {
      ...
      if ((s32_Retval == C_NO_ERR) && (q_ExpectedSizeHere == true))
      {
         ...
         {
            std::string c_Tmp;
            c_Tmp = PrintFormattedCompat("Unexpected UI Datapool count, expected: %u, got %zu", u32_ExpectedSize,
                                 orc_DataPools.size());
                                                 ...
                                                 std::vector<C_OscNodeDataPoolList> * const opc_OscLists)
{
   ...
   std::string c_CurrentDataPoolListNode;
   uint32_t u32_ExpectedSize = 0UL;
   const bool q_ExpectedSizeHere = orc_XmlParser.AttributeExists("length");
   ...
   if ((s32_Retval == C_NO_ERR) && (q_ExpectedSizeHere == true))
   {
      ...
      {
         std::string c_Tmp;
         c_Tmp = PrintFormattedCompat("Unexpected UI list count, expected: %u, got %zu", u32_ExpectedSize,
   ...
   std::vector<C_OscNodeDataPoolListElement> * const opc_OscElements)
{
   ...
   std::string c_CurrentDataPoolListElementNode;
   uint32_t u32_ExpectedSize = 0UL;
   const bool q_ExpectedSizeHere = orc_XmlParser.AttributeExists("length");
   ...
   if (q_ExpectedSizeHere == true)
   {
      ...
      {
         std::string c_Tmp;
         c_Tmp = PrintFormattedCompat("Unexpected UI data element count, expected: %u, got %zu", u32_ExpectedSize,
                                                      ...
                                                      C_OscXmlParserBase & orc_XmlParser)
{
   ...
   if (q_ExpectedSizeHere == true)
   {
      ...
      {
         std::string c_Tmp;
         c_Tmp = PrintFormattedCompat("Unexpected UI shared Datapools group count, expected: %u, got %zu", u32_ExpectedSize,
                                                     ...
                                                     C_OscXmlParserBase & orc_XmlParser)
{
   ...
   if (q_ExpectedSizeHere == true)
   {
      ...
      {
         std::string c_Tmp;
         c_Tmp = PrintFormattedCompat("Unexpected UI shared Datapool Ids count in group, expected: %u, got %zu",
                              u32_ExpectedSize,
                              orc_Group.size());
         osc_write_log_warning("Load file", c_Tmp.c_str());
      }
                                                ...
                                                C_OscXmlParserBase & orc_XmlParser, const QDir * const opc_BasePath)
{
   ...
   {
      std::string c_CurrentCanProtocolNode;
      uint32_t u32_ExpectedSize = 0UL;
      const bool q_ExpectedSizeHere = orc_XmlParser.AttributeExists("length");
      ...
      if ((s32_Retval == C_NO_ERR) && (q_ExpectedSizeHere == true))
      {
         ...
         {
            std::string c_Tmp;
            c_Tmp = PrintFormattedCompat("Unexpected UI protocol count, expected: %u, got %zu", u32_ExpectedSize,
   ...
   std::vector<C_PuiSdNodeCanMessageContainer> & orc_CanMessageContainers, C_OscXmlParserBase & orc_XmlParser)
{
   ...
   std::string c_CurrentCanMessageContainerNode;
   uint32_t u32_ExpectedSize = 0UL;
   const bool q_ExpectedSizeHere = orc_XmlParser.AttributeExists("length");
   ...
   if ((s32_Retval == C_NO_ERR) && (q_ExpectedSizeHere == true))
   {
      ...
      {
         std::string c_Tmp;
         c_Tmp = PrintFormattedCompat("Unexpected data element count, expected: %u, got %zu", u32_ExpectedSize,
                                               ...
                                               C_OscXmlParserBase & orc_XmlParser)
{
   ...
   std::string c_CurrentCanMessageNode;
   uint32_t u32_ExpectedSize = 0UL;
   const bool q_ExpectedSizeHere = orc_XmlParser.AttributeExists("length");
   ...
   if ((s32_Retval == C_NO_ERR) && (q_ExpectedSizeHere == true))
   {
      ...
      {
         std::string c_Tmp;
         c_Tmp = PrintFormattedCompat("Unexpected UI messages count, expected: %u, got %zu", u32_ExpectedSize,
                                         ...
                                         const QDir * const opc_BasePath, std::vector<C_OscNode> * const opc_OscNodes)
{
   ...
   if ((s32_Retval == C_NO_ERR) && (q_ExpectedSizeHere == true))
   {
      ...
      {
         std::string c_Tmp;
         c_Tmp = PrintFormattedCompat("Unexpected UI nodes count, expected: %u, got %zu", u32_ExpectedSize,
                              orc_Nodes.size());
         osc_write_log_warning("Load file", c_Tmp.c_str());
      }
   }
...
int32_t C_PuiSdHandlerFiler::h_LoadBuses(std::vector<C_PuiSdBus> & orc_Buses, C_OscXmlParserBase & orc_XmlParser)
{
   ...
   if ((s32_Retval == C_NO_ERR) && (q_ExpectedSizeHere == true))
   {
      ...
      {
         std::string c_Tmp;
         c_Tmp = PrintFormattedCompat("Unexpected bus count, expected: %u, got %zu", u32_ExpectedSize,
                              orc_Buses.size());
         osc_write_log_warning("Load file", c_Tmp.c_str());
      }
   }
                                                   ...
                                                   C_OscXmlParserBase & orc_XmlParser)
{
   ...
   if ((s32_Retval == C_NO_ERR) && (q_ExpectedSizeHere == true))
   {
      ...
      {
         std::string c_Tmp;
         c_Tmp = PrintFormattedCompat("Unexpected bus text element count, expected: %u, got %zu", u32_ExpectedSize,
                                                     ...
                                                     C_OscXmlParserBase & orc_XmlParser)
{
   ...
   {
      std::string c_CurrentNode = orc_XmlParser.SelectNodeChild("last-known-halc-crc");
...
*/
//----------------------------------------------------------------------------------------------------------------------
QString C_PuiSdHandlerFiler::h_GetCommUiFileName(const std::string & orc_DatapoolName)
{
...
*/
//----------------------------------------------------------------------------------------------------------------------
QString C_PuiSdHandlerFiler::h_GetDatapoolUiFileName(const std::string & orc_DatapoolName)
{
