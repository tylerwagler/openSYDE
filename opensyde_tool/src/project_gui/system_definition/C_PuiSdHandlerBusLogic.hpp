...
public:
   ...
   std::map<std::string, bool> GetExistingBusNames(void) const;
   ...
   bool CheckBusNameAvailable(const std::string & orc_Name,
...
protected:
   ...
   void m_GetExistingMessageNamesProtocol(const uint32_t & oru32_NodeIndex,
                                          const stw::opensyde_core::C_OscCanProtocol::E_Type & ore_ComType,
                                          const uint32_t & oru32_InterfaceIndex, std::map<std::string, bool>
                                          & orc_ExistingNames) const;
   std::map<std::string, bool> m_GetExistingMessageNames(const uint32_t & oru32_NodeIndex,
                                                                   const uint32_t & oru32_InterfaceIndex) const;
   std::map<std::string, bool> m_GetExistingSignalNames(
      const stw::opensyde_core::C_OscCanMessageIdentificationIndices & orc_MessageId) const;
