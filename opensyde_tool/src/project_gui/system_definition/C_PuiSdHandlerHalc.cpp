...
*/
//----------------------------------------------------------------------------------------------------------------------
const C_OscHalcConfig *
C_PuiSdHandlerHalc::GetHalcConfig(const uint32_t ou32_NodeIndex) const {
...
*/
//----------------------------------------------------------------------------------------------------------------------
const C_OscHalcConfigDomain *C_PuiSdHandlerHalc::GetHalcDomainConfigDataConst(
    const uint32_t ou32_NodeIndex, const uint32_t ou32_DomainIndex) const {
...
*/
//----------------------------------------------------------------------------------------------------------------------
const C_OscHalcConfigChannel *
C_PuiSdHandlerHalc::GetHalcDomainChannelConfigData(
...
*/
//----------------------------------------------------------------------------------------------------------------------
const C_OscHalcConfigParameterStruct *
C_PuiSdHandlerHalc::GetHalcDomainChannelParameterConfigStructData(
    const uint32_t ou32_NodeIndex, const uint32_t ou32_DomainIndex,
  ...
  const C_OscHalcConfigChannel *const pc_Config =
      this->GetHalcDomainChannelConfigData(ou32_NodeIndex, ou32_DomainIndex,
                                           ou32_ChannelIndex,
                                           oq_UseChannelIndex);
...
*/
//----------------------------------------------------------------------------------------------------------------------
const C_OscHalcDefDomain *C_PuiSdHandlerHalc::GetHalcDomainFileDataConst(
    const uint32_t ou32_NodeIndex, const uint32_t ou32_DomainIndex) const {
...
*/
//----------------------------------------------------------------------------------------------------------------------
const C_OscHalcDefChannelDef *
C_PuiSdHandlerHalc::GetHalcDomainFileChannelDataConst(
    const uint32_t ou32_NodeIndex, const uint32_t ou32_DomainIndex,
    const uint32_t ou32_Channel) const {
  const C_OscHalcDefChannelDef *pc_Retval;
  const C_OscHalcDefDomain *const pc_Config =
      this->GetHalcDomainFileDataConst(ou32_NodeIndex, ou32_DomainIndex);
...
*/
//----------------------------------------------------------------------------------------------------------------------
const C_OscHalcDefChannelUseCase *
C_PuiSdHandlerHalc::GetHalcDomainFileUseCaseData(
    const uint32_t ou32_NodeIndex, const uint32_t ou32_DomainIndex,
    const uint32_t ou32_UseCaseIndex) const {
...
*/
//----------------------------------------------------------------------------------------------------------------------
const C_OscHalcDefChannelAvailability *
C_PuiSdHandlerHalc::GetHalcDomainFileUseCaseAvailabilityData(
    const uint32_t ou32_NodeIndex, const uint32_t ou32_DomainIndex,
  ...
  const C_OscHalcDefChannelUseCase *const pc_Config =
      this->GetHalcDomainFileUseCaseData(ou32_NodeIndex, ou32_DomainIndex,
                                         ou32_UseCaseIndex);
...
*/
//----------------------------------------------------------------------------------------------------------------------
const C_OscHalcDefStruct *C_PuiSdHandlerHalc::GetHalcDomainFileVariableData(
    const uint32_t ou32_NodeIndex, const uint32_t ou32_DomainIndex,
    const C_OscHalcDefDomain::E_VariableSelector oe_Selector,
    const uint32_t ou32_Index) const {
  const C_OscHalcDefStruct *pc_Retval;
  const C_OscHalcDefDomain *const pc_DefDomain =
      this->GetHalcDomainFileDataConst(ou32_NodeIndex, ou32_DomainIndex);
  const C_OscHalcConfigDomain *const pc_ConfigDomain =
      this->GetHalcDomainConfigDataConst(ou32_NodeIndex, ou32_DomainIndex);
  ...
  if ((pc_DefDomain != NULL) && (pc_ConfigDomain != NULL)) {
    ...
    const C_OscHalcDefChannelValues &rc_Values =
        (pc_ConfigDomain->c_ChannelConfigs.size() == 0UL)
            ? pc_DefDomain->c_DomainValues
            : pc_DefDomain->c_ChannelValues;
...
C_PuiSdHandlerHalc::GetHalcDatapool(const uint32_t ou32_NodeIndex,
...
C_OscHalcDefDomain::E_Category C_PuiSdHandlerHalc::GetDomainCategoryFromDpId(
  ...
  if (this->TranslateToHalcIndex(
          orc_Id, ou32_ArrayIndex, u32_DomainIndex, q_UseChannelIndex,
          u32_ChannelIndex, e_Selector, u32_ParameterIndex, q_UseElementIndex,
          u32_ParameterElementIndex, q_IsUseCaseIndex, q_IsChanNumIndex,
          q_IsSafetyFlagIndex) == C_NO_ERR) {
    const C_OscHalcDefDomain *const pc_Domain =
        this->GetHalcDomainFileDataConst(orc_Id.u32_NodeIndex, u32_DomainIndex);
    if (pc_Domain != NULL) {
...
int32_t C_PuiSdHandlerHalc::ClearHalcConfig(const uint32_t ou32_NodeIndex) {
  ...
  if (ou32_NodeIndex < this->mc_CoreDefinition.c_Nodes.size()) {
    ...
    // reset hash for this node's halc config if there already exists a hash
    // value for this node's halc config
    // [] sets the value if key was found, otherwise creates a new key value
    // pair
...
*/
//----------------------------------------------------------------------------------------------------------------------
int32_t C_PuiSdHandlerHalc::SetHalcConfig(const uint32_t ou32_NodeIndex,
                                          const C_OscHalcConfig &orc_Config) {
  int32_t s32_Retval = C_NO_ERR;
...
*/
//----------------------------------------------------------------------------------------------------------------------
int32_t C_PuiSdHandlerHalc::SetHalcDomainConfig(
    const uint32_t ou32_NodeIndex, const uint32_t ou32_DomainIndex,
  ...
  if (ou32_NodeIndex < this->mc_CoreDefinition.c_Nodes.size()) {
    C_OscNode &rc_Node = this->mc_CoreDefinition.c_Nodes[ou32_NodeIndex];
    s32_Retval =
        rc_Node.c_HalcConfig.SetDomainConfig(ou32_DomainIndex, orc_Domain);
  } else {
    s32_Retval = C_RANGE;
  }
...
*/
//----------------------------------------------------------------------------------------------------------------------
int32_t C_PuiSdHandlerHalc::SetHalcDomainChannelConfig(
    const uint32_t ou32_NodeIndex, const uint32_t ou32_DomainIndex,
    const uint32_t ou32_ChannelIndex, const bool oq_UseChannelIndex,
    const C_OscHalcConfigChannel &orc_Channel) {
  return this->SetHalcDomainChannelConfig(
      ou32_NodeIndex, ou32_DomainIndex, ou32_ChannelIndex, oq_UseChannelIndex,
...
int32_t C_PuiSdHandlerHalc::SetHalcDomainChannelConfig(
  ...
  if (ou32_NodeIndex < this->mc_CoreDefinition.c_Nodes.size()) {
    C_OscNode &rc_Node = this->mc_CoreDefinition.c_Nodes[ou32_NodeIndex];
    s32_Retval = rc_Node.c_HalcConfig.SetDomainChannelConfig(
        ou32_DomainIndex, ou32_ChannelIndex, oq_UseChannelIndex, orc_Name,
        orc_Comment, oq_SafetyRelevant, ou32_UseCaseIndex);
  } else {
    s32_Retval = C_RANGE;
  }
...
*/
//----------------------------------------------------------------------------------------------------------------------
int32_t C_PuiSdHandlerHalc::ResetHalcDomainChannelConfig(
    const uint32_t ou32_NodeIndex, const uint32_t ou32_DomainIndex,
    const uint32_t ou32_ChannelIndex, const bool oq_UseChannelIndex) {
  int32_t s32_Retval = C_NO_ERR;
  ...
  if (ou32_NodeIndex < this->mc_CoreDefinition.c_Nodes.size()) {
    C_OscNode &rc_Node = this->mc_CoreDefinition.c_Nodes[ou32_NodeIndex];
    s32_Retval = rc_Node.c_HalcConfig.ResetDomainChannelConfig(
        ou32_DomainIndex, ou32_ChannelIndex, oq_UseChannelIndex);
  } else {
    s32_Retval = C_RANGE;
  }
...
*/
//----------------------------------------------------------------------------------------------------------------------
int32_t C_PuiSdHandlerHalc::ResetHalcDomainChannelUseCase(
    const uint32_t ou32_NodeIndex, const uint32_t ou32_DomainIndex,
    const uint32_t ou32_ChannelIndex, const bool oq_UseChannelIndex) {
  int32_t s32_Retval = C_NO_ERR;
  ...
  if (ou32_NodeIndex < this->mc_CoreDefinition.c_Nodes.size()) {
    C_OscNode &rc_Node = this->mc_CoreDefinition.c_Nodes[ou32_NodeIndex];
    s32_Retval = rc_Node.c_HalcConfig.ResetDomainChannelUseCase(
        ou32_DomainIndex, ou32_ChannelIndex, oq_UseChannelIndex);
  } else {
    s32_Retval = C_RANGE;
  }
...
*/
//----------------------------------------------------------------------------------------------------------------------
int32_t C_PuiSdHandlerHalc::SetHalcDomainChannelConfigName(
    const uint32_t ou32_NodeIndex, const uint32_t ou32_DomainIndex,
    const uint32_t ou32_ChannelIndex, const bool oq_UseChannelIndex,
  ...
  if (ou32_NodeIndex < this->mc_CoreDefinition.c_Nodes.size()) {
    C_OscNode &rc_Node = this->mc_CoreDefinition.c_Nodes[ou32_NodeIndex];
    s32_Retval = rc_Node.c_HalcConfig.SetDomainChannelConfigName(
        ou32_DomainIndex, ou32_ChannelIndex, oq_UseChannelIndex, orc_Name);
  } else {
    s32_Retval = C_RANGE;
  }
...
*/
//----------------------------------------------------------------------------------------------------------------------
int32_t C_PuiSdHandlerHalc::SetHalcDomainChannelConfigComment(
    const uint32_t ou32_NodeIndex, const uint32_t ou32_DomainIndex,
    const uint32_t ou32_ChannelIndex, const bool oq_UseChannelIndex,
  ...
  if (ou32_NodeIndex < this->mc_CoreDefinition.c_Nodes.size()) {
    C_OscNode &rc_Node = this->mc_CoreDefinition.c_Nodes[ou32_NodeIndex];
    s32_Retval = rc_Node.c_HalcConfig.SetDomainChannelConfigComment(
        ou32_DomainIndex, ou32_ChannelIndex, oq_UseChannelIndex, orc_Comment);
  } else {
    s32_Retval = C_RANGE;
  }
...
*/
//----------------------------------------------------------------------------------------------------------------------
int32_t C_PuiSdHandlerHalc::SetHalcDomainChannelConfigSafety(
    const uint32_t ou32_NodeIndex, const uint32_t ou32_DomainIndex,
    const uint32_t ou32_ChannelIndex, const bool oq_UseChannelIndex,
  ...
  if (ou32_NodeIndex < this->mc_CoreDefinition.c_Nodes.size()) {
    C_OscNode &rc_Node = this->mc_CoreDefinition.c_Nodes[ou32_NodeIndex];
    s32_Retval = rc_Node.c_HalcConfig.SetDomainChannelConfigSafety(
        ou32_DomainIndex, ou32_ChannelIndex, oq_UseChannelIndex,
        oq_SafetyRelevant);
  } else {
    s32_Retval = C_RANGE;
...
*/
//----------------------------------------------------------------------------------------------------------------------
int32_t C_PuiSdHandlerHalc::SetHalcDomainChannelConfigUseCase(
    const uint32_t ou32_NodeIndex, const uint32_t ou32_DomainIndex,
    const uint32_t ou32_ChannelIndex, const bool oq_UseChannelIndex,
    const uint32_t ou32_UseCaseIndex) {
  int32_t s32_Retval = C_NO_ERR;
  ...
  if (ou32_NodeIndex < this->mc_CoreDefinition.c_Nodes.size()) {
    C_OscNode &rc_Node = this->mc_CoreDefinition.c_Nodes[ou32_NodeIndex];
    s32_Retval = rc_Node.c_HalcConfig.SetDomainChannelConfigUseCase(
        ou32_DomainIndex, ou32_ChannelIndex, oq_UseChannelIndex,
        ou32_UseCaseIndex);
  } else {
    s32_Retval = C_RANGE;
...
*/
//----------------------------------------------------------------------------------------------------------------------
int32_t C_PuiSdHandlerHalc::SetHalcDomainChannelParameterConfig(
    const uint32_t ou32_NodeIndex, const uint32_t ou32_DomainIndex,
    const uint32_t ou32_ChannelIndex, const uint32_t ou32_ParameterIndex,
  ...
  if (ou32_NodeIndex < this->mc_CoreDefinition.c_Nodes.size()) {
    C_OscNode &rc_Node = this->mc_CoreDefinition.c_Nodes[ou32_NodeIndex];
    s32_Retval = rc_Node.c_HalcConfig.SetDomainChannelParameterConfig(
        ou32_DomainIndex, ou32_ChannelIndex, ou32_ParameterIndex,
...
*/
//----------------------------------------------------------------------------------------------------------------------
int32_t C_PuiSdHandlerHalc::SetHalcDomainChannelParameterConfigElement(
    const uint32_t ou32_NodeIndex, const uint32_t ou32_DomainIndex,
    const uint32_t ou32_ChannelIndex, const uint32_t ou32_ParameterIndex,
  ...
  if (ou32_NodeIndex < this->mc_CoreDefinition.c_Nodes.size()) {
    C_OscNode &rc_Node = this->mc_CoreDefinition.c_Nodes[ou32_NodeIndex];
    s32_Retval = rc_Node.c_HalcConfig.SetDomainChannelParameterConfigElement(
        ou32_DomainIndex, ou32_ChannelIndex, ou32_ParameterIndex,
        ou32_ElementIndex, oq_UseChannelIndex, orc_Parameter);
  } else {
    s32_Retval = C_RANGE;
  }
...
*/
//----------------------------------------------------------------------------------------------------------------------
int32_t C_PuiSdHandlerHalc::SetHalcDomainChannelParameterConfigElementPlain(
    const uint32_t ou32_NodeIndex, const uint32_t ou32_DomainIndex,
    const uint32_t ou32_ChannelIndex, const uint32_t ou32_ParameterIndex,
    const uint32_t ou32_ElementIndex, const bool oq_UseChannelIndex,
  ...
  if (ou32_NodeIndex < this->mc_CoreDefinition.c_Nodes.size()) {
    C_OscNode &rc_Node = this->mc_CoreDefinition.c_Nodes[ou32_NodeIndex];
    s32_Retval =
        rc_Node.c_HalcConfig.SetDomainChannelParameterConfigElementPlain(
            ou32_DomainIndex, ou32_ChannelIndex, ou32_ParameterIndex,
            ou32_ElementIndex, oq_UseChannelIndex, orc_Value);
  } else {
    s32_Retval = C_RANGE;
  }
...
*/
//----------------------------------------------------------------------------------------------------------------------
int32_t C_PuiSdHandlerHalc::SetHalcDomainChannelParameterConfigElementEnum(
    const uint32_t ou32_NodeIndex, const uint32_t ou32_DomainIndex,
    const uint32_t ou32_ChannelIndex, const uint32_t ou32_ParameterIndex,
    const uint32_t ou32_ElementIndex, const bool oq_UseChannelIndex,
  ...
  if (ou32_NodeIndex < this->mc_CoreDefinition.c_Nodes.size()) {
    C_OscNode &rc_Node = this->mc_CoreDefinition.c_Nodes[ou32_NodeIndex];
    s32_Retval =
        rc_Node.c_HalcConfig.SetDomainChannelParameterConfigElementEnum(
            ou32_DomainIndex, ou32_ChannelIndex, ou32_ParameterIndex,
            ou32_ElementIndex, oq_UseChannelIndex, orc_DisplayName);
  } else {
    s32_Retval = C_RANGE;
  }
...
*/
//----------------------------------------------------------------------------------------------------------------------
int32_t C_PuiSdHandlerHalc::SetHalcDomainChannelParameterConfigElementBitmask(
    const uint32_t ou32_NodeIndex, const uint32_t ou32_DomainIndex,
    const uint32_t ou32_ChannelIndex, const uint32_t ou32_ParameterIndex,
    const uint32_t ou32_ElementIndex, const bool oq_UseChannelIndex,
    const QString &orc_DisplayName, const bool oq_Value) {
  int32_t s32_Retval = C_NO_ERR;

  if (ou32_NodeIndex < this->mc_CoreDefinition.c_Nodes.size()) {
    C_OscNode &rc_Node = this->mc_CoreDefinition.c_Nodes[ou32_NodeIndex];
    s32_Retval =
        rc_Node.c_HalcConfig.SetDomainChannelParameterConfigElementBitmask(
            ou32_DomainIndex, ou32_ChannelIndex, ou32_ParameterIndex,
            ou32_ElementIndex, oq_UseChannelIndex, orc_DisplayName, oq_Value);
  } else {
    s32_Retval = C_RANGE;
  }
...
*/
//----------------------------------------------------------------------------------------------------------------------
int32_t C_PuiSdHandlerHalc::SetHalcDomainChannelParameterConfigElementString(
    const uint32_t ou32_NodeIndex, const uint32_t ou32_DomainIndex,
    const uint32_t ou32_ChannelIndex, const uint32_t ou32_ParameterIndex,
    const uint32_t ou32_ElementIndex, const bool oq_UseChannelIndex,
  ...
  if (ou32_NodeIndex < this->mc_CoreDefinition.c_Nodes.size()) {
    C_OscNode &rc_Node = this->mc_CoreDefinition.c_Nodes[ou32_NodeIndex];
    s32_Retval =
        rc_Node.c_HalcConfig.SetDomainChannelParameterConfigElementString(
            ou32_DomainIndex, ou32_ChannelIndex, ou32_ParameterIndex,
            ou32_ElementIndex, oq_UseChannelIndex, orc_Value);
  } else {
    s32_Retval = C_RANGE;
...
*/
//----------------------------------------------------------------------------------------------------------------------
int32_t C_PuiSdHandlerHalc::GetHalChannelOrDomainName(
    const uint32_t ou32_NodeIndex, const uint32_t ou32_DomainIndex,
    const uint32_t ou32_Channel, QString &orc_Name) const {
  int32_t s32_Retval = C_NO_ERR;
  const C_OscHalcDefChannelDef *const pc_ChannelDef =
      this->GetHalcDomainFileChannelDataConst(ou32_NodeIndex, ou32_DomainIndex,
                                              ou32_Channel);
...
*/
//----------------------------------------------------------------------------------------------------------------------
int32_t C_PuiSdHandlerHalc::TranslateToHalcIndex(
    const C_OscNodeDataPoolListElementId &orc_Id,
  ...
  const C_OscNodeDataPool *const pc_Dp =
      this->GetOscDataPool(orc_Id.u32_NodeIndex, orc_Id.u32_DataPoolIndex);
  ...
  if ((pc_Node != NULL) && (pc_Dp != NULL)) {
    const C_OscHalcMagicianDatapoolListHandler c_DpHandler(
        pc_Node->c_HalcConfig, ore_Selector, pc_Dp->q_IsSafety);
    bool q_Found = false;
    ...
    for (uint32_t u32_ItDomain = 0UL;
      ...
      if ((pc_CurrentDomainDef != NULL) && (pc_CurrentDomainConfig != NULL)) {
        const uint32_t u32_CountRelevantItems = c_DpHandler.CountRelevantItems(
            pc_CurrentDomainConfig->c_ChannelConfigs,
            pc_CurrentDomainConfig->c_DomainConfig);
        // other values
        if (u32_CountRelevantItems > 0UL) {
          // channels
          if (ore_Selector == C_OscHalcDefDomain::eVA_PARAM) {
            if (c_DpHandler.CheckChanNumVariableNecessary(
                    *pc_CurrentDomainConfig)) {
              if (u32_ListIndex == orc_Id.u32_ElementIndex) {
                oru32_DomainIndex = u32_ItDomain;
                orq_UseChannelIndex =
                    pc_CurrentDomainDef->c_Channels.size() > 0UL;
          ...
          if (q_Found == false) {
            ...
            if (q_Found == false) {
              // usecase
              if (ore_Selector == C_OscHalcDefDomain::eVA_PARAM) {
                if (c_DpHandler.CheckUseCaseVariableNecessary(
                        *pc_CurrentDomainConfig)) {
                  if (u32_ListIndex == orc_Id.u32_ElementIndex) {
                    oru32_DomainIndex = u32_ItDomain;
                    orq_UseChannelIndex =
              ...
              if (q_Found == false) {
                ...
                if (pc_CurrentDomainConfig->c_ChannelConfigs.size() == 0UL) {
                  ...
                  case C_OscHalcDefDomain::eVA_PARAM:
                    u32_ListIndex +=
                        C_OscHalcMagicianDatapoolListHandler::h_CountElements(
                            pc_CurrentDomainDef->c_DomainValues.c_Parameters,
                            u32_CountRelevantItems);
                    break;
                  case C_OscHalcDefDomain::eVA_INPUT:
                    u32_ListIndex +=
                        C_OscHalcMagicianDatapoolListHandler::h_CountElements(
                  ...
                  if (pc_CurrentDomainConfig->c_ChannelConfigs.size() == 0UL) {
                    ...
                    case C_OscHalcDefDomain::eVA_PARAM:
                      s32_Retval = C_PuiSdHandlerHalc::mh_GetIndexInVector(
                          pc_CurrentDomainDef->c_DomainValues.c_Parameters,
                          u32_StartingIndex, orc_Id.u32_ElementIndex,
                          oru32_ParameterIndex, orq_UseElementIndex,
          ...
          if (q_Found) {
            if (pc_CurrentDomainConfig->c_ChannelConfigs.size() > 0UL) {
              ...
              for (uint32_t u32_ItChannel = 0UL;
                   u32_ItChannel <
                   pc_CurrentDomainConfig->c_ChannelConfigs.size();
                   ++u32_ItChannel) {
...
//----------------------------------------------------------------------------------------------------------------------
/*! \brief  Check if the HALC configuration is clear or if it has a loaded
   definition/configuration

   \param[in]   ou32_NodeIndex   Node index
   \param[out]  orq_IsClear      true    Definition is cleared. No definition is
   loaded. false   The definition is not cleared. A concrete definition is
   loaded.
...
*/
//----------------------------------------------------------------------------------------------------------------------
int32_t C_PuiSdHandlerHalc::IsHalcClear(const uint32_t ou32_NodeIndex,
                                        bool &orq_IsClear) {
  int32_t s32_Retval = C_NO_ERR;
...
*/
//----------------------------------------------------------------------------------------------------------------------
int32_t C_PuiSdHandlerHalc::SetHalcDomainChannelConfigOfLinkedChannels(
    const uint32_t ou32_NodeIndex, const uint32_t ou32_DomainIndex,
    const uint32_t ou32_ChannelIndex, const bool oq_UseChannelIndex,
    const uint32_t ou32_UseCaseIndexOld, const uint32_t ou32_UseCaseIndexNew) {
  int32_t s32_Retval = C_NO_ERR;
  ...
  if (oq_UseChannelIndex == true) {
    ...
    s32_Retval = this->CheckHalcDomainChannelLinked(
        ou32_NodeIndex, ou32_DomainIndex, ou32_ChannelIndex, oq_UseChannelIndex,
        q_IsLinkedOld, NULL, &c_LinkedChannelIndicesOld, &ou32_UseCaseIndexOld);

    if (s32_Retval == C_NO_ERR) {
      s32_Retval = this->CheckHalcDomainChannelLinked(
          ou32_NodeIndex, ou32_DomainIndex, ou32_ChannelIndex,
          oq_UseChannelIndex, q_IsLinkedNew, NULL, &c_LinkedChannelIndicesNew,
          &ou32_UseCaseIndexNew);
    }
    ...
    if ((s32_Retval == C_NO_ERR) &&
      ...
      if (q_IsLinkedOld == true) {
        for (std::vector<uint32_t>::const_iterator c_ItChannels =
             ...
             (s32_Retval == C_NO_ERR);
             ++c_ItChannels) {
          s32_Retval = this->ResetHalcDomainChannelUseCase(
              ou32_NodeIndex, ou32_DomainIndex, *c_ItChannels, true);
        }
      }
      ...
      if ((s32_Retval == C_NO_ERR) && (q_IsLinkedNew == true)) {
        const C_OscHalcConfigChannel *const pc_Channel =
            this->GetHalcDomainChannelConfigData(
                ou32_NodeIndex, ou32_DomainIndex, ou32_ChannelIndex,
                oq_UseChannelIndex);
        if (pc_Channel != NULL) {
          for (std::vector<uint32_t>::const_iterator c_ItChannels =
               ...
               (s32_Retval == C_NO_ERR);
               ++c_ItChannels) {
            s32_Retval = this->SetHalcDomainChannelConfigUseCase(
                ou32_NodeIndex, ou32_DomainIndex, *c_ItChannels, true,
                ou32_UseCaseIndexNew);

            // update all parameters in linked channel
            for (uint32_t u32_ItParams = 0;
                 (u32_ItParams < pc_Channel->c_Parameters.size()) &&
                 (s32_Retval == C_NO_ERR);
                 u32_ItParams++) {
              const C_OscHalcConfigParameterStruct &rc_Parameter =
                  pc_Channel->c_Parameters[u32_ItParams];

              s32_Retval = this->SetHalcDomainChannelParameterConfig(
                  ou32_NodeIndex, ou32_DomainIndex, *c_ItChannels, u32_ItParams,
                  true, rc_Parameter);
            }
          }
        } else {
...
*/
//----------------------------------------------------------------------------------------------------------------------
int32_t C_PuiSdHandlerHalc::CheckHalcDomainChannelError(
    const uint32_t ou32_NodeIndex, const uint32_t ou32_DomainIndex,
    const uint32_t ou32_ChannelIndex, const bool oq_UseChannelIndex,
  ...
  if (pc_Node != NULL) {
    ...
    if (oq_UseChannelIndex == true) {
      orq_HasError = false;
      for (uint32_t u32_Inv = 0UL; u32_Inv < c_InvalidChannelIndices.size();
           ++u32_Inv) {
...
int32_t C_PuiSdHandlerHalc::GetHalcRelevantIndicesForSelectedUseCase(
  ...
  if (pc_Node != NULL) {
    s32_Retval = pc_Node->c_HalcConfig.GetRelevantIndicesForSelectedUseCase(
        ou32_DomainIndex, ou32_ChannelIndex, oq_UseChannelIndex,
        opc_ParameterIndices, opc_InputIndices, opc_OutputIndices,
        opc_StatusIndices);
  } else {
    s32_Retval = C_RANGE;
  }
...
//----------------------------------------------------------------------------------------------------------------------
int32_t
C_PuiSdHandlerHalc::HalcGenerateDatapools(const uint32_t ou32_NodeIndex) {
  int32_t s32_Retval;
  ...
  if ((ou32_NodeIndex < this->mc_CoreDefinition.c_Nodes.size()) &&
    ...
    if ((c_ItPrevHash == mc_PreviousHashes.end()) ||
      ...
      for (uint32_t u32_DatapoolCounter = 0U;
           u32_DatapoolCounter < rc_OscNode.c_DataPools.size();
           ++u32_DatapoolCounter) {
        const C_OscNodeDataPool &rc_Datapool =
            rc_OscNode.c_DataPools[u32_DatapoolCounter];
      ...
      if (s32_Retval == C_NO_ERR) {
        ...
        if (rc_OscNode.c_HalcConfig.c_FileString.isEmpty() == false) {
          ...
          if (s32_Retval == C_NO_ERR) {
            ...
            Q_ASSERT(rc_OscNode.c_DataPools.size() ==
            ...
            if (rc_OscNode.c_DataPools.size() ==
              ...
              for (uint32_t u32_It = 0UL; u32_It < c_Datapools.size();
                ...
                const C_PuiSdNodeDataPool c_Tmp2 =
                    C_PuiSdHandlerHalc::mh_GetUiDatapoolForOscDataPool(
                        c_Datapools[u32_It]);
                ...
                if (c_Tmp.size() == c_Datapools.size()) {
                  ...
                  if (rc_Tmp.c_Name == rc_Datapool.c_Name) {
                    ...
                    rc_Datapool.s32_RelatedDataBlockIndex =
                        rc_Tmp.s32_RelatedDataBlockIndex;
                    rc_Datapool.u16_DefinitionCrcVersion =
                        rc_Tmp.u16_DefinitionCrcVersion;
                  }
                }
...
//----------------------------------------------------------------------------------------------------------------------
int32_t
C_PuiSdHandlerHalc::HalcRemoveDatapools(const uint32_t ou32_NodeIndex,
  ...
  if (ou32_NodeIndex < this->mc_CoreDefinition.c_Nodes.size()) {
    ...
    for (; c_ItOsc != rc_OscNode.c_DataPools.end();) {
      if ((c_ItOsc->e_Type == C_OscNodeDataPool::eHALC) ||
          (c_ItOsc->e_Type == C_OscNodeDataPool::eHALC_NVM)) {
        // Remove Datapool
        s32_Retval = this->RemoveDataPool(ou32_NodeIndex, u32_DatapoolIndex,
                                          oq_SuppressSyncSignal);
      } else {
        // Iterate
        ++c_ItOsc;
        ++u32_DatapoolIndex;
...
int32_t C_PuiSdHandlerHalc::HalcResetDataBlocks(const uint32_t ou32_NodeIndex) {
  ...
  if (ou32_NodeIndex < this->mc_CoreDefinition.c_Nodes.size()) {
    ...
    for (u32_Counter = 0U; u32_Counter < rc_OscNode.c_Applications.size();
         ++u32_Counter) {
      ...
      if (rc_App.e_Type == C_OscNodeApplication::ePARAMETER_SET_HALC) {
        Q_EMIT(this->SigSyncNodeApplicationAboutToBeChangedFromParamSetHalc(
            ou32_NodeIndex, u32_Counter));
...
/*! \brief  Check HALC channel name available
   ...
   \param[in]  opu32_ChannelIndexToSkip   Channel index to skip
                                          (Use-case: skip current channel to
...
*/
//----------------------------------------------------------------------------------------------------------------------
bool C_PuiSdHandlerHalc::CheckHalcChannelNameAvailable(
    const uint32_t ou32_NodeIndex, const uint32_t ou32_DomainIndex,
  ...
  if (pc_Domain != NULL) {
    ...
    for (uint32_t u32_ItChannel = 0;
         (u32_ItChannel < pc_Domain->c_ChannelConfigs.size()) &&
         (q_Retval == true);
         ++u32_ItChannel) {
      bool q_Skip = false;
...
*/
//----------------------------------------------------------------------------------------------------------------------
C_PuiSdNodeDataPool C_PuiSdHandlerHalc::mh_GetUiDatapoolForOscDataPool(
    const C_OscNodeDataPool &orc_OscDatapool) {
  C_PuiSdNodeDataPool c_Retval;

  c_Retval.c_DataPoolLists.clear();

  for (uint32_t u32_It = 0UL; u32_It < orc_OscDatapool.c_Lists.size();
       ++u32_It) {
    ...
    for (uint32_t u32_ItElem = 0UL; u32_ItElem < rc_List.c_Elements.size();
         ++u32_ItElem) {
...
int32_t C_PuiSdHandlerHalc::mh_GetIndexInVector(
  ...
  for (uint32_t u32_ItItem = 0UL;
       (u32_ItItem < orc_Structs.size()) && (q_Found == false); ++u32_ItItem) {
    const uint32_t u32_StartingIndex = u32_Counter;
    u32_Counter += C_OscHalcMagicianDatapoolListHandler::h_CountElements(
        orc_Structs[u32_ItItem], ou32_NumChannelsInDatapool);
    if (u32_Counter > ou32_TargetIndex) {
      ...
      if (rc_Struct.c_StructElements.size() > 0UL) {
        ...
        for (uint32_t u32_ItEl = 0UL;
             (u32_ItEl < rc_Struct.c_StructElements.size()) &&
             (q_Found == false);
             ++u32_ItEl) {
          u32_Counter += C_OscHalcMagicianDatapoolListHandler::h_CountElements(
