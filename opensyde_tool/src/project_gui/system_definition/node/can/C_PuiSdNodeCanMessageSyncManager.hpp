...
public:
   ...
   void CheckMessageNameBus(const QString & orc_MessageName, bool & orq_Valid, const stw::opensyde_core::C_OscCanMessageIdentificationIndices * const opc_SkipMessage =
