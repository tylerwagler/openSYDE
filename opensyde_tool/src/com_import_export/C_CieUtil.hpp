...
private:
   ...
   static int32_t mh_HandleSignalsOfMatchingMessage(const C_PuiSdNodeCanMessageSyncManager & orc_SyncManager,
                                                    const stw::opensyde_core::C_OscCanMessageIdentificationIndices & orc_MatchingMessageId,
                                                    const std::vector<stw::opensyde_core::C_OscCanSignal> & orc_CorePreviousSignals,
                                                    const std::vector<stw::opensyde_core::C_OscCanSignal> & orc_CoreNewSignals,
                                                    const std::vector<C_PuiSdNodeCanSignal> & orc_UiNewSignals,
                                                    const std::vector<stw::opensyde_core::C_OscNodeDataPoolListElement> & orc_CoreNewSignalData,
                                                    const std::vector<stw::opensyde_gui_logic::C_PuiSdNodeDataPoolListElement> & orc_UiNewSignalData);
