...
public:
  ...
  public:
    QString c_Name;    ///< unique name of bus
  ...
  public:
    ...
    stw::opensyde_core::C_OscNodeDataPoolContent
        c_MinValue; ///< Minimum value(s) for complete data
                    // element
    stw::opensyde_core::C_OscNodeDataPoolContent
        c_MaxValue;       ///< Maximum value(s) for complete data
                          // element
  ...
  public:
    ...
    stw::opensyde_core::C_OscCanSignal::E_ByteOrderType
        e_ComByteOrder;        ///< Communication value byte order
    ...
    stw::opensyde_core::C_OscCanSignal::E_MultiplexerType
        e_MultiplexerType;       ///< Signal multiplexer type
  ...
  public:
    ...
    stw::opensyde_core::C_OscCanMessage::E_TxMethodType
  ...
  public:
    ...
    QStringList
        c_Warnings; ///< Appropriate warnings: if empty, there is no warning
  };
