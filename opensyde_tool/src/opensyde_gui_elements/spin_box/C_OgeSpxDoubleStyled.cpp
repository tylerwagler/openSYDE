...
*/
//----------------------------------------------------------------------------------------------------------------------
C_OgeSpxDoubleStyled::C_OgeSpxDoubleStyled(QWidget * const opc_Parent) :
...
*/
//----------------------------------------------------------------------------------------------------------------------
C_OgeSpxDoubleStyled::C_OgeSpxDoubleStyled(const QString & orc_Variant, QWidget * const opc_Parent) :
   C_OgeSpxDoubleToolTipBase(opc_Parent),
...
*/
//----------------------------------------------------------------------------------------------------------------------
QString C_OgeSpxDoubleStyled::GetVariant(void) const
{
...
*/
//----------------------------------------------------------------------------------------------------------------------
void C_OgeSpxDoubleStyled::SetVariant(const QString & orc_Variant)
{
