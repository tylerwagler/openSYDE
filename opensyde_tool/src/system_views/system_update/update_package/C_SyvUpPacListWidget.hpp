...
public:
  ...
  int32_t CheckAllPaths(uint32_t &oru32_CountFiles,
...
protected:
  ...
  void m_MoveItem(const int32_t os32_SourceIndex,
                  const int32_t os32_TargetIndex) override;
...
private:
  ...
  void m_AddNodeWidget(const uint32_t ou32_NodeIndex,
  ...
  void m_AddNewFile(const QString &orc_DialogCaption,
