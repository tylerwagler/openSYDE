...
class C_SyvUpPacSecurityCertificatePackageDialog : public QWidget {
  Q_OBJECT

public:
  explicit C_SyvUpPacSecurityCertificatePackageDialog(
...
private:
  ...
  C_SyvUpPacSecurityCertificatePackageDialog(
      const C_SyvUpPacSecurityCertificatePackageDialog &);
  C_SyvUpPacSecurityCertificatePackageDialog &
  operator=(const C_SyvUpPacSecurityCertificatePackageDialog &) &;
