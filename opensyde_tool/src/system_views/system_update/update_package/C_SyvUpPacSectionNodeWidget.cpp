                ...
                (c_File.isFile() == true))
            {
                   ...
                   (pc_App->GetState() != C_SyvUpPacListNodeItemWidget::hu32_STATE_FINISHED))
               {
                  if ((q_ParamSetFile == false) &&
                      (q_PemFile == false))
                  {
                     orc_ApplicationsToWrite.c_FilesToFlash.emplace_back(c_Path);
                  }
                  else if (q_ParamSetFile == true)
                  {
                     orc_ApplicationsToWrite.c_FilesToWriteToNvm.emplace_back(c_Path);
                  }
                  else
                  {
               ...
               if (opc_AllApplications != NULL)
               {
                  ...
                  if ((q_ParamSetFile == false) &&
                      (q_PemFile == false))
                  {
                     opc_AllApplications->c_FilesToFlash.emplace_back(c_Path);
                  }
                  else if (q_ParamSetFile == true)
                  {
                     opc_AllApplications->c_FilesToWriteToNvm.emplace_back(c_Path);
                  }
                  else
                  {
