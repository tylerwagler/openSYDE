...
public:
   ...
   void SetContent(const bool oq_ValidSerialNumber,
                   const stw::opensyde_core::C_OscProtocolSerialNumber & orc_PureSerialNumber, const QHash<uint8_t,
                                                                                                              stw::opensyde_core::C_OscDcDeviceOldComConfig> & orc_SubNodeIdsToOldNodeIds);
   bool IsAssigned(void) const;
   void GetContent(stw::opensyde_core::C_OscProtocolSerialNumber & orc_PureSerialNumber, QHash<uint8_t,
...
private:
   ...
   bool mq_Assigned;
   QHash<uint8_t, stw::opensyde_core::C_OscDcDeviceOldComConfig> mc_SubNodeIdsToOldNodeIds;
