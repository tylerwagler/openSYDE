...
class C_SyvClipBoardHelper : public C_UtiClipBoardHelper {
public:
  static void h_StoreDashboardToClipboard(
  ...
  static int32_t h_LoadDashboardFromClipboard(
...
private:
  ...
  static void mh_StoreDashboardToClipboard(
      const C_PuiSvDashboard &orc_Data,
      const QMap<stw::opensyde_core::C_OscNodeDataPoolListElementId,
                 C_PuiSvReadDataConfiguration> &orc_Rails,
      const QMap<C_PuiSvDbNodeDataPoolListElementId, C_PuiSvDbElementIdCrcGroup>
          &orc_ElementIdGroups,
      const QString &orc_GenericTagName);
  static void mh_StoreElementIdGroups(
      const QMap<C_PuiSvDbNodeDataPoolListElementId, C_PuiSvDbElementIdCrcGroup>
          &orc_ElementIdGroups,
      const QString &orc_GenericTagName,
  ...
  static int32_t mh_LoadDashboardFromClipboard(
      ...
      QMap<C_PuiSvDbNodeDataPoolListElementId, C_PuiSvDbElementIdCrcGroup>
          &orc_ElementIdGroups,
      const QString &orc_GenericTagName);
  static int32_t mh_LoadElementIdGroups(
      QMap<C_PuiSvDbNodeDataPoolListElementId, C_PuiSvDbElementIdCrcGroup>
          &orc_ElementIdGroups,
      const QString &orc_GenericTagName,
      stw::opensyde_core::C_OscXmlParserBase &orc_XmlParser);
