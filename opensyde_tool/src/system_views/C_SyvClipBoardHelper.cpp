...
*/
//----------------------------------------------------------------------------------------------------------------------
void C_SyvClipBoardHelper::h_StoreDashboardToClipboard(
  ...
  const QMap<C_PuiSvDbNodeDataPoolListElementId, C_PuiSvDbElementIdCrcGroup>
      c_ElementIdGroups =
          C_SyvClipBoardHelper::mh_FillElementIdGroups(orc_Data, orc_Rails);

  C_SyvClipBoardHelper::mh_StoreDashboardToClipboard(
      orc_Data, orc_Rails, c_ElementIdGroups, orc_GenericTagName);
}
...
*/
//----------------------------------------------------------------------------------------------------------------------
int32_t C_SyvClipBoardHelper::h_LoadDashboardFromClipboard(
    ...
    QMap<C_PuiSvDbNodeDataPoolListElementId, C_PuiSvDbElementIdCrcGroup>
        &orc_ElementIdGroups,
    const QString &orc_GenericTagName) {
  int32_t s32_Retval = C_SyvClipBoardHelper::mh_LoadDashboardFromClipboard(
      orc_Data, orc_Rails, orc_ElementIdGroups, orc_GenericTagName);

  if (s32_Retval == C_NO_ERR) {
    s32_Retval = C_SyvClipBoardHelper::mh_ValidateIds(orc_Data, orc_Rails,
                                                      orc_ElementIdGroups);
  }
 ...
 */
//----------------------------------------------------------------------------------------------------------------------
C_SyvClipBoardHelper::C_SyvClipBoardHelper(void) : C_UtiClipBoardHelper() {}
...
*/
//----------------------------------------------------------------------------------------------------------------------
void C_SyvClipBoardHelper::mh_StoreDashboardToClipboard(
    const C_PuiSvDashboard &orc_Data,
    const QMap<C_OscNodeDataPoolListElementId, C_PuiSvReadDataConfiguration>
        &orc_Rails,
    const QMap<C_PuiSvDbNodeDataPoolListElementId, C_PuiSvDbElementIdCrcGroup>
...
void C_SyvClipBoardHelper::mh_StoreElementIdGroups(
  ...
  for (QMap<C_PuiSvDbNodeDataPoolListElementId,
           ...
           orc_ElementIdGroups.cbegin();
       c_It != orc_ElementIdGroups.cend(); ++c_It) {
    C_SyvClipBoardHelper::mh_StoreElementIdGroup(c_It.key(), c_It.value(),
                                                 orc_XmlParser);
  }
...
*/
//----------------------------------------------------------------------------------------------------------------------
int32_t C_SyvClipBoardHelper::mh_LoadDashboardFromClipboard(
    C_PuiSvDashboard &orc_Data,
    QMap<stw::opensyde_core::C_OscNodeDataPoolListElementId,
         C_PuiSvReadDataConfiguration> &orc_Rails,
    QMap<C_PuiSvDbNodeDataPoolListElementId, C_PuiSvDbElementIdCrcGroup>
  ...
  if (c_StringXml.SelectRoot() == orc_GenericTagName) {
    ...
    if (s32_Retval == C_NO_ERR) {
      s32_Retval = C_SyvClipBoardHelper::mh_LoadElementIdGroups(
          orc_ElementIdGroups, orc_GenericTagName, c_StringXml);
    } else {
      s32_Retval = C_CONFIG;
    }
...
//----------------------------------------------------------------------------------------------------------------------
QMap<C_PuiSvDbNodeDataPoolListElementId, C_PuiSvDbElementIdCrcGroup>
C_SyvClipBoardHelper::mh_FillElementIdGroups(
    const C_PuiSvDashboard &orc_Data,
    const QMap<C_OscNodeDataPoolListElementId, C_PuiSvReadDataConfiguration>
        &orc_Rails) {
...
QSet<C_PuiSvDbNodeDataPoolListElementId> C_SyvClipBoardHelper::mh_GetAllIds(
  ...
  for (QMap<C_OscNodeDataPoolListElementId,
           ...
           orc_Rails.cbegin();
       c_It != orc_Rails.cend(); ++c_It) {
    const C_PuiSvDbNodeDataPoolListElementId c_Tmp(
        c_It.key(), C_PuiSvDbNodeDataPoolListElementId::eDATAPOOL_ELEMENT,
        false, 0UL);
...
*/
//----------------------------------------------------------------------------------------------------------------------
int32_t C_SyvClipBoardHelper::mh_ValidateIds(
    const C_PuiSvDashboard &orc_Data,
    const QMap<C_OscNodeDataPoolListElementId, C_PuiSvReadDataConfiguration>
        &orc_Rails,
    const QMap<C_PuiSvDbNodeDataPoolListElementId, C_PuiSvDbElementIdCrcGroup>
