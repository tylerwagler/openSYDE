   ...
   mu32_ViewIndex(ou32_ViewIndex)
{
   ...
   //Connects
   connect(this->mpc_Ui->pc_PushButtonOk, &stw::opensyde_gui_elements::C_OgePubStyled::clicked, this,
           &C_SyvDaDashboardSettings::m_OkClicked);
   connect(this->mpc_Ui->pc_PushButtonCancel, &stw::opensyde_gui_elements::C_OgePubStyled::clicked, this,
