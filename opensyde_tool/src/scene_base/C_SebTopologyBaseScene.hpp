...
protected:
   ...
   uint64_t m_GetNewUniqueBusConnectorId(const QMap<
                                            ...
                                            uint64_t> * const opc_IdMap = NULL, const uint32_t & oru32_Index = 0, const QList<stw::opensyde_gui_logic::C_PuiSdCompleteBusConnectionData> * const opc_AdditionalConnectionData =
                                            NULL);
