...
{
public:
   C_SebUnoBaseCommand(QGraphicsScene * const opc_Scene, const QList<uint64_t> & orc_Ids,
...
protected:
   QList<QGraphicsItem *> m_GetSceneItems(void) const;
   ...
   const QList<uint64_t> m_GetIds(void) const;

private:
   const QList<uint64_t> mc_Ids;
};
