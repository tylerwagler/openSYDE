   ...
   mrc_ParentDialog(orc_Parent)
{
   ...
   connect(this->mpc_Ui->pc_PushButtonCancel, &C_OgePubStyled::clicked, this, &C_PopSaveAsDialogWidget::m_OnCancel);
}
...
void C_PopSaveAsDialogWidget::m_OnSave(void)
{
   ...
   const bool q_ValidName = C_OscUtils::h_CheckValidFileName(c_Name);
   const bool q_ValidPath = C_OscUtils::h_CheckValidFilePath(c_BasePath);
