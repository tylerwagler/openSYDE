         ...
         if (q_Temp == false)
         {
            ...
            osc_write_log_error("Open IDE",
                                static_cast<QString>(
                                   ...
                                   " \"%1\" is missing.").arg(orc_IdeExeCall).toStdString());
         }
      }
   }
   else
                                               ...
                                               const QString & orc_AbsoluteReferenceDir)
{
   ...
   if (C_OscUtils::h_CheckValidFilePath(orc_Path.toStdString()) == false)
   {
                                                   ...
                                                   const QString & orc_AbsoluteReferenceDir)
{
   ...
   else if (orc_Paths.isEmpty() == false)
   {
      ...
      {
         if (C_OscUtils::h_CheckValidFilePath(c_Return[s32_Pos].toStdString()) == false)
         {
