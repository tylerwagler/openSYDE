                                                                              ...
                                                                              u32_DeviceInterfaceIndex) == C_NO_ERR)
      {
         ...
         if (pc_Node != NULL)
         {
            ...
            if (u32_DeviceInterfaceIndex < pc_Node->c_Properties.c_ComInterfaces.size())
            {
               ...
               {
                  QList<C_CieImportDataAssignment> c_NodeAssignmenVector = {c_NodeAssignment};
                  QList<C_CieImportDataAssignment> c_InvalidNodeAssignmentVector = {c_InvalidNodeAssignment};
                  //Prepare data
...
void C_SdNdeCoDeviceEdsWidget::m_SetDetails(void)
{
   ...
   if (pc_CanOpenDeviceInfo != NULL)
   {
      ...
      this->mpc_Ui->pc_LabFileCurrent->setText(
         pc_CanOpenDeviceInfo->c_OriginalEdsFileName);
