...
private:
   ...
   static bool mh_ParseTokens(const std::string & orc_Expression,
                              std::vector<stw::opensyde_core::C_OscDataLoggerTriggerParser::C_Token> & orc_Tokens, std::string * const opc_ErrorDetails);
   static bool mh_ReplaceChannelTokens(std::vector<stw::opensyde_core::C_OscDataLoggerTriggerParser::C_Token> & orc_Tokens,
                                       std::string * const opc_ErrorDetails);
   static bool mh_CheckSyntax(const std::vector<stw::opensyde_core::C_OscDataLoggerTriggerParser::C_Token> & orc_Tokens,
                              std::string * const opc_ErrorDetails);
   static bool mh_CheckTokens(const uint32_t ou32_NodeIndex, const std::vector<stw::opensyde_core::C_OscDataLoggerTriggerParser::C_Token> & orc_Tokens,
                              std::string * const opc_ErrorDetails);
