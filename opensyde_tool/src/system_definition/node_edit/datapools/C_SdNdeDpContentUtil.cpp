...
/*!
   \file
   \brief       Utilitiy functions for C_OscNodeDataPoolContent access
   (implementation)
...
*/
//----------------------------------------------------------------------------------------------------------------------
int32_t C_SdNdeDpContentUtil::h_GetValueAsFloat64(
    const C_OscNodeDataPoolContent &orc_Content, float64_t &orf64_Output,
  ...
  if (orc_Content.GetArray()) {
    if (ou32_Index < orc_Content.GetArraySize()) {
      ...
      case C_OscNodeDataPoolContent::eUINT8:
        orf64_Output = static_cast<float64_t>(
            orc_Content.GetValueArrU8Element(ou32_Index));
        break;
      case C_OscNodeDataPoolContent::eUINT16:
        orf64_Output = static_cast<float64_t>(
            orc_Content.GetValueArrU16Element(ou32_Index));
        break;
      case C_OscNodeDataPoolContent::eUINT32:
        orf64_Output = static_cast<float64_t>(
            orc_Content.GetValueArrU32Element(ou32_Index));
        break;
      case C_OscNodeDataPoolContent::eUINT64:
        orf64_Output = static_cast<float64_t>(
            orc_Content.GetValueArrU64Element(ou32_Index));
        break;
      case C_OscNodeDataPoolContent::eSINT8:
        orf64_Output = static_cast<float64_t>(
            orc_Content.GetValueArrS8Element(ou32_Index));
        break;
      case C_OscNodeDataPoolContent::eSINT16:
        orf64_Output = static_cast<float64_t>(
            orc_Content.GetValueArrS16Element(ou32_Index));
        break;
      case C_OscNodeDataPoolContent::eSINT32:
        orf64_Output = static_cast<float64_t>(
            orc_Content.GetValueArrS32Element(ou32_Index));
        break;
      case C_OscNodeDataPoolContent::eSINT64:
        orf64_Output = static_cast<float64_t>(
            orc_Content.GetValueArrS64Element(ou32_Index));
        break;
      case C_OscNodeDataPoolContent::eFLOAT32:
        orf64_Output = static_cast<float64_t>(
            orc_Content.GetValueArrF32Element(ou32_Index));
        break;
...
void C_SdNdeDpContentUtil::h_GetValuesAsFloat64(
  ...
  if (orc_Content.GetArray() == true) {
    ...
    for (uint32_t u32_It = 0; u32_It < orc_Content.GetArraySize(); ++u32_It) {
      ...
      case C_OscNodeDataPoolContent::eUINT8:
        f64_Value =
            static_cast<float64_t>(orc_Content.GetValueArrU8Element(u32_It));
        break;
      case C_OscNodeDataPoolContent::eUINT16:
        f64_Value =
            static_cast<float64_t>(orc_Content.GetValueArrU16Element(u32_It));
        break;
      case C_OscNodeDataPoolContent::eUINT32:
        f64_Value =
            static_cast<float64_t>(orc_Content.GetValueArrU32Element(u32_It));
        break;
      case C_OscNodeDataPoolContent::eUINT64:
        f64_Value =
            static_cast<float64_t>(orc_Content.GetValueArrU64Element(u32_It));
        break;
      case C_OscNodeDataPoolContent::eSINT8:
        f64_Value =
            static_cast<float64_t>(orc_Content.GetValueArrS8Element(u32_It));
        break;
      case C_OscNodeDataPoolContent::eSINT16:
        f64_Value =
            static_cast<float64_t>(orc_Content.GetValueArrS16Element(u32_It));
        break;
      case C_OscNodeDataPoolContent::eSINT32:
        f64_Value =
            static_cast<float64_t>(orc_Content.GetValueArrS32Element(u32_It));
        break;
      case C_OscNodeDataPoolContent::eSINT64:
        f64_Value =
            static_cast<float64_t>(orc_Content.GetValueArrS64Element(u32_It));
        break;
      case C_OscNodeDataPoolContent::eFLOAT32:
        f64_Value =
            static_cast<float64_t>(orc_Content.GetValueArrF32Element(u32_It));
        break;
      case C_OscNodeDataPoolContent::eFLOAT64:
...
*/
//----------------------------------------------------------------------------------------------------------------------
void C_SdNdeDpContentUtil::h_GetAnyValueAsUint64(
    const C_OscNodeDataPoolContent &orc_Content, uint64_t &oru64_Output,
    const uint32_t ou32_Index) {
  oru64_Output = 0;
  ...
  if (orc_Content.GetArray() == true) {
    if (ou32_Index < orc_Content.GetArraySize()) {
      ...
      case C_OscNodeDataPoolContent::eUINT8:
        oru64_Output =
            static_cast<uint64_t>(orc_Content.GetValueArrU8Element(ou32_Index));
        break;
      case C_OscNodeDataPoolContent::eUINT16:
        oru64_Output = static_cast<uint64_t>(
            orc_Content.GetValueArrU16Element(ou32_Index));
        break;
      case C_OscNodeDataPoolContent::eUINT32:
        oru64_Output = static_cast<uint64_t>(
      ...
      case C_OscNodeDataPoolContent::eSINT8:
        oru64_Output = static_cast<uint64_t>(
            static_cast<uint8_t>(orc_Content.GetValueArrS8Element(ou32_Index)));
        break;
      case C_OscNodeDataPoolContent::eSINT16:
        oru64_Output = static_cast<uint64_t>(static_cast<uint16_t>(
            orc_Content.GetValueArrS16Element(ou32_Index)));
        break;
      case C_OscNodeDataPoolContent::eSINT32:
        oru64_Output = static_cast<uint64_t>(static_cast<uint32_t>(
            orc_Content.GetValueArrS32Element(ou32_Index)));
        break;
      case C_OscNodeDataPoolContent::eSINT64:
        oru64_Output = static_cast<uint64_t>(
      ...
      case C_OscNodeDataPoolContent::eFLOAT64:
        oru64_Output = static_cast<uint64_t>(
            orc_Content.GetValueArrF64Element(ou32_Index));
        break;
      default:
        break;
      }
    ...
    case C_OscNodeDataPoolContent::eSINT8:
      oru64_Output =
          static_cast<uint64_t>(static_cast<uint8_t>(orc_Content.GetValueS8()));
      break;
    case C_OscNodeDataPoolContent::eSINT16:
      oru64_Output = static_cast<uint64_t>(
          static_cast<uint16_t>(orc_Content.GetValueS16()));
      break;
    case C_OscNodeDataPoolContent::eSINT32:
      oru64_Output = static_cast<uint64_t>(
          static_cast<uint32_t>(orc_Content.GetValueS32()));
      break;
    case C_OscNodeDataPoolContent::eSINT64:
...
*/
//----------------------------------------------------------------------------------------------------------------------
void C_SdNdeDpContentUtil::h_GetAnyValueAsSint64(
    const C_OscNodeDataPoolContent &orc_Content, int64_t &ors64_Output,
    const uint32_t ou32_Index) {
  ors64_Output = 0;
  ...
  if (orc_Content.GetArray() == true) {
    if (ou32_Index < orc_Content.GetArraySize()) {
      ...
      case C_OscNodeDataPoolContent::eUINT8:
        ors64_Output =
            static_cast<int64_t>(orc_Content.GetValueArrU8Element(ou32_Index));
        break;
      case C_OscNodeDataPoolContent::eUINT16:
        ors64_Output =
            static_cast<int64_t>(orc_Content.GetValueArrU16Element(ou32_Index));
        break;
      case C_OscNodeDataPoolContent::eUINT32:
        ors64_Output =
            static_cast<int64_t>(orc_Content.GetValueArrU32Element(ou32_Index));
        break;
      case C_OscNodeDataPoolContent::eUINT64:
        ors64_Output =
            static_cast<int64_t>(orc_Content.GetValueArrU64Element(ou32_Index));
        break;
      case C_OscNodeDataPoolContent::eSINT8:
        ors64_Output =
            static_cast<int64_t>(orc_Content.GetValueArrS8Element(ou32_Index));
        break;
      case C_OscNodeDataPoolContent::eSINT16:
        ors64_Output =
            static_cast<int64_t>(orc_Content.GetValueArrS16Element(ou32_Index));
        break;
      case C_OscNodeDataPoolContent::eSINT32:
        ors64_Output =
            static_cast<int64_t>(orc_Content.GetValueArrS32Element(ou32_Index));
        break;
      case C_OscNodeDataPoolContent::eSINT64:
        ors64_Output =
            static_cast<int64_t>(orc_Content.GetValueArrS64Element(ou32_Index));
        break;
      case C_OscNodeDataPoolContent::eFLOAT32:
        ors64_Output =
            static_cast<int64_t>(orc_Content.GetValueArrF32Element(ou32_Index));
        break;
      case C_OscNodeDataPoolContent::eFLOAT64:
        ors64_Output =
            static_cast<int64_t>(orc_Content.GetValueArrF64Element(ou32_Index));
        break;
      default:
        break;
      }
...
/*! \brief   Sets a sint64 value in the content class
   ...
   The os64_Value value will be casted to the current type of the orc_Content
   class. If the orc_Content holds an array, the value will be set to the
   position ou32_ArrayIndex.

   Hint: for integer datatypes an offset for rounding is added, so that the
   decimal place is not lost by casting.

   \param[in]      os64_Value       Value to set and cast
   \param[in,out]  orc_Content      Content class with configured type and array
   configuration
   \param[in]      ou32_ArrayIndex  Optional index for array position if content
   class has an array
*/
//----------------------------------------------------------------------------------------------------------------------
void C_SdNdeDpContentUtil::h_SetValueInContentS64(
    const int64_t os64_Value, C_OscNodeDataPoolContent &orc_Content,
  ...
  case C_OscNodeDataPoolContent::eUINT8:
    if (os64_Value <=
        static_cast<int64_t>(std::numeric_limits<uint8_t>::lowest())) {
      if (orc_Content.GetArray() == true) {
        orc_Content.SetValueArrU8Element(std::numeric_limits<uint8_t>::lowest(),
                                         ou32_ArrayIndex);
      } else {
    ...
    if (os64_Value >=
      ...
      if (orc_Content.GetArray() == true) {
        orc_Content.SetValueArrU8Element(std::numeric_limits<uint8_t>::max(),
                                         ou32_ArrayIndex);
      } else {
  ...
  case C_OscNodeDataPoolContent::eUINT16:
    if (os64_Value <=
        static_cast<int64_t>(std::numeric_limits<uint16_t>::lowest())) {
      if (orc_Content.GetArray() == true) {
        orc_Content.SetValueArrU16Element(
            std::numeric_limits<uint16_t>::lowest(), ou32_ArrayIndex);
      } else {
    ...
    if (os64_Value >=
      ...
      if (orc_Content.GetArray() == true) {
        orc_Content.SetValueArrU16Element(std::numeric_limits<uint16_t>::max(),
                                          ou32_ArrayIndex);
      } else {
  ...
  case C_OscNodeDataPoolContent::eUINT32:
    if (os64_Value <=
      ...
      if (orc_Content.GetArray() == true) {
        orc_Content.SetValueArrU32Element(
            std::numeric_limits<uint32_t>::lowest(), ou32_ArrayIndex);
      } else {
    ...
    if (os64_Value >=
      ...
      if (orc_Content.GetArray() == true) {
        orc_Content.SetValueArrU32Element(std::numeric_limits<uint32_t>::max(),
                                          ou32_ArrayIndex);
      } else {
  ...
  case C_OscNodeDataPoolContent::eUINT64:
    if (os64_Value <=
      ...
      if (orc_Content.GetArray() == true) {
        orc_Content.SetValueArrU64Element(
            std::numeric_limits<uint64_t>::lowest(), ou32_ArrayIndex);
      } else {
  ...
  case C_OscNodeDataPoolContent::eSINT8:
    if (os64_Value <=
      ...
      if (orc_Content.GetArray() == true) {
        orc_Content.SetValueArrS8Element(std::numeric_limits<int8_t>::lowest(),
                                         ou32_ArrayIndex);
      } else {
    ...
    if (os64_Value >=
      ...
      if (orc_Content.GetArray() == true) {
        orc_Content.SetValueArrS8Element(std::numeric_limits<int8_t>::max(),
                                         ou32_ArrayIndex);
      } else {
  ...
  case C_OscNodeDataPoolContent::eSINT16:
    if (os64_Value <=
      ...
      if (orc_Content.GetArray() == true) {
        orc_Content.SetValueArrS16Element(
            std::numeric_limits<int16_t>::lowest(), ou32_ArrayIndex);
      } else {
    ...
    if (os64_Value >=
      ...
      if (orc_Content.GetArray() == true) {
        orc_Content.SetValueArrS16Element(std::numeric_limits<int16_t>::max(),
                                          ou32_ArrayIndex);
      } else {
  ...
  case C_OscNodeDataPoolContent::eSINT32:
    if (os64_Value <=
      ...
      if (orc_Content.GetArray() == true) {
        orc_Content.SetValueArrS32Element(
            std::numeric_limits<int32_t>::lowest(), ou32_ArrayIndex);
      } else {
    ...
    if (os64_Value >=
      ...
      if (orc_Content.GetArray() == true) {
        orc_Content.SetValueArrS32Element(std::numeric_limits<int32_t>::max(),
                                          ou32_ArrayIndex);
      } else {
  ...
  if (q_ValueAssigned == false) {
    if (orc_Content.GetArray() == true) {
      switch (orc_Content.GetType()) {
      case C_OscNodeDataPoolContent::eUINT8:
        orc_Content.SetValueArrU8Element(static_cast<uint8_t>(os64_Value),
                                         ou32_ArrayIndex);
        break;
      case C_OscNodeDataPoolContent::eUINT16:
        orc_Content.SetValueArrU16Element(static_cast<uint16_t>(os64_Value),
                                          ou32_ArrayIndex);
        break;
      case C_OscNodeDataPoolContent::eUINT32:
        orc_Content.SetValueArrU32Element(static_cast<uint32_t>(os64_Value),
                                          ou32_ArrayIndex);
        break;
      case C_OscNodeDataPoolContent::eUINT64:
        orc_Content.SetValueArrU64Element(static_cast<uint64_t>(os64_Value),
                                          ou32_ArrayIndex);
        break;
      case C_OscNodeDataPoolContent::eSINT8:
        orc_Content.SetValueArrS8Element(static_cast<int8_t>(os64_Value),
                                         ou32_ArrayIndex);
        break;
      case C_OscNodeDataPoolContent::eSINT16:
        orc_Content.SetValueArrS16Element(static_cast<int16_t>(os64_Value),
                                          ou32_ArrayIndex);
        break;
      case C_OscNodeDataPoolContent::eSINT32:
        orc_Content.SetValueArrS32Element(static_cast<int32_t>(os64_Value),
                                          ou32_ArrayIndex);
        break;
      case C_OscNodeDataPoolContent::eSINT64:
        ...
        break;
      case C_OscNodeDataPoolContent::eFLOAT32:
        orc_Content.SetValueArrF32Element(static_cast<float32_t>(os64_Value),
                                          ou32_ArrayIndex);
        break;
      case C_OscNodeDataPoolContent::eFLOAT64:
        orc_Content.SetValueArrF64Element(static_cast<float64_t>(os64_Value),
                                          ou32_ArrayIndex);
        break;
      default:
        break;
...
/*! \brief   Sets a scaled float value in the content class
   ...
   If the orc_Content holds an array, the value will be set to the position
   ou32_ArrayIndex.
   ...
   \param[in,out]  orc_Content         Content class with configured type and
   array configuration
   \param[in]      of64_Factor         Factor
   \param[in]      of64_Offset         Offset
   \param[in]      ou32_ArrayIndex     Optional index for array position if
   content class has an array
*/
//----------------------------------------------------------------------------------------------------------------------
void C_SdNdeDpContentUtil::h_SetScaledValueInContent(
    const float64_t of64_ScaledValue, C_OscNodeDataPoolContent &orc_Content,
    const float64_t of64_Factor, const float64_t of64_Offset,
    const uint32_t ou32_ArrayIndex) {
  // Unscale the value
  const float64_t f64_Value = C_OscUtils::h_GetValueUnscaled(
      of64_ScaledValue, of64_Factor, of64_Offset);

  // Update the value
  C_OscNodeDataPoolContentUtil::h_SetValueInContent(f64_Value, orc_Content,
                                                    ou32_ArrayIndex);
}
...
/*! \brief   Get number of steps for the specified element ID
   ...
   \param[out]  oru64_Steps   Number of steps, if type supported (sint8, uint8,
...
*/
//----------------------------------------------------------------------------------------------------------------------
int32_t C_SdNdeDpContentUtil::h_GetNumberOfAvailableSteps(
    const C_OscNodeDataPoolContent &orc_Min,
    const C_OscNodeDataPoolContent &orc_Max, uint64_t &oru64_Steps,
    const uint32_t ou32_Index) {
  int32_t s32_Retval = C_NO_ERR;

  // Default
  oru64_Steps = 0;
  if ((orc_Min.GetType() == orc_Max.GetType()) &&
    ...
    case C_OscNodeDataPoolContent::eUINT8:
      if (orc_Min.GetArray() == false) {
        ...
        u64_Max =
            static_cast<uint64_t>(orc_Max.GetValueArrU8Element(ou32_Index));
        u64_Min =
            static_cast<uint64_t>(orc_Min.GetValueArrU8Element(ou32_Index));
      }
      if (u64_Max >= u64_Min) {
    ...
    case C_OscNodeDataPoolContent::eSINT8:
      if (orc_Min.GetArray() == false) {
        ...
        s64_Max =
            static_cast<int64_t>(orc_Max.GetValueArrS8Element(ou32_Index));
        s64_Min =
            static_cast<int64_t>(orc_Min.GetValueArrS8Element(ou32_Index));
      }
      if (s64_Max >= s64_Min) {
    ...
    case C_OscNodeDataPoolContent::eUINT16:
      if (orc_Min.GetArray() == false) {
        ...
        u64_Max =
            static_cast<uint64_t>(orc_Max.GetValueArrU16Element(ou32_Index));
        u64_Min =
            static_cast<uint64_t>(orc_Min.GetValueArrU16Element(ou32_Index));
      }
      if (u64_Max >= u64_Min) {
        oru64_Steps = u64_Max - u64_Min;
      } else {
    ...
    case C_OscNodeDataPoolContent::eSINT16:
      if (orc_Min.GetArray() == false) {
        ...
        s64_Max =
            static_cast<int64_t>(orc_Max.GetValueArrS16Element(ou32_Index));
        s64_Min =
            static_cast<int64_t>(orc_Min.GetValueArrS16Element(ou32_Index));
      }
      if (s64_Max >= s64_Min) {
        // Overflow may happen (for sint64) but cast will lead to correct result
        oru64_Steps = static_cast<uint64_t>(s64_Max - s64_Min);
    ...
    case C_OscNodeDataPoolContent::eUINT32:
      if (orc_Min.GetArray() == false) {
        ...
        u64_Max =
            static_cast<uint64_t>(orc_Max.GetValueArrU32Element(ou32_Index));
        u64_Min =
            static_cast<uint64_t>(orc_Min.GetValueArrU32Element(ou32_Index));
      }
      if (u64_Max >= u64_Min) {
        oru64_Steps = u64_Max - u64_Min;
      } else {
    ...
    case C_OscNodeDataPoolContent::eSINT32:
      if (orc_Min.GetArray() == false) {
        ...
        s64_Max =
            static_cast<int64_t>(orc_Max.GetValueArrS32Element(ou32_Index));
        s64_Min =
            static_cast<int64_t>(orc_Min.GetValueArrS32Element(ou32_Index));
      }
      if (s64_Max >= s64_Min) {
        // Overflow may happen (for sint64) but cast will lead to correct result
        oru64_Steps = static_cast<uint64_t>(s64_Max - s64_Min);
...
*/
//----------------------------------------------------------------------------------------------------------------------
int32_t C_SdNdeDpContentUtil::h_GetMinMaxAfterScaling(
    const C_OscNodeDataPoolContent &orc_Min,
    const C_OscNodeDataPoolContent &orc_Max, const float64_t of64_Factor,
    const float64_t of64_Offset, C_OscNodeDataPoolContent &orc_NewMin,
  ...
  if ((orc_Min.GetType() == orc_Max.GetType()) &&
    ...
    if (orc_Min.GetArray() == false) {
      ...
      Q_ASSERT(C_SdNdeDpContentUtil::h_GetValueAsFloat64(
                   orc_Min, f64_Min, ou32_Index) == C_NO_ERR);
      Q_ASSERT(C_SdNdeDpContentUtil::h_GetValueAsFloat64(
                   orc_Max, f64_Max, ou32_Index) == C_NO_ERR);
      ...
      if (C_SdNdeDpContentUtil::h_GetNumberOfAvailableSteps(
              orc_Min, orc_Max, u64_Steps, 0) == C_NO_ERR) {
        const C_OscNodeDataPoolContent::E_Type e_Type =
            C_SdNdeDpContentUtil::h_GetMinimumTypeForRange(f64_Min, f64_Max,
                                                           u64_Steps);
        // Prepare output
      ...
      if ((orc_Min.GetArray() == orc_Max.GetArray()) &&
          (ou32_Index < orc_Min.GetArraySize())) {
        // Scale min & max
        orc_Min.GetAnyValueAsFloat64(f64_Min, ou32_Index);
        orc_Max.GetAnyValueAsFloat64(f64_Max, ou32_Index);
        f64_Min =
            C_OscUtils::h_GetValueScaled(f64_Min, of64_Factor, of64_Offset);
        f64_Max =
            C_OscUtils::h_GetValueScaled(f64_Max, of64_Factor, of64_Offset);
        if (C_SdNdeDpContentUtil::h_GetNumberOfAvailableSteps(
                orc_Min, orc_Max, u64_Steps, ou32_Index) == C_NO_ERR) {
          const C_OscNodeDataPoolContent::E_Type e_Type =
              C_SdNdeDpContentUtil::h_GetMinimumTypeForRange(f64_Min, f64_Max,
                                                             u64_Steps);
          // Prepare output
...
*/
//----------------------------------------------------------------------------------------------------------------------
int32_t C_SdNdeDpContentUtil::h_GetMinimalTypeAfterScaling(
    const C_OscNodeDataPoolContent &orc_Min,
    const C_OscNodeDataPoolContent &orc_Max, const float64_t of64_Factor,
  ...
  if ((orc_Min.GetType() == orc_Max.GetType()) &&
    ...
    if (orc_Min.GetArray() == false) {
      // Scale min & max
      // lint -e{534} return value intentionally ignored; values initialized
      // above
      ...
      if (C_SdNdeDpContentUtil::h_GetNumberOfAvailableSteps(
              orc_Min, orc_Max, u64_Steps, 0) == C_NO_ERR) {
        orc_Types.push_back(C_SdNdeDpContentUtil::h_GetMinimumTypeForRange(
      ...
      if (((c_Min.size() == c_Max.size()) &&
           (c_Min.size() == orc_Min.GetArraySize())) &&
          (orc_Min.GetArraySize() == orc_Max.GetArraySize())) {
        orc_Types.reserve(orc_Max.GetArraySize());
        for (uint32_t u32_ItArray = 0; u32_ItArray < orc_Max.GetArraySize();
             ++u32_ItArray) {
          f64_Min = C_OscUtils::h_GetValueScaled(c_Min[u32_ItArray],
                                                 of64_Factor, of64_Offset);
          f64_Max = C_OscUtils::h_GetValueScaled(c_Max[u32_ItArray],
                                                 of64_Factor, of64_Offset);
          if (C_SdNdeDpContentUtil::h_GetNumberOfAvailableSteps(
                  orc_Min, orc_Max, u64_Steps, u32_ItArray) == C_NO_ERR) {
            orc_Types.push_back(C_SdNdeDpContentUtil::h_GetMinimumTypeForRange(
                f64_Min, f64_Max, u64_Steps));
          } else {
            orc_Types.push_back(C_OscNodeDataPoolContent::eFLOAT64);
...
C_SdNdeDpContentUtil::h_GetMinimumTypeForRange(const float64_t of64_Min,
  ...
  if (((of64_Min > of64_Max) ||
    ...
    if ((ou64_Steps > 0ULL) &&
        (C_Uti::h_CheckFloatHasNoFractionPart(
             (of64_Max - of64_Min) / static_cast<float64_t>(ou64_Steps)) ==
         false)) {
      e_Retval = C_OscNodeDataPoolContent::eFLOAT64;
    } else {
      if (of64_Min < 0.0) {
        // Signed integer
        if (((of64_Min >=
              static_cast<float64_t>(std::numeric_limits<int8_t>::lowest())) &&
             (of64_Max <=
        ...
        } else if (((of64_Min >= static_cast<float64_t>(
                                     std::numeric_limits<int16_t>::lowest())) &&
                    (of64_Max <= static_cast<float64_t>(
                                     std::numeric_limits<int16_t>::max()))) &&
                   (ou64_Steps <= static_cast<uint64_t>(
        ...
        } else if (((of64_Max <= static_cast<float64_t>(
                                     std::numeric_limits<uint16_t>::max()))) &&
                   (ou64_Steps <= static_cast<uint64_t>(
                                      std::numeric_limits<uint16_t>::max()))) {
...
*/
//----------------------------------------------------------------------------------------------------------------------
int32_t C_SdNdeDpContentUtil::h_SimpleConvertToVariant(
    const C_OscNodeDataPoolContent &orc_Content, QVariant &orc_Variant) {
  int32_t s32_Retval = C_NO_ERR;
...
*/
//----------------------------------------------------------------------------------------------------------------------
int32_t C_SdNdeDpContentUtil::h_SimpleConvertFromVariant(
    const QVariant &orc_Variant, C_OscNodeDataPoolContent &orc_Content) {
  bool q_Ok;
  int32_t s32_Retval = C_NO_ERR;
...
void C_SdNdeDpContentUtil::h_GetValuesAsScaledString(
  ...
  if (orc_Content.GetArray() == false) {
    QString c_Tmp;
    C_SdNdeDpContentUtil::h_GetValueAsScaledString(orc_Content, of64_Factor,
                                                   of64_Offset, c_Tmp, 0,
                                                   oq_AllowRangeAdaptation);
    orc_Output.push_back(c_Tmp);
  } else {
    orc_Output.reserve(orc_Content.GetArraySize());
    for (uint32_t u32_ItElement = 0; u32_ItElement < orc_Content.GetArraySize();
         ++u32_ItElement) {
      QString c_Tmp;
      C_SdNdeDpContentUtil::h_GetValueAsScaledString(
          orc_Content, of64_Factor, of64_Offset, c_Tmp, u32_ItElement,
          oq_AllowRangeAdaptation);
      orc_Output.push_back(c_Tmp);
    }
  }
...
*/
//----------------------------------------------------------------------------------------------------------------------
void C_SdNdeDpContentUtil::h_GetValuesAsScaledCombinedString(
    const C_OscNodeDataPoolContent &orc_Content, const float64_t of64_Factor,
...
*/
//----------------------------------------------------------------------------------------------------------------------
void C_SdNdeDpContentUtil::h_GetValueAsScaledString(
    const C_OscNodeDataPoolContent &orc_Content, const float64_t of64_Factor,
    const float64_t of64_Offset, QString &orc_Output, const uint32_t ou32_Index,
    const bool oq_AllowRangeAdaptation) {
  orc_Content.GetValueAsScaledString(of64_Factor, of64_Offset, orc_Output,
                                     ou32_Index, oq_AllowRangeAdaptation);
  // Replace separators
  orc_Output.replace(QLocale::c().decimalPoint(),
                     QLocale::system().decimalPoint(), Qt::CaseInsensitive);
}
...
void C_SdNdeDpContentUtil::h_InitMax(C_OscNodeDataPoolContent &orc_Content) {
  ...
  case C_OscNodeDataPoolContent::eSINT64:
    if (orc_Content.GetArray() == false) {
      ...
      for (uint32_t u32_It = 0; u32_It < orc_Content.GetArraySize(); ++u32_It) {
        orc_Content.SetValueArrS64Element(std::numeric_limits<int64_t>::max(),
                                          u32_It);
      }
    }
    break;
  ...
  case C_OscNodeDataPoolContent::eUINT64:
    if (orc_Content.GetArray() == false) {
      ...
      for (uint32_t u32_It = 0; u32_It < orc_Content.GetArraySize(); ++u32_It) {
        orc_Content.SetValueArrU64Element(std::numeric_limits<uint64_t>::max(),
                                          u32_It);
      }
    }
    break;
  case C_OscNodeDataPoolContent::eFLOAT32:
    if (orc_Content.GetArray() == false) {
      ...
      for (uint32_t u32_It = 0; u32_It < orc_Content.GetArraySize(); ++u32_It) {
        orc_Content.SetValueArrF32Element(std::numeric_limits<float32_t>::max(),
                                          u32_It);
      }
    }
    break;
  case C_OscNodeDataPoolContent::eFLOAT64:
    if (orc_Content.GetArray() == false) {
      ...
      for (uint32_t u32_It = 0; u32_It < orc_Content.GetArraySize(); ++u32_It) {
        orc_Content.SetValueArrF64Element(std::numeric_limits<float64_t>::max(),
                                          u32_It);
      }
    }
    break;
...
void C_SdNdeDpContentUtil::h_InitMin(C_OscNodeDataPoolContent &orc_Content) {
  ...
  case C_OscNodeDataPoolContent::eSINT16:
    if (orc_Content.GetArray() == false) {
      ...
      for (uint32_t u32_It = 0; u32_It < orc_Content.GetArraySize(); ++u32_It) {
        orc_Content.SetValueArrS16Element(
            std::numeric_limits<int16_t>::lowest(), u32_It);
      }
    }
    break;
  case C_OscNodeDataPoolContent::eSINT32:
    if (orc_Content.GetArray() == false) {
      ...
      for (uint32_t u32_It = 0; u32_It < orc_Content.GetArraySize(); ++u32_It) {
        orc_Content.SetValueArrS32Element(
            std::numeric_limits<int32_t>::lowest(), u32_It);
      }
    }
    break;
  case C_OscNodeDataPoolContent::eSINT64:
    if (orc_Content.GetArray() == false) {
      ...
      for (uint32_t u32_It = 0; u32_It < orc_Content.GetArraySize(); ++u32_It) {
        orc_Content.SetValueArrS64Element(
            std::numeric_limits<int64_t>::lowest(), u32_It);
      }
    }
    break;
  case C_OscNodeDataPoolContent::eUINT8:
  ...
  case C_OscNodeDataPoolContent::eUINT16:
    if (orc_Content.GetArray() == false) {
      ...
      for (uint32_t u32_It = 0; u32_It < orc_Content.GetArraySize(); ++u32_It) {
        orc_Content.SetValueArrU16Element(
            std::numeric_limits<uint16_t>::lowest(), u32_It);
      }
    }
    break;
  case C_OscNodeDataPoolContent::eUINT32:
    if (orc_Content.GetArray() == false) {
      ...
      for (uint32_t u32_It = 0; u32_It < orc_Content.GetArraySize(); ++u32_It) {
        orc_Content.SetValueArrU32Element(
            std::numeric_limits<uint32_t>::lowest(), u32_It);
      }
    }
    break;
  case C_OscNodeDataPoolContent::eUINT64:
    if (orc_Content.GetArray() == false) {
      ...
      for (uint32_t u32_It = 0; u32_It < orc_Content.GetArraySize(); ++u32_It) {
        orc_Content.SetValueArrU64Element(
            std::numeric_limits<uint64_t>::lowest(), u32_It);
      }
    }
    break;
  case C_OscNodeDataPoolContent::eFLOAT32:
    if (orc_Content.GetArray() == false) {
      ...
      for (uint32_t u32_It = 0; u32_It < orc_Content.GetArraySize(); ++u32_It) {
        orc_Content.SetValueArrF32Element(
            std::numeric_limits<float32_t>::lowest(), u32_It);
      }
    }
    break;
  case C_OscNodeDataPoolContent::eFLOAT64:
    if (orc_Content.GetArray() == false) {
      ...
      for (uint32_t u32_It = 0; u32_It < orc_Content.GetArraySize(); ++u32_It) {
        orc_Content.SetValueArrF64Element(
            std::numeric_limits<float64_t>::lowest(), u32_It);
      }
    }
    break;
  default:
...
*/
//----------------------------------------------------------------------------------------------------------------------
void C_SdNdeDpContentUtil::h_InitMaxForSignal(
    C_OscNodeDataPoolContent &orc_Content, const uint16_t ou16_BitLength) {
  ...
  if (q_BitLengthInvalid == false) {
    ...
    if (q_IsUnsigned == true) {
      ...
      for (uint16_t u16_ItBit = 0; u16_ItBit < ou16_BitLength; ++u16_ItBit) {
        u64_Max += static_cast<uint64_t>(1ULL)
                   << static_cast<uint64_t>(u16_ItBit);
      }

      switch (
          orc_Content
              .GetType()) // lint !e788 //only unsigned types handled explicitly
      {
      case C_OscNodeDataPoolContent::eUINT8:
    ...
    if (q_IsSigned == true) {
      ...
      if (ou16_BitLength > 0U) {
        u64_Max += static_cast<uint64_t>(1ULL)
                   << (static_cast<uint64_t>(ou16_BitLength) - 1ULL);
      }

      switch (
          orc_Content
              .GetType()) // lint !e788 //only signed types handled explicitly
      {
      case C_OscNodeDataPoolContent::eSINT8:
    ...
    if (q_IsFloat == true) {
      switch (
          orc_Content
              .GetType()) // lint !e788 //only float types handled explicitly
      {
      case C_OscNodeDataPoolContent::eFLOAT32:
        orc_Content.SetValueF32(std::numeric_limits<float32_t>::max());
        break;
...
*/
//----------------------------------------------------------------------------------------------------------------------
void C_SdNdeDpContentUtil::h_InitMinForSignal(
    C_OscNodeDataPoolContent &orc_Content, const uint16_t ou16_BitLength) {
  bool q_IsUnsigned = false;
  bool q_IsSigned = false;
  bool q_IsFloat = false;
...
*/
//----------------------------------------------------------------------------------------------------------------------
QVariant C_SdNdeDpContentUtil::h_ConvertContentToGeneric(
    const C_OscNodeDataPoolContent &orc_Input, const uint32_t &oru32_Index,
  ...
  if (orc_Input.GetArray() == false) {
    ...
    case C_OscNodeDataPoolContent::E_Type::eFLOAT32:
      if (os32_Role == static_cast<int32_t>(Qt::ItemDataRole::DisplayRole)) {
        ...
        c_Precison.replace(QLocale::c().decimalPoint(),
    ...
    case C_OscNodeDataPoolContent::E_Type::eUINT8:
      c_Retval =
          static_cast<quint64>(orc_Input.GetValueArrU8Element(oru32_Index));
      break;
    case C_OscNodeDataPoolContent::E_Type::eUINT16:
      c_Retval =
          static_cast<quint64>(orc_Input.GetValueArrU16Element(oru32_Index));
      break;
    case C_OscNodeDataPoolContent::E_Type::eUINT32:
      c_Retval =
          static_cast<quint64>(orc_Input.GetValueArrU32Element(oru32_Index));
      break;
    case C_OscNodeDataPoolContent::E_Type::eUINT64:
      c_Retval = static_cast<quint64>(orc_Input.GetValueArrU64Element(oru32_Index));
      break;
    case C_OscNodeDataPoolContent::E_Type::eSINT8:
      c_Retval =
          static_cast<qint64>(orc_Input.GetValueArrS8Element(oru32_Index));
      break;
    case C_OscNodeDataPoolContent::E_Type::eSINT16:
      c_Retval =
          static_cast<qint64>(orc_Input.GetValueArrS16Element(oru32_Index));
      break;
    case C_OscNodeDataPoolContent::E_Type::eSINT32:
      c_Retval =
          static_cast<qint64>(orc_Input.GetValueArrS32Element(oru32_Index));
      break;
    case C_OscNodeDataPoolContent::E_Type::eSINT64:
      c_Retval = static_cast<qint64>(orc_Input.GetValueArrS64Element(oru32_Index));
      break;
    case C_OscNodeDataPoolContent::E_Type::eFLOAT32:
      c_Retval =
          static_cast<float64_t>(orc_Input.GetValueArrF32Element(oru32_Index));
      break;
    case C_OscNodeDataPoolContent::E_Type::eFLOAT64:
...
*/
//----------------------------------------------------------------------------------------------------------------------
QVariant C_SdNdeDpContentUtil::h_ConvertScaledContentToGeneric(
    const C_OscNodeDataPoolContent &orc_Input, const float64_t of64_Factor,
    const float64_t of64_Offset, const uint32_t &oru32_Index,
    const bool oq_AllowRangeAdaptation, const int32_t os32_Role) {
  QVariant c_Retval;

  if (C_OscUtils::h_IsScalingActive(of64_Factor, of64_Offset) == false) {
    c_Retval = C_SdNdeDpContentUtil::h_ConvertContentToGeneric(
    ...
    if (oru32_Index < c_Values.size()) {
      const float64_t f64_ScaledValue =
          C_OscUtils::h_GetValueScaled(c_Values[oru32_Index], of64_Factor,
                                       of64_Offset, oq_AllowRangeAdaptation);
      if (C_Uti::h_CheckFloatHasNoFractionPart(f64_ScaledValue) == false) {
        ...
        if (((f64_ScaledValue < 0.0) &&
          ...
          if (os32_Role ==
              static_cast<int32_t>(Qt::ItemDataRole::DisplayRole)) {
            c_Precison = QString::number(f64_ScaledValue, 'g', 17);
            c_Precison.replace(QLocale::c().decimalPoint(),
                               QLocale::system().decimalPoint(),
                               Qt::CaseInsensitive);
...
*/
//----------------------------------------------------------------------------------------------------------------------
int32_t C_SdNdeDpContentUtil::h_SetDataVariableFromGeneric(
    const QVariant &orc_Value, C_OscNodeDataPoolContent &orc_Output,
  ...
  case QVariant::ULongLong:
    if (orc_Output.GetArray() == false) {
      ...
      switch (orc_Output.GetType()) {
      case C_OscNodeDataPoolContent::E_Type::eUINT8:
        orc_Output.SetValueArrU8Element(
            static_cast<uint8_t>(orc_Value.toULongLong()), oru32_Index);
        break;
      case C_OscNodeDataPoolContent::E_Type::eUINT16:
        orc_Output.SetValueArrU16Element(
            static_cast<uint16_t>(orc_Value.toULongLong()), oru32_Index);
        break;
      case C_OscNodeDataPoolContent::E_Type::eUINT32:
        orc_Output.SetValueArrU32Element(
            static_cast<uint32_t>(orc_Value.toULongLong()), oru32_Index);
        break;
      case C_OscNodeDataPoolContent::E_Type::eUINT64:
        orc_Output.SetValueArrU64Element(
            static_cast<uint64_t>(orc_Value.toULongLong()), oru32_Index);
        break;
      case C_OscNodeDataPoolContent::E_Type::eSINT8:
        orc_Output.SetValueArrS8Element(
            static_cast<int8_t>(orc_Value.toULongLong()), oru32_Index);
        break;
      case C_OscNodeDataPoolContent::E_Type::eSINT16:
        orc_Output.SetValueArrS16Element(
            static_cast<int16_t>(orc_Value.toULongLong()), oru32_Index);
        break;
      case C_OscNodeDataPoolContent::E_Type::eSINT32:
        orc_Output.SetValueArrS32Element(
            static_cast<int32_t>(orc_Value.toULongLong()), oru32_Index);
        break;
      case C_OscNodeDataPoolContent::E_Type::eSINT64:
        orc_Output.SetValueArrS64Element(
            static_cast<int64_t>(orc_Value.toULongLong()), oru32_Index);
        break;
      case C_OscNodeDataPoolContent::E_Type::eFLOAT32:
        orc_Output.SetValueArrF32Element(
            static_cast<float32_t>(orc_Value.toULongLong()), oru32_Index);
        break;
      case C_OscNodeDataPoolContent::E_Type::eFLOAT64:
        orc_Output.SetValueArrF64Element(
            static_cast<float64_t>(orc_Value.toULongLong()), oru32_Index);
        break;
      default:
        break;
      }
  ...
  case QVariant::LongLong:
    if (orc_Output.GetArray() == false) {
      ...
      case C_OscNodeDataPoolContent::E_Type::eUINT8:
        orc_Output.SetValueArrU8Element(
            static_cast<uint8_t>(orc_Value.toLongLong()), oru32_Index);
        break;
      case C_OscNodeDataPoolContent::E_Type::eUINT16:
        orc_Output.SetValueArrU16Element(
            static_cast<uint16_t>(orc_Value.toLongLong()), oru32_Index);
        break;
      case C_OscNodeDataPoolContent::E_Type::eUINT32:
        orc_Output.SetValueArrU32Element(
            static_cast<uint32_t>(orc_Value.toLongLong()), oru32_Index);
        break;
      case C_OscNodeDataPoolContent::E_Type::eUINT64:
        orc_Output.SetValueArrU64Element(
            static_cast<uint64_t>(orc_Value.toLongLong()), oru32_Index);
        break;
      case C_OscNodeDataPoolContent::E_Type::eSINT8:
        orc_Output.SetValueArrS8Element(
            static_cast<int8_t>(orc_Value.toLongLong()), oru32_Index);
        break;
      case C_OscNodeDataPoolContent::E_Type::eSINT16:
        orc_Output.SetValueArrS16Element(
            static_cast<int16_t>(orc_Value.toLongLong()), oru32_Index);
        break;
      case C_OscNodeDataPoolContent::E_Type::eSINT32:
        orc_Output.SetValueArrS32Element(
            static_cast<int32_t>(orc_Value.toLongLong()), oru32_Index);
        break;
      case C_OscNodeDataPoolContent::E_Type::eSINT64:
        orc_Output.SetValueArrS64Element(
            static_cast<int64_t>(orc_Value.toLongLong()), oru32_Index);
        break;
      case C_OscNodeDataPoolContent::E_Type::eFLOAT32:
        orc_Output.SetValueArrF32Element(
            static_cast<float32_t>(orc_Value.toLongLong()), oru32_Index);
        break;
      case C_OscNodeDataPoolContent::E_Type::eFLOAT64:
        orc_Output.SetValueArrF64Element(
            static_cast<float64_t>(orc_Value.toLongLong()), oru32_Index);
        break;
      default:
        break;
      }
  ...
  case QVariant::UInt:
    if (orc_Output.GetArray() == false) {
      ...
      case C_OscNodeDataPoolContent::E_Type::eUINT8:
        orc_Output.SetValueArrU8Element(
            static_cast<uint8_t>(orc_Value.toUInt()), oru32_Index);
        break;
      case C_OscNodeDataPoolContent::E_Type::eUINT16:
        orc_Output.SetValueArrU16Element(
            static_cast<uint16_t>(orc_Value.toUInt()), oru32_Index);
        break;
      case C_OscNodeDataPoolContent::E_Type::eUINT32:
        orc_Output.SetValueArrU32Element(
            static_cast<uint32_t>(orc_Value.toUInt()), oru32_Index);
        break;
      case C_OscNodeDataPoolContent::E_Type::eUINT64:
        orc_Output.SetValueArrU64Element(
            static_cast<uint64_t>(orc_Value.toUInt()), oru32_Index);
        break;
      case C_OscNodeDataPoolContent::E_Type::eSINT8:
        orc_Output.SetValueArrS8Element(static_cast<int8_t>(orc_Value.toUInt()),
                                        oru32_Index);
        break;
      case C_OscNodeDataPoolContent::E_Type::eSINT16:
        orc_Output.SetValueArrS16Element(
            static_cast<int16_t>(orc_Value.toUInt()), oru32_Index);
        break;
      case C_OscNodeDataPoolContent::E_Type::eSINT32:
        orc_Output.SetValueArrS32Element(
            static_cast<int32_t>(orc_Value.toUInt()), oru32_Index);
        break;
      case C_OscNodeDataPoolContent::E_Type::eSINT64:
        orc_Output.SetValueArrS64Element(
            static_cast<int64_t>(orc_Value.toUInt()), oru32_Index);
        break;
      case C_OscNodeDataPoolContent::E_Type::eFLOAT32:
        orc_Output.SetValueArrF32Element(
            static_cast<float32_t>(orc_Value.toUInt()), oru32_Index);
        break;
      case C_OscNodeDataPoolContent::E_Type::eFLOAT64:
        orc_Output.SetValueArrF64Element(
            static_cast<float64_t>(orc_Value.toUInt()), oru32_Index);
        break;
      default:
        break;
      }
  ...
  case QVariant::Int:
    if (orc_Output.GetArray() == false) {
      ...
      case C_OscNodeDataPoolContent::E_Type::eUINT32:
        ...
        break;
      case C_OscNodeDataPoolContent::E_Type::eUINT64:
        orc_Output.SetValueU64(
            static_cast<uint64_t>(static_cast<uint32_t>(orc_Value.toInt())));
        break;
      case C_OscNodeDataPoolContent::E_Type::eSINT8:
      ...
      switch (orc_Output.GetType()) {
      case C_OscNodeDataPoolContent::E_Type::eUINT8:
        orc_Output.SetValueArrU8Element(static_cast<uint8_t>(orc_Value.toInt()),
                                        oru32_Index);
        break;
      case C_OscNodeDataPoolContent::E_Type::eUINT16:
        orc_Output.SetValueArrU16Element(
            static_cast<uint16_t>(orc_Value.toInt()), oru32_Index);
        break;
      case C_OscNodeDataPoolContent::E_Type::eUINT32:
        orc_Output.SetValueArrU32Element(
            static_cast<uint32_t>(orc_Value.toInt()), oru32_Index);
        break;
      case C_OscNodeDataPoolContent::E_Type::eUINT64:
        orc_Output.SetValueArrU64Element(
            static_cast<uint64_t>(static_cast<uint32_t>(orc_Value.toInt())),
        ...
        break;
      case C_OscNodeDataPoolContent::E_Type::eSINT8:
        orc_Output.SetValueArrS8Element(static_cast<int8_t>(orc_Value.toInt()),
                                        oru32_Index);
        break;
      case C_OscNodeDataPoolContent::E_Type::eSINT16:
        orc_Output.SetValueArrS16Element(
            static_cast<int16_t>(orc_Value.toInt()), oru32_Index);
        break;
      case C_OscNodeDataPoolContent::E_Type::eSINT32:
        orc_Output.SetValueArrS32Element(
            static_cast<int32_t>(orc_Value.toInt()), oru32_Index);
        break;
      case C_OscNodeDataPoolContent::E_Type::eSINT64:
        orc_Output.SetValueArrS64Element(
            static_cast<int64_t>(orc_Value.toInt()), oru32_Index);
        break;
      case C_OscNodeDataPoolContent::E_Type::eFLOAT32:
        orc_Output.SetValueArrF32Element(
            static_cast<float32_t>(orc_Value.toInt()), oru32_Index);
        break;
      case C_OscNodeDataPoolContent::E_Type::eFLOAT64:
        orc_Output.SetValueArrF64Element(
            static_cast<float64_t>(orc_Value.toInt()), oru32_Index);
        break;
      default:
        break;
      }
  ...
  case QVariant::Double:
    if (orc_Output.GetArray() == false) {
      ...
      case C_OscNodeDataPoolContent::E_Type::eUINT8:
        orc_Output.SetValueArrU8Element(
            static_cast<uint8_t>(orc_Value.toDouble()), oru32_Index);
        break;
      case C_OscNodeDataPoolContent::E_Type::eUINT16:
        orc_Output.SetValueArrU16Element(
            static_cast<uint16_t>(orc_Value.toDouble()), oru32_Index);
        break;
      case C_OscNodeDataPoolContent::E_Type::eUINT32:
        orc_Output.SetValueArrU32Element(
            static_cast<uint32_t>(orc_Value.toDouble()), oru32_Index);
        break;
      case C_OscNodeDataPoolContent::E_Type::eUINT64:
        orc_Output.SetValueArrU64Element(
            static_cast<uint64_t>(orc_Value.toDouble()), oru32_Index);
        break;
      case C_OscNodeDataPoolContent::E_Type::eSINT8:
        orc_Output.SetValueArrS8Element(
            static_cast<int8_t>(orc_Value.toDouble()), oru32_Index);
        break;
      case C_OscNodeDataPoolContent::E_Type::eSINT16:
        orc_Output.SetValueArrS16Element(
            static_cast<int16_t>(orc_Value.toDouble()), oru32_Index);
        break;
      case C_OscNodeDataPoolContent::E_Type::eSINT32:
        orc_Output.SetValueArrS32Element(
            static_cast<int32_t>(orc_Value.toDouble()), oru32_Index);
        break;
      case C_OscNodeDataPoolContent::E_Type::eSINT64:
        orc_Output.SetValueArrS64Element(
            static_cast<int64_t>(orc_Value.toDouble()), oru32_Index);
        break;
      case C_OscNodeDataPoolContent::E_Type::eFLOAT32:
        orc_Output.SetValueArrF32Element(
            static_cast<float32_t>(orc_Value.toDouble()), oru32_Index);
        break;
      case C_OscNodeDataPoolContent::E_Type::eFLOAT64:
        orc_Output.SetValueArrF64Element(
            static_cast<float64_t>(orc_Value.toDouble()), oru32_Index);
        break;
      default:
        break;
      }
...
*/
//----------------------------------------------------------------------------------------------------------------------
int32_t C_SdNdeDpContentUtil::h_SetDataVariableFromGenericWithScaling(
    const QVariant &orc_Value, C_OscNodeDataPoolContent &orc_Output,
    const float64_t of64_Factor, const float64_t of64_Offset,
    const uint32_t &oru32_Index) {
  int32_t s32_Retval = C_NO_ERR;
  ...
  if (C_OscUtils::h_IsScalingActive(of64_Factor, of64_Offset) == false) {
    C_SdNdeDpContentUtil::h_SetDataVariableFromGeneric(orc_Value, orc_Output,
                                                       oru32_Index);
  } else {
    ...
    if (q_Success == true) {
      C_SdNdeDpContentUtil::h_SetScaledValueInContent(
          f64_TmpValue, orc_Output, of64_Factor, of64_Offset, oru32_Index);
    } else {
      s32_Retval = C_RANGE;
    }
  }
...
*/
//----------------------------------------------------------------------------------------------------------------------
QString C_SdNdeDpContentUtil::h_ConvertToString(
    const C_OscNodeDataPoolContent &orc_Data) {
  QString c_Retval = "";

  // Each element is an character
  if (orc_Data.GetType() == C_OscNodeDataPoolContent::eSINT8) {
    if (orc_Data.GetArray() == true) {
      for (uint32_t u32_ItContent = 0; u32_ItContent < orc_Data.GetArraySize();
           ++u32_ItContent) {
        const char_t cn_Char =
            static_cast<char_t>(orc_Data.GetValueArrS8Element(u32_ItContent));
        if (cn_Char == '\0') {
          break;
        } else {
          c_Retval += cn_Char;
      ...
      c_Retval =
          static_cast<QString>(static_cast<char_t>(orc_Data.GetValueS8()));
    }
  }
  return c_Retval;
}
...
C_SdNdeDpContentUtil::h_ConvertToString(const QList<int8_t> &orc_Data) {
  ...
  // Each element is an character
  for (uint32_t u32_ItContent = 0; u32_ItContent < orc_Data.size();
       ++u32_ItContent) {
...
*/
//----------------------------------------------------------------------------------------------------------------------
void C_SdNdeDpContentUtil::h_SetString(const QString &orc_String,
  ...
  if (orc_String.size() <= static_cast<int32_t>(orc_Output.GetArraySize())) {
    if (orc_Output.GetArraySize() == 1) {
      ...
      for (uint32_t u32_ItOutput = 0; u32_ItOutput < orc_Output.GetArraySize();
           ++u32_ItOutput) {
        // As long as there is a string content use that
        if (static_cast<int32_t>(u32_ItOutput) < orc_String.length()) {
          orc_Output.SetValueArrS8Element(
              static_cast<int8_t>(
                  orc_String.at(static_cast<int32_t>(u32_ItOutput)).toLatin1()),
              u32_ItOutput);
        } else {
          // If the string has ended fill up all remaining values with defined
          // content
          orc_Output.SetValueArrS8Element(static_cast<int8_t>('\0'),
                                          u32_ItOutput);
        }
      }
    }
