...
*/
//----------------------------------------------------------------------------------------------------------------------
C_SdNdeNodePropertiesWidget::C_SdNdeNodePropertiesWidget(
    QWidget *const opc_Parent)
    : QWidget(opc_Parent), mpc_Ui(new Ui::C_SdNdeNodePropertiesWidget),
      mu32_NodeIndex(0), mu32_BusIndex(0), mc_BusName("") {
  ...
  // Options buttons
  this->mpc_Ui->pc_PushButtonFlashloaderOptions->SetCustomIcon(
      "://images/SettingsIcon.svg", "://images/SettingsIconDisabled.svg");
  this->mpc_Ui->pc_PushButtonFlashloaderOptions->setIconSize(mc_ICON_SIZE_24);

  // set explicit min width to allow the layout to cut off parts of the button
  // (necessary to free space for smaller
  //  screen resolutions)
  ...
  // table setups
  this->mpc_Ui->pc_TableWidgetComIfSettings
      ->horizontalHeaderItem(
          static_cast<int32_t>(C_SdNdeComIfSettingsTableDelegate::eINTERFACE))
      ->setTextAlignment(static_cast<int32_t>(Qt::AlignLeft));
  this->mpc_Ui->pc_TableWidgetComIfSettings
      ->horizontalHeaderItem(
          static_cast<int32_t>(C_SdNdeComIfSettingsTableDelegate::eCONNECTION))
      ->setTextAlignment(static_cast<int32_t>(Qt::AlignLeft));
  this->mpc_Ui->pc_TableWidgetComIfSettings
      ->horizontalHeaderItem(
  ...
  this->mpc_Ui->pc_TableWidgetComIfSettings
      ->horizontalHeaderItem(
          static_cast<int32_t>(C_SdNdeComIfSettingsTableDelegate::eIPADDRESS))
      ->setTextAlignment(static_cast<int32_t>(Qt::AlignHCenter));
  this->mpc_Ui->pc_TableWidgetComIfSettings
      ->horizontalHeaderItem(
          static_cast<int32_t>(C_SdNdeComIfSettingsTableDelegate::eUPDATE))
      ->setTextAlignment(static_cast<int32_t>(Qt::AlignHCenter));
  this->mpc_Ui->pc_TableWidgetComIfSettings
      ->horizontalHeaderItem(
          static_cast<int32_t>(C_SdNdeComIfSettingsTableDelegate::eROUTING))
      ->setTextAlignment(static_cast<int32_t>(Qt::AlignHCenter));
  this->mpc_Ui->pc_TableWidgetComIfSettings
      ->horizontalHeaderItem(
          static_cast<int32_t>(C_SdNdeComIfSettingsTableDelegate::eDIAGNOSTIC))
      ->setTextAlignment(static_cast<int32_t>(Qt::AlignHCenter));

  // set min column width (necessary for "Linked to..." strech column
  this->mpc_Ui->pc_TableWidgetComIfSettings->horizontalHeader()
      ->setMinimumSectionSize(150);
  ...
  this->mpc_Ui->pc_TableWidgetComIfSettings->setColumnWidth(
      static_cast<int32_t>(C_SdNdeComIfSettingsTableDelegate::eINTERFACE), 150);
  ...
  this->mpc_Ui->pc_TableWidgetComIfSettings->horizontalHeader()
      ->setSectionResizeMode(
          ...
          QHeaderView::Fixed);
  this->mpc_Ui->pc_TableWidgetComIfSettings->setColumnWidth(
      static_cast<int32_t>(C_SdNdeComIfSettingsTableDelegate::eNODEID), 150);
  ...
  this->mpc_Ui->pc_TableWidgetComIfSettings->horizontalHeader()
      ->setSectionResizeMode(
          ...
          QHeaderView::Fixed);
  this->mpc_Ui->pc_TableWidgetComIfSettings->setColumnWidth(
      static_cast<int32_t>(C_SdNdeComIfSettingsTableDelegate::eIPADDRESS), 150);
  ...
  this->mpc_Ui->pc_TableWidgetComIfSettings->horizontalHeader()
      ->setSectionResizeMode(
          ...
          QHeaderView::Fixed);
  this->mpc_Ui->pc_TableWidgetComIfSettings->setColumnWidth(
      static_cast<int32_t>(C_SdNdeComIfSettingsTableDelegate::eUPDATE), 150);
  ...
  this->mpc_Ui->pc_TableWidgetComIfSettings->horizontalHeader()
      ->setSectionResizeMode(
          ...
          QHeaderView::Fixed);
  this->mpc_Ui->pc_TableWidgetComIfSettings->setColumnWidth(
      static_cast<int32_t>(C_SdNdeComIfSettingsTableDelegate::eROUTING), 150);
  ...
  // Name restriction
  this->mpc_Ui->pc_LineEditNodeName->setMaxLength(
  ...
  connect(this->mpc_Ui->pc_TableWidgetComIfSettings, &QTableWidget::cellChanged,
          this, &C_SdNdeNodePropertiesWidget::m_CheckComInterface);

  connect(this->mpc_Ui->pc_TableWidgetComIfSettings, &QTableWidget::cellClicked,
          this, &C_SdNdeNodePropertiesWidget::m_HandleCellClick);
  connect(this->mpc_Ui->pc_PushButtonFlashloaderOptions,
          &C_OgePubOptions::clicked, this,
  ...
  connect(this->mpc_Ui->pc_ComboBoxProtocol,
          ...
          this, &C_SdNdeNodePropertiesWidget::m_SupportedProtocolChange);
  connect(this->mpc_Ui->pc_ComboBoxXAppSupport,
          static_cast<void (QComboBox::*)(int32_t)>(
              &QComboBox::currentIndexChanged),
          this, &C_SdNdeNodePropertiesWidget::m_XappSupportChange);
  ...
  connect(&this->mc_Timer, &QTimer::timeout, this,
          &C_SdNdeNodePropertiesWidget::m_OpenBus);
}
...
void C_SdNdeNodePropertiesWidget::InitStaticNames(void) const {
  ...
  const int32_t s32_COL_INTERFACE =
      static_cast<int32_t>(C_SdNdeComIfSettingsTableDelegate::eINTERFACE);
  const int32_t s32_COL_CONNECTION =
      static_cast<int32_t>(C_SdNdeComIfSettingsTableDelegate::eCONNECTION);
  const int32_t s32_COL_NODE_ID =
      static_cast<int32_t>(C_SdNdeComIfSettingsTableDelegate::eNODEID);
  const int32_t s32_COL_IP_ADDRESS =
      static_cast<int32_t>(C_SdNdeComIfSettingsTableDelegate::eIPADDRESS);
  const int32_t s32_COL_UPDATE =
      static_cast<int32_t>(C_SdNdeComIfSettingsTableDelegate::eUPDATE);
  const int32_t s32_COL_ROUTING =
      static_cast<int32_t>(C_SdNdeComIfSettingsTableDelegate::eROUTING);
  const int32_t s32_COL_DIAGNOSTIC =
      static_cast<int32_t>(C_SdNdeComIfSettingsTableDelegate::eDIAGNOSTIC);
  ...
  this->mpc_Ui->pc_LabelComIfSettings->setText(
      "Communication Interfaces Settings");
  ...
  this->mpc_Ui->pc_PushButtonFlashloaderOptions->setText(
      static_cast<QString>(' ') + "STW Flashloader Settings");
  ...
  this->mpc_Ui->pc_TableWidgetComIfSettings
      ->horizontalHeaderItem(s32_COL_INTERFACE)
      ->setText(c_InterfaceString);

  // fake padding with Spaces. No other solution known so far
  c_ConnectString = "  ";
  c_ConnectString.append("Linked to...");
  this->mpc_Ui->pc_TableWidgetComIfSettings
      ->horizontalHeaderItem(s32_COL_CONNECTION)
      ->setText(c_ConnectString);
  this->mpc_Ui->pc_TableWidgetComIfSettings
      ->horizontalHeaderItem(s32_COL_NODE_ID)
      ->setText("Node ID");
  this->mpc_Ui->pc_TableWidgetComIfSettings
      ->horizontalHeaderItem(s32_COL_IP_ADDRESS)
      ->setText("IP Address");
  this->mpc_Ui->pc_TableWidgetComIfSettings
      ->horizontalHeaderItem(s32_COL_UPDATE)
      ->setText("Usable for Update");
  this->mpc_Ui->pc_TableWidgetComIfSettings
      ->horizontalHeaderItem(s32_COL_ROUTING)
      ->setText("Usable for Routing");
  this->mpc_Ui->pc_TableWidgetComIfSettings
      ->horizontalHeaderItem(s32_COL_DIAGNOSTIC)
      ->setText("Usable for Dashboard");

  this->mpc_Ui->pc_TextEditComment->setPlaceholderText(
      "Add your comment here ...");

  // Tool tips
  this->mpc_Ui->pc_LabSubNodeTitle->SetToolTipInformation(
      "Sub-Node", "Name of the Sub-Node.");
  ...
  this->mpc_Ui->pc_LabelName->SetToolTipInformation(
      ...
      static_cast<QString>(
          ...
          .arg(C_PuiSdHandler::h_GetInstance()->GetNameMaxCharLimit()));

  this->mpc_Ui->pc_LabelComment->SetToolTipInformation(
      "Comment", "Comment for this node.");

  this->mpc_Ui->pc_LabelProgramming->SetToolTipInformation(
      "Programming Support",
  ...
  this->mpc_Ui->pc_LabelXAppSupport->SetToolTipInformation(
      "X.App Support",
  ...
  this->mpc_Ui->pc_LabelProtocol->SetToolTipInformation(
      "Protocol Support",
  ...
  this->mpc_Ui->pc_TableWidgetComIfSettings->SetToolTipHeadingAt(
      s32_COL_INTERFACE, Qt::Horizontal, "Interface",
      "Name of communication interface (CAN/ETHERNET).");

  this->mpc_Ui->pc_TableWidgetComIfSettings->SetToolTipHeadingAt(
      s32_COL_CONNECTION, Qt::Horizontal, "Linked to...",
      "Name of bus to which the interface is linked to.");

  this->mpc_Ui->pc_TableWidgetComIfSettings->SetToolTipHeadingAt(
      s32_COL_NODE_ID, Qt::Horizontal, "Node ID",
  ...
  this->mpc_Ui->pc_TableWidgetComIfSettings->SetToolTipHeadingAt(
      s32_COL_IP_ADDRESS, Qt::Horizontal, "IP Address",
  ...
  this->mpc_Ui->pc_TableWidgetComIfSettings->SetToolTipHeadingAt(
      s32_COL_UPDATE, Qt::Horizontal, "Usable for Update",
  ...
  this->mpc_Ui->pc_TableWidgetComIfSettings->SetToolTipHeadingAt(
      s32_COL_DIAGNOSTIC, Qt::Horizontal, "Usable for Dashboard",
  ...
  this->mpc_Ui->pc_TableWidgetComIfSettings->SetToolTipHeadingAt(
      s32_COL_ROUTING, Qt::Horizontal, "Usable for Routing",
...
void C_SdNdeNodePropertiesWidget::m_LoadFromData(void) {
  ...
  disconnect(this->mpc_Ui->pc_LineEditNodeName, &QLineEdit::editingFinished,
             this, &C_SdNdeNodePropertiesWidget::m_RegisterNameChange);
  disconnect(this->mpc_Ui->pc_TextEditComment, &QTextEdit::textChanged, this,
             &C_SdNdeNodePropertiesWidget::m_RegisterChange);
  disconnect(this->mpc_Ui->pc_TableWidgetComIfSettings,
  ...
  if (pc_Node != NULL) {
    ...
    // create delegate
    this->mpc_Ui->pc_TableWidgetComIfSettings->setItemDelegate(
        new C_SdNdeComIfSettingsTableDelegate(this, this->mu32_NodeIndex));
    ...
    if (pc_DevDef != NULL) {
      ...
      if (u32_SubDeviceIndex < pc_DevDef->c_SubDevices.size()) {
        ...
        // node name
        this->mpc_Ui->pc_LineEditNodeName->setText(
            C_PuiSdUtil::h_GetNodeBaseNameOrName(this->mu32_NodeIndex));

        // sub node info
        if (C_PuiSdHandler::h_GetInstance()->GetNodeSquadIndexWithNodeIndex(
                this->mu32_NodeIndex, u32_NodeSquadIndex) == C_NO_ERR) {
          // squad node
          this->mpc_Ui->pc_SubNodeInfoWidget->setVisible(true);
          this->mpc_Ui->pc_LabSubNodeName->setText(
              C_PuiSdUtil::h_GetSubNodeDeviceName(this->mu32_NodeIndex));
        } else {
          // no squad node
        ...
        // comment
        this->mpc_Ui->pc_TextEditComment->setText(
            pc_Node->c_Properties.c_Comment);

        // protocol
        if ((pc_DevDef->c_SubDevices[u32_SubDeviceIndex]
                 .q_FlashloaderOpenSydeEthernet == true) ||
            (pc_DevDef->c_SubDevices[u32_SubDeviceIndex]
                 .q_FlashloaderOpenSydeCan == true) ||
            (pc_DevDef->c_SubDevices[u32_SubDeviceIndex].q_FlashloaderStwCan ==
             true)) {
          if (pc_Node->c_Properties.e_FlashLoader ==
              C_OscNodeProperties::eFL_OPEN_SYDE) {
            // openSYDE
            this->mpc_Ui->pc_ComboBoxProtocol->setCurrentIndex(mu8_FL_INDEX_OS);
          } else if (pc_Node->c_Properties.e_FlashLoader ==
                     C_OscNodeProperties::eFL_STW) {
            // STW
            this->mpc_Ui->pc_ComboBoxProtocol->setCurrentIndex(
                mu8_FL_INDEX_STW);
            q_StwFlashloaderActive = true;
          } else {
            // having "none" as flashloader is supported by the device
          ...
          if (((pc_DevDef->c_SubDevices[u32_SubDeviceIndex]
            ...
            this->mpc_Ui->pc_ComboBoxProtocol->removeItem(
                mu8_FL_INDEX_NOSUPPORT);
          }
        } else {
          // not supported
          this->mpc_Ui->pc_ComboBoxProtocol->setCurrentIndex(
        ...
        this->mpc_Ui->pc_PushButtonFlashloaderOptions->setVisible(
            q_StwFlashloaderActive);

        // programming
        if (pc_DevDef->c_SubDevices[u32_SubDeviceIndex].q_ProgrammingSupport ==
            true) {
          this->mpc_Ui->pc_ComboBoxProgramming->setCurrentIndex(
              C_SdNdeNodePropertiesWidget::mhs32_PR_INDEX_ENABLED);
        } else {
          this->mpc_Ui->pc_ComboBoxProgramming->setCurrentIndex(
        ...
        // load device picture
        c_FileInfoDevImg.setFile(pc_DevDef->c_ImagePath);
        q_FileExists = (c_FileInfoDevImg.exists() && c_FileInfoDevImg.isFile());

        // check if file exists
        if (q_FileExists == true) {
          c_ImgNode.load(pc_DevDef->c_ImagePath);
          c_ImgNode = c_ImgNode.scaled(
              mu16_NODE_IMG_WIDTH,
              c_ImgNode.height(), // second parameter is not relevant
              Qt::KeepAspectRatio, Qt::SmoothTransformation);
          this->mpc_Ui->pc_LabelNoImageAvailable->setVisible(false);
          this->mpc_Ui->pc_DatapoolTypeImage->setAlignment(Qt::AlignVCenter |
                                                           Qt::AlignHCenter);
        } else {
          // no image available
          const QIcon c_Icon("://images/system_definition/Image_Grey.svg");
          c_ImgNode = c_Icon.pixmap(
              QSize(mu16_NODE_IMG_WIDTH / 2, mu16_NODE_IMG_WIDTH / 2));
          this->mpc_Ui->pc_LabelNoImageAvailable->setVisible(true);
          this->mpc_Ui->pc_DatapoolTypeImage->setAlignment(Qt::AlignBottom |
                                                           Qt::AlignHCenter);
        }

        // company logo and product page link
        if ((pc_DevDef->c_ManufacturerDisplayValue.isEmpty() == false) &&
            (pc_DevDef->c_ManufacturerDisplayValue !=
             "Sensor-Technik Wiedemann GmbH")) {
          QFileInfo c_FileInfoCompLogo;
          c_FileInfoCompLogo.setFile(pc_DevDef->c_CompanyLogoLink);
          q_FileExists =
              (c_FileInfoCompLogo.exists() && c_FileInfoCompLogo.isFile());

          if (q_FileExists == true) {
            QPixmap c_ImgCompLogo;
            c_ImgCompLogo.load(pc_DevDef->c_CompanyLogoLink);
            c_ImgCompLogo = c_ImgCompLogo.scaled(
                (c_ImgCompLogo.width() / 10), (c_ImgCompLogo.height() / 10),
                Qt::KeepAspectRatio, Qt::SmoothTransformation);
            this->mpc_Ui->pc_CompanyLogo->setPixmap(c_ImgCompLogo);
          }

          this->mpc_Ui->pc_LabelProductPageLink->SetLink(
              "Visit Product Page", pc_DevDef->c_ProductPageLink);
          this->mpc_Ui->pc_LabelProductPageLink->SetToolTipInformation(
              pc_DevDef->c_ManufacturerDisplayValue,
              pc_DevDef->c_ProductPageLink);
        ...
        this->mpc_Ui->pc_LabelNodeType->setText(pc_DevDef->GetDisplayName());

        // clear table
        this->mpc_Ui->pc_TableWidgetComIfSettings->setRowCount(0);

        // insert can+ethernet count of rows
        this->mpc_Ui->pc_TableWidgetComIfSettings->setRowCount(
...

        {
          ...
          const int32_t s32_MaxHeight =
              38 + (this->mpc_Ui->pc_TableWidgetComIfSettings->rowCount() * 40);
          // Minimum is slightly off the optimal value (3 rows are visible)
          const int32_t s32_MinHeight =
              38 +
              (std::min(3,
                        this->mpc_Ui->pc_TableWidgetComIfSettings->rowCount()) *
               40);
          this->mpc_Ui->pc_TableWidgetComIfSettings->setMinimumHeight(
              s32_MinHeight);
          this->mpc_Ui->pc_TableWidgetComIfSettings->setMaximumHeight(
              s32_MaxHeight);
        }
        ...
        for (uint8_t u8_ComIfCnt = 0;
          ...
          const int32_t s32_COL_INTERFACE = static_cast<int32_t>(
              C_SdNdeComIfSettingsTableDelegate::eINTERFACE);
          const int32_t s32_COL_CONNECTION = static_cast<int32_t>(
              C_SdNdeComIfSettingsTableDelegate::eCONNECTION);
          const int32_t s32_COL_NODE_ID =
              static_cast<int32_t>(C_SdNdeComIfSettingsTableDelegate::eNODEID);
          const int32_t s32_COL_IP_ADDRESS = static_cast<int32_t>(
              C_SdNdeComIfSettingsTableDelegate::eIPADDRESS);
          const int32_t s32_COL_UPDATE =
              static_cast<int32_t>(C_SdNdeComIfSettingsTableDelegate::eUPDATE);
          const int32_t s32_COL_ROUTING =
              static_cast<int32_t>(C_SdNdeComIfSettingsTableDelegate::eROUTING);
          const int32_t s32_COL_DIAGNOSTIC = static_cast<int32_t>(
          ...
          if (u8_ComIfCnt < pc_DevDef->u8_NumCanBusses) {
            q_IsUpdateAvailable =
                pc_DevDef->c_SubDevices[u32_SubDeviceIndex].IsUpdateAvailable(
                    C_OscSystemBus::eCAN);
            q_IsRoutingAvailable =
                pc_Node->IsRoutingAvailable(C_OscSystemBus::eCAN);
            q_IsDiagnosisAvailable =
                pc_DevDef->c_SubDevices[u32_SubDeviceIndex]
                    .IsDiagnosisAvailable(C_OscSystemBus::eCAN);
          } else {
            q_IsUpdateAvailable =
                pc_DevDef->c_SubDevices[u32_SubDeviceIndex].IsUpdateAvailable(
                    C_OscSystemBus::eETHERNET);
            q_IsRoutingAvailable =
                pc_Node->IsRoutingAvailable(C_OscSystemBus::eETHERNET);
            q_IsDiagnosisAvailable =
                pc_DevDef->c_SubDevices[u32_SubDeviceIndex]
                    .IsDiagnosisAvailable(C_OscSystemBus::eETHERNET);
          }
          ...
          // INTERFACE
           {
              C_OgeChxUnified * pc_CheckBox = new C_OgeChxUnified(this);
              pc_CheckBox->SetCheckBoxVariant("TransparentError");
              this->mpc_Ui->pc_TableWidgetComIfSettings->setCellWidget(
                  u8_ComIfCnt, s32_COL_INTERFACE, pc_CheckBox);
           }
          // disable
          this->mpc_Ui->pc_TableWidgetComIfSettings
              ->cellWidget(u8_ComIfCnt, s32_COL_INTERFACE)
              ->setEnabled(false);

          // set name
          if (u8_ComIfCnt < pc_DevDef->u8_NumCanBusses) {
            // its a CAN interface
            c_ComIfName = C_PuiSdUtil::h_GetInterfaceName(
                C_OscSystemBus::eCAN, static_cast<uint8_t>(u8_ComIfCnt));
          } else {
          ...
          dynamic_cast<C_OgeChxUnified *>(
              this->mpc_Ui->pc_TableWidgetComIfSettings->cellWidget(
                  u8_ComIfCnt, s32_COL_INTERFACE))
              ->setText(c_ComIfName);
          ...
          if (pc_Node->c_Properties.c_ComInterfaces[u8_ComIfCnt]
            ...
            const C_OscSystemBus *const pc_Bus =
                C_PuiSdHandler::h_GetInstance()->GetOscBus(
                    pc_Node->c_Properties.c_ComInterfaces[u8_ComIfCnt]
                        .u32_BusIndex);
            // get bus name
            if (pc_Bus != NULL) {
          ...
          if (c_BusName != "-") {
            this->mpc_Ui->pc_TableWidgetComIfSettings
                ...
                ->setEnabled(true);
            C_OgeWiUtil::h_ApplyStylesheetProperty(
                this->mpc_Ui->pc_TableWidgetComIfSettings->cellWidget(
                    u8_ComIfCnt, s32_COL_CONNECTION),
                "COMIF_TableCell_Hyperlink", true);
          }
          // if the node isn't connected to a bus, the link to bus definition
          // shall not work
          else {
            this->mpc_Ui->pc_TableWidgetComIfSettings
                ->cellWidget(u8_ComIfCnt, s32_COL_CONNECTION)
          ...
          /**********************************************************************************************************/
          // NODE ID
          this->mpc_Ui->pc_TableWidgetComIfSettings->setItem(
              u8_ComIfCnt, s32_COL_NODE_ID, new QTableWidgetItem(""));
          // align center
          this->mpc_Ui->pc_TableWidgetComIfSettings
              ->item(u8_ComIfCnt, s32_COL_NODE_ID)
          ...
          if (u8_ComIfCnt >= static_cast<int32_t>(pc_DevDef->u8_NumCanBusses)) {
            c_IpAddressString.append(QString::number(
                pc_Node->c_Properties.c_ComInterfaces[u8_ComIfCnt]
          ...
          if (u8_ComIfCnt < pc_DevDef->u8_NumCanBusses) {
            this->mpc_Ui->pc_TableWidgetComIfSettings
                ->cellWidget(u8_ComIfCnt, s32_COL_IP_ADDRESS)
                ->setEnabled(false);
          } else {
            this->mpc_Ui->pc_TableWidgetComIfSettings
                ->cellWidget(u8_ComIfCnt, s32_COL_IP_ADDRESS)
          ...
          if (pc_DevDef->u8_NumEthernetBusses == 0) {
            this->mpc_Ui->pc_TableWidgetComIfSettings->horizontalHeader()
                ->hideSection(static_cast<int32_t>(
                    C_SdNdeComIfSettingsTableDelegate ::eIPADDRESS));
          }
          ...
          // UPDATE
          this->mpc_Ui->pc_TableWidgetComIfSettings->setCellWidget(
              u8_ComIfCnt, s32_COL_UPDATE, ([]new C_OgeChxUnified(this)
    ->SetCheckBoxVariant("Tristate"), []0));
          // set node value
          if (q_IsUpdateAvailable == true) {
            // defensive move
            if ((pc_DevDef->u8_NumCanBusses) > 0) {
              // if Protocol Cbx is KEFEX and we got ETH interfaces update shall
              // be disabled
              if ((q_StwFlashloaderActive == true) &&
                  (u8_ComIfCnt >= (pc_DevDef->u8_NumCanBusses))) {
                this->mpc_Ui->pc_TableWidgetComIfSettings
          ...
          connect(dynamic_cast<C_OgeChxUnified *>(
                      this->mpc_Ui->pc_TableWidgetComIfSettings->cellWidget(
                          u8_ComIfCnt, s32_COL_UPDATE)),
          ...
          // ROUTING
          this->mpc_Ui->pc_TableWidgetComIfSettings->setCellWidget(
              u8_ComIfCnt, s32_COL_ROUTING, ([]new C_OgeChxUnified(this)
    ->SetCheckBoxVariant("Tristate"), []0));
          ...
          if (q_IsRoutingAvailable == true) {
            ...
            dynamic_cast<C_OgeChxUnified *>(
                this->mpc_Ui->pc_TableWidgetComIfSettings->cellWidget(
                    u8_ComIfCnt, s32_COL_ROUTING))
                ->setChecked(pc_Node->c_Properties.c_ComInterfaces[u8_ComIfCnt]
                                 .q_IsRoutingEnabled);
          ...
          // DIAGNOSTIC
          this->mpc_Ui->pc_TableWidgetComIfSettings->setCellWidget(
              u8_ComIfCnt, s32_COL_DIAGNOSTIC, ([]new C_OgeChxUnified(this)
    ->SetCheckBoxVariant("Tristate"), []0));
          ...
          if (q_IsDiagnosisAvailable == true) {
            ...
            dynamic_cast<C_OgeChxUnified *>(
                this->mpc_Ui->pc_TableWidgetComIfSettings->cellWidget(
                    u8_ComIfCnt, s32_COL_DIAGNOSTIC))
                ->setChecked(pc_Node->c_Properties.c_ComInterfaces[u8_ComIfCnt]
                                 .q_IsDiagnosisEnabled);
          } else {
            // disable
            this->mpc_Ui->pc_TableWidgetComIfSettings
          ...
          if (u8_ComIfCnt >= static_cast<int32_t>(pc_DevDef->u8_NumCanBusses)) {
            ...
            q_InterfaceIsConnected =
                pc_DevDef->c_SubDevices[u32_SubDeviceIndex].IsConnected(
                    C_OscSystemBus::eETHERNET,
                    static_cast<uint8_t>(
                        u8_ComIfCnt -
                        static_cast<int32_t>(pc_DevDef->u8_NumCanBusses)));
  ...
  // Initial check of the data. Row is irrelevant because all rows will be
  // checked of the column.
  this->m_CheckComInterface(
      0U, static_cast<int32_t>(C_SdNdeComIfSettingsTableDelegate::eNODEID));
  ...
  connect(this->mpc_Ui->pc_TextEditComment, &QTextEdit::textChanged, this,
          &C_SdNdeNodePropertiesWidget::m_RegisterChange);
  connect(this->mpc_Ui->pc_TableWidgetComIfSettings, &QTableWidget::cellChanged,
          this, &C_SdNdeNodePropertiesWidget::m_RegisterErrorChange);
  connect(this->mpc_Ui->pc_TableWidgetComIfSettings, &QTableWidget::cellChanged,
          this, &C_SdNdeNodePropertiesWidget::m_CheckComInterface);
  // lint -e{929} Cast required to avoid ambiguous signal of qt interface
  connect(this->mpc_Ui->pc_ComboBoxProtocol,
    ...
    if (pc_DevDef != NULL) {
      ...
      if (u32_SubDeviceIndex < pc_DevDef->c_SubDevices.size()) {
        ...
        if (C_PuiSdHandler::h_GetInstance()->CheckNodeNameAvailable(
                this->mpc_Ui->pc_LineEditNodeName->text(),
                &this->mu32_NodeIndex, NULL)) {
          ...
          if (C_PuiSdHandler::h_GetInstance()->GetNodeSquadIndexWithNodeIndex(
            ...
            if (pc_NodeSquad != NULL) {
              // name (base name)
              c_Name = pc_NodeSquad->c_BaseName;
            }
          } else {
            // name
        ...
        for (uint16_t u16_ComIfCnt = 0;
          ...
          const bool q_IsRoutingAvailable =
              pc_Node->IsRoutingAvailable(rc_CurInterface.e_InterfaceType);
          ...
          if (q_IsUpdateAvailable == true) {
            ...
            if (this->mpc_Ui->pc_TableWidgetComIfSettings
                    ->cellWidget(u16_ComIfCnt, s32_COL_UPDATE)
                    ->isEnabled() == true) {
              q_NewValue =
                  dynamic_cast<C_OgeChxUnified *>(
                      this->mpc_Ui->pc_TableWidgetComIfSettings->cellWidget(
                          u16_ComIfCnt, s32_COL_UPDATE))
                      ->isChecked();
            } else {
              q_NewValue = false;
            }
          ...
          if (q_IsRoutingAvailable == true) {
            // set state only if the cell is enabled (connected + available)
            if (this->mpc_Ui->pc_TableWidgetComIfSettings
                    ->cellWidget(u16_ComIfCnt, s32_COL_ROUTING)
                    ->isEnabled() == true) {
              q_NewValue =
                  dynamic_cast<C_OgeChxUnified *>(
                      this->mpc_Ui->pc_TableWidgetComIfSettings->cellWidget(
                          u16_ComIfCnt, s32_COL_ROUTING))
                      ->isChecked();
            } else {
              q_NewValue = false;
            }
          ...
          if (q_IsDiagnosisAvailable == true) {
            // set state only if the cell is enabled (connected + available)
            if (this->mpc_Ui->pc_TableWidgetComIfSettings
                    ->cellWidget(u16_ComIfCnt, s32_COL_DIAGNOSTIC)
                    ->isEnabled() == true) {
              q_NewValue =
                  dynamic_cast<C_OgeChxUnified *>(
                      this->mpc_Ui->pc_TableWidgetComIfSettings->cellWidget(
                          u16_ComIfCnt, s32_COL_DIAGNOSTIC))
                      ->isChecked();
            } else {
              q_NewValue = false;
            }
        ...
        // save new node
        C_PuiSdHandler::h_GetInstance()->SetOscNodePropertiesDetailed(
            this->mu32_NodeIndex, c_Name, c_Comment, e_DiagnosticServer,
            e_FlashLoader, c_NodeIds, c_UpdateFlags, c_RoutingFlags,
            c_DiagnosisFlags);
  ...
  if (pc_Node != NULL) {
    ...
    if (pc_DevDef != NULL) {
      for (uint16_t u16_ComIfCnt = 0U;
        ...
        C_OgeChxUnified *const pc_Tristate = dynamic_cast<C_OgeChxUnified *>(
            this->mpc_Ui->pc_TableWidgetComIfSettings->cellWidget(
                u16_ComIfCnt, s32_COL_ROUTING));
        C_OgeChxUnified *const pc_TristateUpdate =
            dynamic_cast<C_OgeChxUnified *>(
                this->mpc_Ui->pc_TableWidgetComIfSettings->cellWidget(
                    u16_ComIfCnt, s32_COL_UPDATE));
        ...
        if (pc_Tristate != NULL) {
          this->mpc_Ui->pc_TableWidgetComIfSettings
              ->cellWidget(u16_ComIfCnt, s32_COL_ROUTING)
              ->setEnabled(q_IsRoutingAvailable);
          ...
          // if protocol switches to opensyde enable and check update for eth
          // interfaces again
          else {
            this->mpc_Ui->pc_TableWidgetComIfSettings
                ->cellWidget(u16_ComIfCnt, s32_COL_UPDATE)
...
void C_SdNdeNodePropertiesWidget::m_CheckNodeName(void) {
  ...
  const bool q_NameIsUnique =
      C_PuiSdHandler::h_GetInstance()->CheckNodeNameAvailable(
          c_Text, &this->mu32_NodeIndex, NULL);
  const bool q_NameIsValid = C_OscUtils::h_CheckValidCeName(c_Text);

  // set invalid text property
  C_OgeWiUtil::h_ApplyStylesheetProperty(this->mpc_Ui->pc_LineEditNodeName,
                                         "Valid",
                                         q_NameIsUnique && q_NameIsValid);
  ...
  if ((q_NameIsUnique == true) && (q_NameIsValid == true)) {
    ...
    this->mpc_Ui->pc_LineEditNodeName->SetToolTipInformation(
        c_Heading, c_Content, C_NagToolTip::eERROR);
  }
...
void C_SdNdeNodePropertiesWidget::m_TrimNodeName(void) const {
  this->mpc_Ui->pc_LineEditNodeName->setText(
      this->mpc_Ui->pc_LineEditNodeName->text().trimmed());
}

//----------------------------------------------------------------------------------------------------------------------
/*! \brief   Register Change

   Function where ui elements register a change. Change will be sent via a
   signal
*/
//----------------------------------------------------------------------------------------------------------------------
...
/*! \brief  Register error change
   ...
   Function where ui elements register an error change. Change will be sent via
   a signal
*/
//----------------------------------------------------------------------------------------------------------------------
...
void C_SdNdeNodePropertiesWidget::m_RegisterNameChange(void) {
  ...
  if (hq_InProgress == false) {
    ...
    if (C_PuiSdHandler::h_GetInstance()->CheckNodeNameAvailable(
            this->mpc_Ui->pc_LineEditNodeName->text(), &this->mu32_NodeIndex,
            &c_ExistingNames) == false) {
      const QString c_Description =
          static_cast<QString>("A node with the name \"%1\" already exists. "
                               "Choose another name.")
      ...
      for (uint32_t u32_ItExistingName = 0UL;
           u32_ItExistingName < c_ExistingNames.size(); ++u32_ItExistingName) {
      ...
      if (pc_Node != NULL) {
        Q_EMIT(this->SigNameChanged("NETWORK TOPOLOGY",
                                    pc_Node->c_Properties.c_Name, false));
      }
    }
    hq_InProgress =
        false; // lint !e838 its static and could be used on strange second call
  }
}
//----------------------------------------------------------------------------------------------------------------------
...
*/
//----------------------------------------------------------------------------------------------------------------------
void C_SdNdeNodePropertiesWidget::m_CheckComInterface(
    const uint32_t ou32_Row, const uint32_t ou32_Column) const {
  const int32_t s32_COL_NODE_ID =
      static_cast<int32_t>(C_SdNdeComIfSettingsTableDelegate::eNODEID);
  const int32_t s32_COL_IP =
      static_cast<int32_t>(C_SdNdeComIfSettingsTableDelegate::eIPADDRESS);
  ...
  if ((ou32_Column == s32_COL_NODE_ID) || (ou32_Column == s32_COL_IP)) {
    ...
    for (s32_RowCounter = 0U;
         s32_RowCounter <
         this->mpc_Ui->pc_TableWidgetComIfSettings->model()->rowCount();
         ++s32_RowCounter) {
      // get node id from cell
      const uint8_t u8_NodeId =
          static_cast<uint8_t>(this->mpc_Ui->pc_TableWidgetComIfSettings
                                   ->item(s32_RowCounter, s32_COL_NODE_ID)
                                   ->text()
                                   .toInt());
      ...
      this->m_GetInterfaceStatus(this->mu32_NodeIndex, s32_RowCounter,
                                 u8_NodeId, c_IpBytes, q_IdValid, q_IpValid);

      // handle coloring of cell, when properties are conflicting
      this->m_HandlePropertyConflict(s32_RowCounter, s32_COL_NODE_ID,
                                     s32_COL_IP, q_IdValid, q_IpValid);
...
//----------------------------------------------------------------------------------------------------------------------
/*! \brief  Wrapper for core logic. Checks for id and ip collision on given
   interface.
...
void C_SdNdeNodePropertiesWidget::m_GetInterfaceStatus(
  ...
  orq_IdValid = C_PuiSdHandler::h_GetInstance()
                    ...
                    .CheckInterfaceIsAvailable(ou32_NodeIndex,
                                               os32_InterfaceIndex, ou8_NodeId);

  // check if ip is valid
  orq_IpValid =
      C_PuiSdHandler::h_GetInstance()
          ->GetOscSystemDefinitionConst()
          .CheckIpAddressIsValid(ou32_NodeIndex, os32_InterfaceIndex, orc_Ip);
}

//----------------------------------------------------------------------------------------------------------------------
/*! \brief  Function marks specified cell content red if a property is invalid
   (id/ip collision)
...
*/
//----------------------------------------------------------------------------------------------------------------------
void C_SdNdeNodePropertiesWidget::m_HandlePropertyConflict(
    const int32_t os32_Row, const int32_t os32_ColumnId,
  ...
  if (oq_IdValid == false) {
    ...
    this->mpc_Ui->pc_TableWidgetComIfSettings->model()->setData(
        this->mpc_Ui->pc_TableWidgetComIfSettings->model()->index(
            os32_Row, os32_ColumnId),
...
//----------------------------------------------------------------------------------------------------------------------
/*! \brief  Handles different error cases, sets tool-tip and error icon and
   prepares content for tool-tip
...
*/
//----------------------------------------------------------------------------------------------------------------------
void C_SdNdeNodePropertiesWidget::m_HandleErrorFeedback(
    const int32_t os32_InterfaceIndex, const bool oq_IdValid,
    const bool oq_IpValid) const {
  ...
  if ((oq_IdValid == true) && (oq_IpValid == true)) {
    ...
    const C_OscNode *const pc_Node =
        C_PuiSdHandler::h_GetInstance()->GetOscNodeConst(this->mu32_NodeIndex);
    if (pc_Node != NULL) {
      if (os32_InterfaceIndex <
          static_cast<int32_t>(pc_Node->c_Properties.c_ComInterfaces.size())) {
        ...
        if (rc_Interface.GetBusConnected() == true) {
          ...
          if (pc_Bus != NULL) {
            ...
            if ((oq_IdValid == false) && (oq_IpValid == true)) {
              ...
              c_TooltipContent = C_SdUtil::h_InitUsedIdsString(
                  c_UsedIds, pc_Bus->c_Name, "bus");
              this->mpc_Ui->pc_TableWidgetComIfSettings->SetToolTipAt(
                  os32_InterfaceIndex,
                  static_cast<uint32_t>(
                      C_SdNdeComIfSettingsTableDelegate ::eINTERFACE),
                  c_Heading, c_TooltipContent, C_NagToolTip::eERROR);
            }
            // only ips are conflicting
              ...
              c_TooltipContent =
                  C_SdUtil::h_InitUsedIpsString(c_Ips, pc_Bus->c_Name, "bus");
...
/*! \brief  Handle cell click
   ...
   Decides which column in Communication Interfaces Settings Table was clicked
   and which action to perform after click. If a IP-Address is clicked, a pop up
   to edit the IP-Address will show up. If a Bus-Bitrate was clicked, Tool jumps
   to "Edit Bus Properties" Screen.

   \param[in]  ou32_Row       Table Row
   \param[in]  ou32_Column    Table Column
*/
//----------------------------------------------------------------------------------------------------------------------
void C_SdNdeNodePropertiesWidget::m_HandleCellClick(
    const uint32_t ou32_Row, const uint32_t ou32_Column) {
  const int32_t s32_COL_IP_ADDRESS =
      static_cast<int32_t>(C_SdNdeComIfSettingsTableDelegate::eIPADDRESS);
  const int32_t s32_COL_BUS_BITRATE =
      static_cast<int32_t>(C_SdNdeComIfSettingsTableDelegate::eCONNECTION);
  const bool q_EnabledCellIp = this->mpc_Ui->pc_TableWidgetComIfSettings
                                   ->cellWidget(ou32_Row, s32_COL_IP_ADDRESS)
                                   ->isEnabled();
  const bool q_EnabledCellBus = this->mpc_Ui->pc_TableWidgetComIfSettings
                                    ->cellWidget(ou32_Row, s32_COL_BUS_BITRATE)
                                    ->isEnabled();

  if ((ou32_Column == s32_COL_IP_ADDRESS) && (q_EnabledCellIp == true)) {
    this->m_IpAddressClick(ou32_Row);
  } else if ((ou32_Column == s32_COL_BUS_BITRATE) &&
             (q_EnabledCellBus == true)) {
...
void C_SdNdeNodePropertiesWidget::m_IpAddressClick(const uint32_t ou32_Row) {
  ...
  if (pc_Node != NULL) {
    ...
    const QPointer<C_OgePopUpDialog> c_New =
        new C_OgePopUpDialog(this->parentWidget(), this->parentWidget());
    C_SdNdeIpAddressConfigurationWidget *const pc_Dialog =
        new C_SdNdeIpAddressConfigurationWidget(*c_New, this->mu32_NodeIndex,
                                                ou32_Row);
  ...
  } // lint !e429  //no memory leak because of the parent of pc_New and
    // pc_Dialog and the Qt memory management
}

//----------------------------------------------------------------------------------------------------------------------
/*! \brief  collects info about the bus, which got clicked in table and sends
 signal to change screen. Timer is needed

 *          to delay the signal, that a cell was clicked and the screen should
 change to bus properties. Without this
 *          opensyde crashes, because of unexpected behaviour of the table. It
 seems that the table still wants to
 *          perform actions after signal is out and screen is changed (while
 parent widget is already deleted).
...
//----------------------------------------------------------------------------------------------------------------------
/*! \brief  Slot for Timer::timeout to walk around the screen change on
 table-click.
...
void C_SdNdeNodePropertiesWidget::m_FlashloaderOptions(void) const {
  ...
  if (pc_Node != NULL) {
    const C_OscNodeStwFlashloaderSettings c_Copy =
        pc_Node->c_Properties.c_StwFlashloaderSettings;
    // Set parent for better hierarchy handling via window manager
    const QPointer<C_OgePopUpDialog> c_New =
        new C_OgePopUpDialog(this->parentWidget(), this->parentWidget());
    C_SdNdeStwFlashloaderOptions *const pc_Dialog =
        new C_SdNdeStwFlashloaderOptions(*c_New, this->mu32_NodeIndex);
    ...
    if (c_New->exec() != static_cast<int32_t>(QDialog::Accepted)) {
      // Revert
      C_PuiSdHandler::h_GetInstance()->SetStwFlashloaderSettings(
          this->mu32_NodeIndex, c_Copy);
    }
    // Hide overlay after dialog is not relevant anymore
    if (c_New.isNull() == false) {
      c_New->HideOverlay();
...
*/
//----------------------------------------------------------------------------------------------------------------------
void C_SdNdeNodePropertiesWidget::m_XappSupportChange(
    const int32_t os32_Index) {
  const bool q_IsXappSupported = (os32_Index == mhs32_PR_INDEX_ENABLED);
  bool q_Continue = true;
  const int32_t s32_ResetIndex = (os32_Index == mhs32_PR_INDEX_DISABLED)
                                     ? mhs32_PR_INDEX_ENABLED
                                     : mhs32_PR_INDEX_DISABLED;
  ...
  if (pc_Node != NULL) {
    for (uint32_t u32_ItApp = 0; u32_ItApp < pc_Node->c_Applications.size();
      ...
      if (rc_App.e_Type == C_OscNodeApplication::ePROGRAMMABLE_APPLICATION) {
        ...
        c_ConcernedDataBlocks.append(rc_App.c_Name);
      }
    }
  }
  ...
  if ((os32_Index == mhs32_PR_INDEX_DISABLED) && (pc_Node != NULL)) {
    if (pc_Node->c_DataLoggerJobs.size() > 0) {
      q_LogJobExists = true;
      for (uint32_t u32_ItLogJobs = 0;
           u32_ItLogJobs < pc_Node->c_DataLoggerJobs.size(); ++u32_ItLogJobs) {
        c_ConcernedLogJobs.append(
            pc_Node->c_DataLoggerJobs[u32_ItLogJobs].c_Properties.c_Name);
      }
    }
  }
