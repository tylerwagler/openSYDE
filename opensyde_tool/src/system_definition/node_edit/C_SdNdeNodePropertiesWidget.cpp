      ...
      if (u32_SubDeviceIndex < pc_DevDef->c_SubDevices.size()) {
        ...
        for (uint8_t u8_ComIfCnt = 0;
          ...
          this->mpc_Ui->pc_TableWidgetComIfSettings->setCellWidget(
              ...
              new C_OgeChxTristateTransparentError(this));
          // disable
          this->mpc_Ui->pc_TableWidgetComIfSettings
          ...
          dynamic_cast<C_OgeChxTristateTransparentError *>(
          ...
          // UPDATE
          this->mpc_Ui->pc_TableWidgetComIfSettings->setCellWidget(
              u8_ComIfCnt, s32_COL_UPDATE, new C_OgeChxTristate(this));
          // set node value
          ...
          // ROUTING
          this->mpc_Ui->pc_TableWidgetComIfSettings->setCellWidget(
              u8_ComIfCnt, s32_COL_ROUTING, new C_OgeChxTristate(this));
          ...
          // DIAGNOSTIC
          this->mpc_Ui->pc_TableWidgetComIfSettings->setCellWidget(
              u8_ComIfCnt, s32_COL_DIAGNOSTIC, new C_OgeChxTristate(this));
  ...
  if (pc_Node != NULL) {
    ...
    if (pc_DevDef != NULL) {
      for (uint16_t u16_ComIfCnt = 0U;
        ...
        C_OgeChxTristate *const pc_Tristate = dynamic_cast<C_OgeChxTristate *>(
            this->mpc_Ui->pc_TableWidgetComIfSettings->cellWidget(
                u16_ComIfCnt, s32_COL_ROUTING));
