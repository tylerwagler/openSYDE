...
*/
//----------------------------------------------------------------------------------------------------------------------
const QList<C_OscCanOpenManagerMappableSignal> * C_SdBueCoAddSignalsModel::m_GetMappableSignals() const
{
   const QList<C_OscCanOpenManagerMappableSignal> * pc_Retval = NULL;
