...
/*!
   \file
   \brief       openSYDE GUI precompiled header (header)

   To use this precompiled-header in a Qt project add the following to your .pro file:

   CONFIG   += precompile_header
   PRECOMPILED_HEADER = ../src/precomp_headers_gui.h
...
//lint -esym(766,"precomp_headers_gui.hpp")   effectively not used in lint "builds"; but that's exactly what we want
