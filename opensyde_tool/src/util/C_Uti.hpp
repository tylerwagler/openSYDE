...
public:
  ...
  static QString h_AdaptStringToSize(const QString &orc_String,
  ...
  static bool
  h_CheckKeyModifier(const Qt::KeyboardModifiers &orc_ActiveKeyModifiers,
                     const Qt::KeyboardModifier &ore_CheckKeyModifier);
  static bool h_CheckStyleState(const QStyle::State &orc_ActiveState,
  ...
  static QString
  h_CheckAndReplaceWithExePathIfNecessary(const QString &orc_Path);
  static QString h_GetLink(
      const QString &orc_DisplayedText,
  ...
  static QString h_MinimizePath(const QString &orc_Path, const QFont &orc_Font,
  ...
  static QString h_GetValueAsHex(const uint64_t ou64_Value,
                                 const uint8_t ou8_FieldWidth = 0);
  static QString h_GetValueAsHex(const uint32_t ou32_Value,
                                 const uint8_t ou8_FieldWidth = 0);
