   ...
   mpc_Ui(new Ui::C_NagMainWidget)
{
   ...
   connect(this->mpc_Ui->pc_LabelVersion, &C_OgeLabUnified::SigDoubleClicked, this, &C_NagMainWidget::m_OnEdit);
   connect(this->mpc_Ui->pc_LineEditVersion, &C_OgeLeUnified::editingFinished, this, &C_NagMainWidget::m_OnEditFinished);
...
void C_NagMainWidget::LoadInitialProject(void)
{
   ...
   C_PopErrorHandling::h_ProjectLoadErr(s32_Error, c_LoadedProject, this, u16_Version, QStringList(c_ErrorDetailsMissingDevices.begin(), c_ErrorDetailsMissingDevices.end()));
}
...
void C_NagMainWidget::m_OnEditFinished(void)
{
   ...
   C_PuiProject::h_GetInstance()->c_Version = c_NewVersion;
