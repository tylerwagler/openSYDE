...
private:
   ...
   static void mh_InitDatapoolElementsHalcConfigList(C_TblTreItem * const opc_ChannelItem, bool & orq_ChannelValid,
                                                     const std::vector<stw::opensyde_core::C_OscHalcDefStruct> & orc_Values, const stw::opensyde_core::C_OscNodeDataPoolList & orc_List, const uint32_t ou32_ChannelArrayIndex, const uint32_t ou32_NodeIndex, const uint32_t ou32_DpIndex, const uint32_t ou32_ListIndex, const uint32_t ou32_UseCase, uint32_t & oru32_Counter, const uint32_t ou32_RelevantChannelNumber, const bool oq_ChanNumVarNecessary, const bool oq_UseCaseVarNecessary, const bool oq_SafetyFlagVarNecessary, const bool oq_IsParam, const std::string & orc_DomainSingularName, const bool oq_ShowOnlyWriteElements, const bool oq_ShowArrayElements, const bool oq_ShowArrayIndexElements, const bool oq_Show64BitValues, const std::vector<C_PuiSvDbNodeDataPoolListElementId> * const opc_AlreasyUsedElements, const QString & orc_HalChannelOrDomainName, const bool oq_ShowStringElements);
