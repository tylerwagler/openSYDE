...
/*!
   ...
   Draws a colored border around the hovered row and paints icons via
   C_TblTreDelegateUtil::h_PaintIcon.
...
*/
//----------------------------------------------------------------------------------------------------------------------
C_TblHoverDelegate::C_TblHoverDelegate(QObject * const opc_Parent) :
...
*/
//----------------------------------------------------------------------------------------------------------------------
void C_TblHoverDelegate::paint(QPainter * const opc_Painter, const QStyleOptionViewItem & orc_Option,
...
*/
//----------------------------------------------------------------------------------------------------------------------
bool C_TblHoverDelegate::SetHoveredRow(const int32_t & ors32_Value)
{
   bool q_Retval;
...
*/
//----------------------------------------------------------------------------------------------------------------------
void C_TblHoverDelegate::SetModel(const QAbstractTableModel * const opc_Value)
{
