...
class C_CamProHandler : public QObject {
  Q_OBJECT
...
public:
  ...
  // Add
  void InsertMessage(const uint32_t ou32_Index,
  ...
  // Move
  void ReplaceDatabaseName(const QString &orc_PrevName,
                           const QString &orc_NewName);
  int32_t MoveMessage(const uint32_t ou32_StartIndex,
