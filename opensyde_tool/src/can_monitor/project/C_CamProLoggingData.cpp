...
{
   stw::scl::C_SclChecksums::CalcCRC32(this->c_FileName.toStdString(), this->c_FileName.length(),
                                       oru32_HashValue);
   stw::scl::C_SclChecksums::CalcCRC32(this->c_Directory.toStdString(), this->c_Directory.length(),
                                       oru32_HashValue);
