...
*/
//----------------------------------------------------------------------------------------------------------------------
void C_CamProHandlerFiler::h_Save(const C_CamProHandler &orc_Handler,
  ...
  Q_ASSERT(orc_XmlParser.SelectNodeParent() ==
           "opensyde-can-monitor-configuration");

  // messages
  orc_XmlParser.CreateAndSelectNodeChild("messages");
  orc_XmlParser.SetAttributeBool("cyclic-active",
                                 orc_Handler.GetCyclicMessageTransmitActive());
...
*/
//----------------------------------------------------------------------------------------------------------------------
int32_t C_CamProHandlerFiler::h_Load(C_CamProHandler &orc_Handler,
                                     C_OscXmlParserBase &orc_XmlParser) {
...
void C_CamProHandlerFiler::h_SaveMessages(
  ...
  for (uint32_t u32_ItMessage = 0UL; u32_ItMessage < orc_Messages.size();
    ...
    C_CamProHandlerFiler::h_SaveMessage(orc_Messages[u32_ItMessage],
                                        orc_XmlParser);
    // Return
...
*/
//----------------------------------------------------------------------------------------------------------------------
void C_CamProHandlerFiler::h_SaveMessage(const C_CamProMessageData &orc_Message,
                                         C_OscXmlParserBase &orc_XmlParser) {
  orc_XmlParser.SetAttributeBool("has-valid-hash",
                                 orc_Message.q_ContainsValidHash);
  ...
  orc_XmlParser.SetAttributeBool("do-cyclic-trigger",
                                 orc_Message.q_DoCyclicTrigger);
  orc_XmlParser.SetAttributeUint32("interval",
                                   orc_Message.u32_CyclicTriggerTime);
  orc_XmlParser.SetAttributeUint32("key-press-offset",
                                   orc_Message.u32_KeyPressOffset);
  orc_XmlParser.SetAttributeBool("auto-protocol-support",
                                 orc_Message.q_SetAutoSupportMode);
...
*/
//----------------------------------------------------------------------------------------------------------------------
int32_t C_CamProHandlerFiler::h_LoadMessage(C_CamProMessageData &orc_Message,
                                            C_OscXmlParserBase &orc_XmlParser) {
  int32_t s32_Retval = C_NO_ERR;

  if (orc_XmlParser.AttributeExists("has-valid-hash") == true) {
    orc_Message.q_ContainsValidHash =
        orc_XmlParser.GetAttributeBool("has-valid-hash");
  }
  ...
  if (orc_XmlParser.AttributeExists("DB1") == true) {
    orc_Message.c_Bytes[0] =
        static_cast<uint8_t>(orc_XmlParser.GetAttributeUint32("DB1"));
  } else {
    s32_Retval = C_CONFIG;
  }
  if (orc_XmlParser.AttributeExists("DB2") == true) {
    orc_Message.c_Bytes[1] =
        static_cast<uint8_t>(orc_XmlParser.GetAttributeUint32("DB2"));
  } else {
    s32_Retval = C_CONFIG;
  }
  if (orc_XmlParser.AttributeExists("DB3") == true) {
    orc_Message.c_Bytes[2] =
        static_cast<uint8_t>(orc_XmlParser.GetAttributeUint32("DB3"));
  } else {
    s32_Retval = C_CONFIG;
  }
  if (orc_XmlParser.AttributeExists("DB4") == true) {
    orc_Message.c_Bytes[3] =
        static_cast<uint8_t>(orc_XmlParser.GetAttributeUint32("DB4"));
  } else {
    s32_Retval = C_CONFIG;
  }
  if (orc_XmlParser.AttributeExists("DB5") == true) {
    orc_Message.c_Bytes[4] =
        static_cast<uint8_t>(orc_XmlParser.GetAttributeUint32("DB5"));
  } else {
    s32_Retval = C_CONFIG;
  }
  if (orc_XmlParser.AttributeExists("DB6") == true) {
    orc_Message.c_Bytes[5] =
        static_cast<uint8_t>(orc_XmlParser.GetAttributeUint32("DB6"));
  } else {
    s32_Retval = C_CONFIG;
  }
  if (orc_XmlParser.AttributeExists("DB7") == true) {
    orc_Message.c_Bytes[6] =
        static_cast<uint8_t>(orc_XmlParser.GetAttributeUint32("DB7"));
  } else {
    s32_Retval = C_CONFIG;
  }
  if (orc_XmlParser.AttributeExists("DB8") == true) {
    orc_Message.c_Bytes[7] =
        static_cast<uint8_t>(orc_XmlParser.GetAttributeUint32("DB8"));
  } else {
    s32_Retval = C_CONFIG;
  }
  if (orc_XmlParser.AttributeExists("do-cyclic-trigger") == true) {
    orc_Message.q_DoCyclicTrigger =
        orc_XmlParser.GetAttributeBool("do-cyclic-trigger");
  } else {
    s32_Retval = C_CONFIG;
  }
  if (orc_XmlParser.AttributeExists("interval") == true) {
    orc_Message.u32_CyclicTriggerTime =
        orc_XmlParser.GetAttributeUint32("interval");
  } else {
    s32_Retval = C_CONFIG;
  }
  if (orc_XmlParser.AttributeExists("key-press-offset") == true) {
    orc_Message.u32_KeyPressOffset =
        orc_XmlParser.GetAttributeUint32("key-press-offset");
  } else {
    s32_Retval = C_CONFIG;
  }
  if (orc_XmlParser.AttributeExists("auto-protocol-support") == true) {
    orc_Message.q_SetAutoSupportMode =
        orc_XmlParser.GetAttributeBool("auto-protocol-support");
  } else {
    // Default
...
*/
//----------------------------------------------------------------------------------------------------------------------
void C_CamProHandlerFiler::h_SaveSettings(const C_CamProHandler &orc_Handler,
                                          C_OscXmlParserBase &orc_XmlParser) {
  ...
  orc_XmlParser.SetNodeContent(
      orc_Handler.GetCustomCanDllPath());
  ...
  orc_XmlParser.SetAttributeBool("active",
                                 orc_Handler.GetFilterWidgetEnabled());
  ...
  C_CamProHandlerFiler::h_SaveDatabases(orc_Handler.GetDatabases(),
                                        orc_XmlParser);
  // Return
  orc_XmlParser.SelectNodeParent();
  ...
  C_CamProHandlerFiler::h_SaveLoggingConfig(orc_Handler.GetLoggingData(),
                                            orc_XmlParser);
  // Return
  orc_XmlParser.SelectNodeParent();
}
...
//----------------------------------------------------------------------------------------------------------------------
int32_t
C_CamProHandlerFiler::h_LoadSettings(C_CamProHandler &orc_Handler,
                                     C_OscXmlParserBase &orc_XmlParser) {
  ...
  if (orc_XmlParser.SelectNodeChild("can-dll-path") == "can-dll-path") {
    if (orc_XmlParser.AttributeExists("type")) {
      orc_Handler.SetCanDllType(static_cast<C_CamProHandler::E_CanDllType>(
          orc_XmlParser.GetAttributeSint32("type")));
    } else {
      s32_Return = C_CONFIG;
    }

    orc_Handler.SetCustomCanDllPath(orc_XmlParser.GetNodeContent());
  ...
  if ((s32_Return == C_NO_ERR) &&
      (orc_XmlParser.SelectNodeChild("filters") == "filters")) {
  ...
  // Logging
  if ((s32_Return == C_NO_ERR) &&
      (orc_XmlParser.SelectNodeChild("logging") == "logging")) {
...
void C_CamProHandlerFiler::h_SaveFilters(
  ...
  for (uint32_t u32_ItFilter = 0UL; u32_ItFilter < orc_Filters.size();
    ...
    C_CamProHandlerFiler::h_SaveFilter(orc_Filters[u32_ItFilter],
                                       orc_XmlParser);
    // Return
    orc_XmlParser.SelectNodeParent();
  }
...
*/
//----------------------------------------------------------------------------------------------------------------------
void C_CamProHandlerFiler::h_SaveFilter(const C_CamProFilterData &orc_Filter,
                                        C_OscXmlParserBase &orc_XmlParser) {
  ...
  orc_XmlParser.CreateNodeChild("comment",
                                orc_Filter.c_Comment);
  orc_XmlParser.CreateAndSelectNodeChild("filter-items");
  orc_XmlParser.SetAttributeUint32("length", orc_Filter.c_FilterItems.size());

  // filter items
  for (int32_t s32_ItFilterItem = 0UL;
       s32_ItFilterItem < orc_Filter.c_FilterItems.size(); ++s32_ItFilterItem) {
    orc_XmlParser.CreateAndSelectNodeChild("filter-item");
    C_CamProHandlerFiler::h_SaveFilterItem(
        orc_Filter.c_FilterItems[s32_ItFilterItem], orc_XmlParser);
    // Return
    orc_XmlParser.SelectNodeParent();
  }
...
*/
//----------------------------------------------------------------------------------------------------------------------
void C_CamProHandlerFiler::h_SaveFilterItem(
    const C_CamProFilterItemData &orc_FilterItem,
    C_OscXmlParserBase &orc_XmlParser) {
  orc_XmlParser.SetAttributeBool("active", orc_FilterItem.q_Enabled);
  orc_XmlParser.SetAttributeSint32("filter-type",
                                   static_cast<int32_t>(orc_FilterItem.e_Type));
  ...
  orc_XmlParser.SetAttributeBool(
      "extended-ID", static_cast<bool>(orc_FilterItem.u8_ExtendedId));
}
...
*/
//----------------------------------------------------------------------------------------------------------------------
int32_t C_CamProHandlerFiler::h_LoadFilter(C_CamProFilterData &orc_Filter,
                                           C_OscXmlParserBase &orc_XmlParser) {
  int32_t s32_Retval = C_NO_ERR;
  QString c_CurrentFilter;
  uint32_t u32_ExpectedSize = 0UL;
  ...
  if (orc_XmlParser.SelectNodeChild("name") == "name") {
    orc_Filter.c_Name = orc_XmlParser.GetNodeContent();
    // Return
  ...
  if (orc_XmlParser.SelectNodeChild("comment") == "comment") {
    orc_Filter.c_Comment = orc_XmlParser.GetNodeContent();
    // Return
    Q_ASSERT(orc_XmlParser.SelectNodeParent() == "filter");
  } else {
    s32_Retval = C_CONFIG;
  ...
  if ((s32_Retval == C_NO_ERR) && (q_ExpectedSizeHere == true)) {
    if (u32_ExpectedSize !=
        static_cast<uint32_t>(orc_Filter.c_FilterItems.size())) {
      QString c_Tmp =
...
*/
//----------------------------------------------------------------------------------------------------------------------
int32_t C_CamProHandlerFiler::h_LoadFilterItem(
    C_CamProFilterItemData &orc_FilterItem,
  ...
  if (orc_XmlParser.AttributeExists("filter-type") == true) {
    orc_FilterItem.e_Type = static_cast<C_CamProFilterItemData::E_Type>(
        orc_XmlParser.GetAttributeSint32("filter-type"));
  } else {
    s32_Retval = C_CONFIG;
  }
  ...
  if (orc_XmlParser.AttributeExists("extended-ID") == true) {
    // extended ID is traditionally uint8_t, but in fact it is either 0 or 1,
    // i.e. bool
    orc_FilterItem.u8_ExtendedId =
        static_cast<uint8_t>(orc_XmlParser.GetAttributeBool("extended-ID"));
  } else {
    s32_Retval = C_CONFIG;
  }
...
void C_CamProHandlerFiler::h_SaveDatabases(
  ...
  for (uint32_t u32_ItDatabase = 0UL; u32_ItDatabase < orc_Databases.size();
    ...
    C_CamProHandlerFiler::h_SaveDatabase(orc_Databases[u32_ItDatabase],
                                         orc_XmlParser);
    // Return
    orc_XmlParser.SelectNodeParent();
  }
...
*/
//----------------------------------------------------------------------------------------------------------------------
void C_CamProHandlerFiler::h_SaveDatabase(
    const C_CamProDatabaseData &orc_Database,
    C_OscXmlParserBase &orc_XmlParser) {
...
//----------------------------------------------------------------------------------------------------------------------
int32_t
C_CamProHandlerFiler::h_LoadDatabase(C_CamProDatabaseData &orc_Database,
                                     C_OscXmlParserBase &orc_XmlParser) {
  int32_t s32_Retval = C_NO_ERR;
  ...
  if (orc_XmlParser.SelectNodeChild("name") == "name") {
    orc_Database.c_Name = orc_XmlParser.GetNodeContent();
    // Return
...
*/
//----------------------------------------------------------------------------------------------------------------------
void C_CamProHandlerFiler::h_SaveLoggingConfig(
    const C_CamProLoggingData &orc_LoggingData,
    C_OscXmlParserBase &orc_XmlParser) {
  orc_XmlParser.SetAttributeBool("active", orc_LoggingData.q_Enabled);
  orc_XmlParser.SetAttributeSint32(
      "overwrite-mode", static_cast<int32_t>(orc_LoggingData.e_OverwriteMode));
  orc_XmlParser.SetAttributeString(
      "format",
      C_CamProLoggingData::h_FormatEnumToString(orc_LoggingData.e_FileFormat));
  orc_XmlParser.CreateNodeChild(
      "directory", orc_LoggingData.c_Directory);
  orc_XmlParser.CreateNodeChild(
      "file-name", orc_LoggingData.c_FileName);
}
...
//----------------------------------------------------------------------------------------------------------------------
int32_t
C_CamProHandlerFiler::h_LoadLoggingConfig(C_CamProLoggingData &orc_LoggingData,
                                          C_OscXmlParserBase &orc_XmlParser) {
  int32_t s32_Retval = C_NO_ERR;
  ...
  if (orc_XmlParser.AttributeExists("overwrite-mode") == true) {
    orc_LoggingData.e_OverwriteMode =
        static_cast<C_CamProLoggingData::E_OverwriteMode>(
            orc_XmlParser.GetAttributeSint32("overwrite-mode"));
  } else {
    s32_Retval = C_CONFIG;
  }

  if (orc_XmlParser.AttributeExists("format") == true) {
    orc_LoggingData.e_FileFormat = C_CamProLoggingData::h_FormatStringToEnum(
        orc_XmlParser.GetAttributeString("format"));
  } else {
    s32_Retval = C_CONFIG;
  }

  if (orc_XmlParser.SelectNodeChild("directory") == "directory") {
    orc_LoggingData.c_Directory = orc_XmlParser.GetNodeContent();
    // Return
  ...
  if (orc_XmlParser.SelectNodeChild("file-name") == "file-name") {
    orc_LoggingData.c_FileName = orc_XmlParser.GetNodeContent();
    // Return
    Q_ASSERT(orc_XmlParser.SelectNodeParent() == "logging");
  } else {
    s32_Retval = C_CONFIG;
