...
public:
   ...
   void Init(void);
   QList<std::array<QString, 2> > GetDataElements(const QModelIndex & orc_Index) const;
   ...
   QList<uint32_t> GetGenericRepresentationForIndex(const QModelIndex & orc_ItemIndex) const;
...
private:
   ...
   static void mh_CombineIndices(QList<std::array<QString, 2> > & orc_BigVectorToAppendTo,
