...
const QStringList C_FlaUtiStyleSheets::mhc_SCROLL_AREA_ELEMENTS(
    {"stw--opensyde_gui_elements--C_OgeTebStyled[variant=\"MessageDetails\"]",
...
const QList<C_FlaUtiStyleSheets::C_PropertyValueColorConfig>
    C_FlaUtiStyleSheets::mhc_SCROLL_BAR_PROPERTIES_SETTINGS_DARK_BLUE(
        {C_FlaUtiStyleSheets::C_PropertyValueColorConfig(
         ...
         C_FlaUtiStyleSheets::C_PropertyValueColorConfig(
             "::handle:pressed", "border-color", mc_STYLE_GUIDE_COLOR_11),
         C_FlaUtiStyleSheets::C_PropertyValueColorConfig(
             "::handle:!pressed", "background-color", mc_STYLE_GUIDE_COLOR_10),
         C_FlaUtiStyleSheets::C_PropertyValueColorConfig(
             "::handle:!pressed", "border-color", mc_STYLE_GUIDE_COLOR_10),

         C_FlaUtiStyleSheets::C_PropertyValueColorConfig(
             "::handle:hover", "background-color", mc_STYLE_GUIDE_COLOR_11),
         C_FlaUtiStyleSheets::C_PropertyValueColorConfig(
             "::handle:hover", "border-color", mc_STYLE_GUIDE_COLOR_11),
         C_FlaUtiStyleSheets::C_PropertyValueColorConfig(
             "::handle:!hover", "background-color", mc_STYLE_GUIDE_COLOR_10),
         C_FlaUtiStyleSheets::C_PropertyValueColorConfig(
    ...
    C_FlaUtiStyleSheets::mhc_SCROLL_BAR_PROPERTIES_BRIGHT(
        {C_FlaUtiStyleSheets::C_PropertyValueColorConfig(
         ...
         C_FlaUtiStyleSheets::C_PropertyValueColorConfig(
             ...
             static_cast<QColor>(Qt::transparent)),
         C_FlaUtiStyleSheets::C_PropertyValueColorConfig(
             "::handle:pressed", "background-color", mc_STYLE_GUIDE_COLOR_8),
         C_FlaUtiStyleSheets::C_PropertyValueColorConfig(
             "::handle:pressed", "border-color", mc_STYLE_GUIDE_COLOR_8),
         C_FlaUtiStyleSheets::C_PropertyValueColorConfig(
             "::handle:hover:!pressed", "background-color",
             mc_STYLE_GUIDE_COLOR_9),
         C_FlaUtiStyleSheets::C_PropertyValueColorConfig(
             "::handle:hover:!pressed", "border-color", mc_STYLE_GUIDE_COLOR_9),
         C_FlaUtiStyleSheets::C_PropertyValueColorConfig(
             "::handle", "background-color", mc_STYLE_GUIDE_COLOR_10),
         C_FlaUtiStyleSheets::C_PropertyValueColorConfig(
             "::handle", "border-color", mc_STYLE_GUIDE_COLOR_10),
         C_FlaUtiStyleSheets::C_PropertyValueColorConfig(
             "", "background-color", mc_STYLE_GUIDE_COLOR_11),
         C_FlaUtiStyleSheets::C_PropertyValueColorConfig(
             "::add-page", "background-color", mc_STYLE_GUIDE_COLOR_11),
         C_FlaUtiStyleSheets::C_PropertyValueColorConfig(
             "::sub-page", "background-color", mc_STYLE_GUIDE_COLOR_11),
         C_FlaUtiStyleSheets::C_PropertyValueColorConfig(
             "", "border-color", mc_STYLE_GUIDE_COLOR_11),
         C_FlaUtiStyleSheets::C_PropertyValueColorConfig(
...
const QList<C_FlaUtiStyleSheets::C_PropertyValueColorConfig>
    C_FlaUtiStyleSheets::mhc_SCROLL_BAR_PROPERTIES_DARK(
        {C_FlaUtiStyleSheets::C_PropertyValueColorConfig(
         ...
         C_FlaUtiStyleSheets::C_PropertyValueColorConfig(
             "::handle:hover:!pressed", "border-color",
             mc_STYLE_GUIDE_COLOR_35),
         C_FlaUtiStyleSheets::C_PropertyValueColorConfig(
             "::handle", "background-color", mc_STYLE_GUIDE_COLOR_39),
         C_FlaUtiStyleSheets::C_PropertyValueColorConfig(
             "::handle", "border-color", mc_STYLE_GUIDE_COLOR_39),
         C_FlaUtiStyleSheets::C_PropertyValueColorConfig(
             "", "background-color", mc_STYLE_GUIDE_COLOR_32),
         C_FlaUtiStyleSheets::C_PropertyValueColorConfig(
             "::add-page", "background-color", mc_STYLE_GUIDE_COLOR_32),
         C_FlaUtiStyleSheets::C_PropertyValueColorConfig(
             "::sub-page", "background-color", mc_STYLE_GUIDE_COLOR_32),
         C_FlaUtiStyleSheets::C_PropertyValueColorConfig(
             "", "border-color", mc_STYLE_GUIDE_COLOR_32),
         C_FlaUtiStyleSheets::C_PropertyValueColorConfig(
             "::add-page", "border-color", mc_STYLE_GUIDE_COLOR_32),
         C_FlaUtiStyleSheets::C_PropertyValueColorConfig(
             "::sub-page", "border-color", mc_STYLE_GUIDE_COLOR_32)});
...
*/
//----------------------------------------------------------------------------------------------------------------------
void C_FlaUtiStyleSheets::mh_AppendStylesheet(const QString &orc_File,
...
*/
//----------------------------------------------------------------------------------------------------------------------
void C_FlaUtiStyleSheets::mh_AppendScrollBarStyleSheets(
    QString &orc_Stylesheet) {
  mh_AppendScrollBarStyleSheet(
      C_FlaUtiStyleSheets::mhc_SCROLL_BAR_ELEMENTS_DARK,
      C_FlaUtiStyleSheets::mhc_SCROLL_BAR_PROPERTIES_DARK, orc_Stylesheet);
  mh_AppendScrollBarStyleSheet(
      C_FlaUtiStyleSheets::mhc_SCROLL_BAR_ELEMENTS_BRIGHT,
...
/*! \brief   Apply stylesheets for scroll bar
   ...
   \param[in]     orc_ScrollBarElements   Which elements to apply the
   stylesheets for
   \param[in]     orc_ScrollBarProperties Which stylesheets should be applied
   for these elements
   \param[in,out] orc_Stylesheet          Dynamic stylesheet document
*/
//----------------------------------------------------------------------------------------------------------------------
void C_FlaUtiStyleSheets::mh_AppendScrollBarStyleSheet(
  ...
  if ((orc_ScrollBarElements.size() > 0) &&
    ...
    orc_Stylesheet += "\n";
    // Each property
    for (uint32_t u32_ItProperty = 0;
         u32_ItProperty < orc_ScrollBarProperties.size(); ++u32_ItProperty) {
      QString c_Value;
      const C_FlaUtiStyleSheets::C_PropertyValueColorConfig &rc_Property =
          orc_ScrollBarProperties[u32_ItProperty];
      // Add elements
      for (uint32_t u32_ItElement = 0;
           u32_ItElement < orc_ScrollBarElements.size(); ++u32_ItElement) {
        QString c_Entry;
        const QString &rc_Element = orc_ScrollBarElements[u32_ItElement];
        c_Entry = static_cast<QString>("%1%2").arg(rc_Element,
                                                   rc_Property.c_PropertyName);
        if (u32_ItElement <
            (static_cast<uint32_t>(orc_ScrollBarElements.size()) - 1UL)) {
          c_Entry += ",";
        }
        c_Entry += "\n";
      ...
      c_Value = "{\n";
      // Add config
      c_Value += static_cast<QString>("%1:rgba(%2,%3,%4,%5);")
                     .arg(rc_Property.c_ValueName,
