   ...
   mrc_ParentDialog(orc_Parent)
{
   ...
   // connects
   connect(this->mpc_Ui->pc_PushButtonSave, &C_OgePubToolTipBase::clicked, this, &C_CamMetSettingsPopup::m_OnOk);
   connect(this->mpc_Ui->pc_PushButtonCancel, &C_OgePubToolTipBase::clicked, this, &C_CamMetSettingsPopup::m_OnCancel);
}
