...
protected:
   ...
   [[nodiscard]] static std::error_code mh_CheckCommonSecurityParameters(const std::vector<uint8_t> & orc_EncryptNodes,
   ...
   [[nodiscard]] static std::error_code mh_CalcDigest(const std::string & orc_SourcePath,
   ...
   [[nodiscard]] static std::error_code mh_AddFileToDigest(const std::string & orc_FilePath, C_OscSecurityEcdsa & orc_Signature);
   [[nodiscard]] static std::error_code mh_AddFileSectionToDigest(std::ifstream & orc_File, C_OscSecurityEcdsa & orc_Signature,
