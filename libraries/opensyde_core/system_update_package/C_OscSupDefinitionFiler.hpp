...
{
public:
   [[nodiscard]] static std::error_code h_CreateUpdatePackageDefFile(const std::string & orc_Path,
                                                                     const C_OscSupDefinition & orc_SupDefContent,
                                                                     const std::vector<std::string> & orc_Files,
                                                                     const bool oq_UseMinorVersion1);
   [[nodiscard]] static std::error_code h_LoadUpdatePackageDefFile(const std::string & orc_TargetUnzipPath, const bool oq_IsZip,
