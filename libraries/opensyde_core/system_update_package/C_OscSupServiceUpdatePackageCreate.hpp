...
{
public:
   [[nodiscard]] static std::error_code h_CreatePackageUsingPemFiles(const std::string & orc_PackagePath,
...
private:
   [[nodiscard]] static std::error_code mh_CheckSecurityParameters(const std::vector<uint8_t> & orc_EncryptNodes,
   ...
   [[nodiscard]] static std::error_code mh_CheckPemFileParameters(const std::vector<std::string> & orc_NodeSignaturePemFiles,
                                                                  const std::vector<uint8_t> & orc_SignatureNodes,
   ...
   [[nodiscard]] static std::error_code mh_SupDefParamAdapter(const uint32_t ou32_ActiveBusIndex,
                                                              const std::vector<uint8_t> & orc_ActiveNodes,
                                                              const std::vector<uint32_t> & orc_NodesUpdateOrder,
                                                              const std::vector<C_OscSuSequences::C_DoFlash> & orc_ApplicationsToWrite,
                                                              C_OscSupDefinition & orc_SupDefContent);

   [[nodiscard]] static std::error_code mh_GetUpdatePositionOfNode(const std::vector<uint32_t> & orc_NodesUpdateOrder,
   ...
   [[nodiscard]] static std::error_code mh_CreateDefFilesAndZipSecureFiles(const C_OscSystemDefinition & orc_SystemDefinition,
                                                                           C_OscSupDefinition & orc_SupDefContent,
   ...
   [[nodiscard]] static std::error_code mh_CreateNodesZip(const std::vector<std::set<std::string> > & orc_SecFiles,
   ...
   [[nodiscard]] static std::error_code mh_HandleNodeDefCreation(const std::vector<uint8_t> & orc_ActiveNodes,
   ...
   [[nodiscard]] static std::error_code mh_HandleSignatureCreation(const std::vector<std::string> & orc_NodeFoldersAbs,
                                                                   const std::vector<uint8_t> & orc_ActiveNodes,
                                                                   const std::vector<uint8_t> & orc_AddSignatureNodes,
                                                                   const std::vector<std::vector<uint8_t> > & orc_NodeSignatureKeys,
                                                                   const uint32_t ou32_NodeCount,
                                                                   std::vector<std::set<std::string> > & orc_SecFiles);
   [[nodiscard]] static std::error_code mh_CalcSig(const std::string & orc_SourcePath,
                                                   const std::set<std::string> & orc_SupFiles, const std::vector<uint8_t> & orc_Key,
                                                   std::string & orc_Signature);
   [[nodiscard]] static std::error_code mh_GetPemFileContent(const std::vector<uint8_t> & orc_ActiveNodes,
                                                             const std::vector<uint8_t> & orc_SignatureNodes,
