...
public:
   ...
   static int32_t h_ParseSimplestTypeValue(const std::string & orc_TypeStr,
                                           C_OscNodeDataPoolContent & orc_Content,
                                           const C_OscXmlParserBase & orc_XmlParser,
                                           const std::string & orc_AttributeName);
   static int32_t h_GetTypeForSimplestTypeString(const std::string & orc_TypeStr,
                                                 C_OscNodeDataPoolContent::E_Type & ore_Type,
                                                 const C_OscXmlParserBase & orc_XmlParser);
   static std::string h_GetTypeString(const C_OscNodeDataPoolContent::E_Type oe_Type);
   static int32_t h_SaveSimpleValueAsAttribute(const std::string & orc_Node,
...
private:
   ...
   static int32_t mh_CheckValidUint(const std::string & orc_Item);
   static int32_t mh_CheckValidSint(const std::string & orc_Item);
   static int32_t mh_CheckValidDouble(const std::string & orc_Item);
};
