...
public:
   ...
   bool CheckIdsUnique(std::vector<std::string> & orc_DuplicateIds) const;

   uint32_t u32_ContentVersion;
   std::string c_DeviceName;
   std::string c_FileString;              ///< Content of corresponding HALC definition as string
   std::string c_OriginalFileName;        ///< Original file name of corresponding HALC definition
