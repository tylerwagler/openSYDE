...
public:
   ...
   std::string c_Id;                                ///< Unique ID for later reference of this domain
   std::string c_Name;                              ///< Displayable plural name of domain
   std::string c_SingularName;                      ///< Displayable singular name of domain
