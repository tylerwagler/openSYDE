...
public:
   ...
   [[nodiscard]] std::error_code SetEnumValue(const std::string & orc_DisplayName);
   [[nodiscard]] std::error_code GetEnumValue(std::string & orc_DisplayName);
   ...
   [[nodiscard]] std::error_code GetBitmask(const std::string & orc_DisplayName, bool & orq_Value) const;
   [[nodiscard]] std::error_code SetBitmask(const std::string & orc_DisplayName, const bool oq_Value);

   [[nodiscard]] std::error_code SetStringValue(const std::string & orc_Value);
   [[nodiscard]] std::error_code GetStringValue(std::string & orc_Value) const;
