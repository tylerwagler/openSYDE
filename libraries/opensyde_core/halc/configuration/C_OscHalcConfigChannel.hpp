...
public:
   ...
   void HandleNameMaxCharLimit(const uint32_t ou32_NameMaxCharLimit, const std::string & orc_Type,
                               std::list<C_OscSystemNameMaxCharLimitChangeReportItem> * const opc_ChangedItems);

   std::string c_Name;                             ///< User configured name for this channel
   std::string c_Comment;                          ///< User configured description for this channel
