...
public:
   ...
   [[nodiscard]] std::error_code SetDomainConfig(const uint32_t ou32_Index, const C_OscHalcConfigDomain & orc_Domain);
   [[nodiscard]] std::error_code SetDomainChannelConfig(const uint32_t ou32_DomainIndex, const uint32_t ou32_ChannelIndex,
   ...
   [[nodiscard]] std::error_code ResetDomainChannelConfig(const uint32_t ou32_DomainIndex, const uint32_t ou32_ChannelIndex,
                                            const bool oq_UseChannelIndex);
   [[nodiscard]] std::error_code ResetDomainChannelUseCase(const uint32_t ou32_DomainIndex, const uint32_t ou32_ChannelIndex,
                                             const bool oq_UseChannelIndex);
   [[nodiscard]] std::error_code SetDomainChannelConfigName(const uint32_t ou32_DomainIndex, const uint32_t ou32_ChannelIndex,
                                              const bool oq_UseChannelIndex, const std::string & orc_Name);
   [[nodiscard]] std::error_code SetDomainChannelConfigComment(const uint32_t ou32_DomainIndex, const uint32_t ou32_ChannelIndex,
                                                 const bool oq_UseChannelIndex, const std::string & orc_Comment);
   [[nodiscard]] std::error_code SetDomainChannelConfigSafety(const uint32_t ou32_DomainIndex, const uint32_t ou32_ChannelIndex,
                                                const bool oq_UseChannelIndex, const bool oq_SafetyRelevant);
   [[nodiscard]] std::error_code SetDomainChannelConfigUseCase(const uint32_t ou32_DomainIndex, const uint32_t ou32_ChannelIndex,
                                                 const bool oq_UseChannelIndex, const uint32_t ou32_UseCaseIndex);
   [[nodiscard]] std::error_code SetDomainChannelParameterConfig(
   ...
   [[nodiscard]] std::error_code SetDomainChannelParameterConfigElement(
      const uint32_t ou32_DomainIndex, const uint32_t ou32_ChannelIndex, const uint32_t ou32_ParameterIndex,
   ...
   [[nodiscard]] std::error_code SetDomainChannelParameterConfigElementPlain(const uint32_t ou32_DomainIndex,
   ...
   [[nodiscard]] std::error_code SetDomainChannelParameterConfigElementEnum(const uint32_t ou32_DomainIndex,
                                                              const uint32_t ou32_ChannelIndex,
                                                              const uint32_t ou32_ParameterIndex,
                                                              const uint32_t ou32_ElementIndex,
                                                              const bool oq_UseChannelIndex,
                                                              const std::string & orc_DisplayName);
   [[nodiscard]] std::error_code SetDomainChannelParameterConfigElementBitmask(const uint32_t ou32_DomainIndex,
                                                                 const uint32_t ou32_ChannelIndex,
                                                                 const uint32_t ou32_ParameterIndex,
                                                                 const uint32_t ou32_ElementIndex,
                                                                 const bool oq_UseChannelIndex,
                                                                 const std::string & orc_DisplayName,
                                                                 const bool oq_Value);
   [[nodiscard]] std::error_code SetDomainChannelParameterConfigElementString(const uint32_t ou32_DomainIndex,
                                                                const uint32_t ou32_ChannelIndex,
                                                                const uint32_t ou32_ParameterIndex,
                                                                const uint32_t ou32_ElementIndex,
                                                                const bool oq_UseChannelIndex,
                                                                const std::string & orc_Value);
   [[nodiscard]] std::error_code GetRelevantIndicesForSelectedUseCase(const uint32_t ou32_DomainIndex,
