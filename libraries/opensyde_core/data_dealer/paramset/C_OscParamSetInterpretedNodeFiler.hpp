...
{
public:
   static std::error_code h_LoadInterpretedNode(C_OscParamSetInterpretedNode & orc_Node,
...
private:
   ...
   static std::error_code mh_LoadDataPools(std::vector<C_OscParamSetInterpretedDataPool> & orc_DataPools,
   ...
   static void mh_SaveDataPools(const std::vector<C_OscParamSetInterpretedDataPool> & orc_DataPools,
                                C_OscXmlParserBase & orc_XmlParser);
   static std::error_code mh_LoadDataPool(C_OscParamSetInterpretedDataPool & orc_DataPool,
                                          C_OscXmlParserBase & orc_XmlParser);
   static void mh_SaveDataPool(const C_OscParamSetInterpretedDataPool & orc_DataPool,
                               C_OscXmlParserBase & orc_XmlParser);

   static std::error_code mh_LoadLists(std::vector<C_OscParamSetInterpretedList> & orc_Lists,
                                       C_OscXmlParserBase & orc_XmlParser);
   static void mh_SaveLists(const std::vector<C_OscParamSetInterpretedList> & orc_Lists,
                            C_OscXmlParserBase & orc_XmlParser);
   static std::error_code mh_LoadList(C_OscParamSetInterpretedList & orc_List, C_OscXmlParserBase & orc_XmlParser);
   static void mh_SaveList(const C_OscParamSetInterpretedList & orc_List, C_OscXmlParserBase & orc_XmlParser);

   static std::error_code mh_LoadElements(std::vector<C_OscParamSetInterpretedElement> & orc_Elements,
                                          C_OscXmlParserBase & orc_XmlParser);
   static void mh_SaveElements(const std::vector<C_OscParamSetInterpretedElement> & orc_Elements,
                               C_OscXmlParserBase & orc_XmlParser);
   static std::error_code mh_LoadElement(C_OscParamSetInterpretedElement & orc_Element,
                                         C_OscXmlParserBase & orc_XmlParser);
