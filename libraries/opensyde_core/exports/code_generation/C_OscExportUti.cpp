...
*/
//----------------------------------------------------------------------------------------------------------------------
std::string C_OscExportUti::h_GetSectionSeparator(const std::string & orc_SectionName)
{
   std::string c_Return;
...
*/
//----------------------------------------------------------------------------------------------------------------------
std::string C_OscExportUti::h_GetHeaderSeparator(void)
{
   const std::string c_Return =
      "//--------------------------------------------------------------------------------------------------------------"
      "--------";
...
*/
//----------------------------------------------------------------------------------------------------------------------
std::string C_OscExportUti::h_GetCreationToolInfo(const std::string & orc_ExportToolInfo)
{
...
*/
//----------------------------------------------------------------------------------------------------------------------
std::error_code C_OscExportUti::h_SaveToFile(stw::scl::C_SclStringList & orc_Data, const std::string & orc_Path,
...
*/
//----------------------------------------------------------------------------------------------------------------------
void C_OscExportUti::h_CollectFilePaths(std::vector<std::string> & orc_FilePaths, const std::string & orc_Path,
                                        const std::string & orc_FileName, const bool oq_SourceCode)
{
...
*/
//----------------------------------------------------------------------------------------------------------------------
std::string C_OscExportUti::h_GetTypePrefix(const C_OscNodeDataPoolContent::E_Type oe_Type, const bool oq_IsArray)
{
   std::string c_Prefix;
...
*/
//----------------------------------------------------------------------------------------------------------------------
std::string C_OscExportUti::h_GetElementTypeAsString(const C_OscNodeDataPoolContent::E_Type oe_Type)
{
   std::string c_Retval;
...
*/
//----------------------------------------------------------------------------------------------------------------------
std::string C_OscExportUti::h_GetElementCeName(const std::string & orc_Name, const bool oq_IsArray,
                                               const C_OscNodeDataPoolContent::E_Type oe_Type,
                                               const std::string & orc_ArrayPos)
{
   std::string c_Return = C_OscExportUti::h_GetTypePrefix(oe_Type, oq_IsArray) + "_" + orc_Name;
...
*/
//----------------------------------------------------------------------------------------------------------------------
bool C_OscExportUti::h_CheckInfOrNan(const std::string & orc_String)
{
   bool q_Return;

    if ((PosCompat(LowerCaseCompat(orc_String), "inf") > 0) || (PosCompat(LowerCaseCompat(orc_String), "nan") > 0))
   {
      q_Return = true;
   }
   else
...
*/
//----------------------------------------------------------------------------------------------------------------------
void C_OscExportUti::h_AddDecimalPointIfNone(std::string & orc_FloatString)
{
   if (PosCompat(orc_FloatString, ".") == 0)
   {
      if (PosCompat(orc_FloatString, "e") > 0)
      {
         InsertCompat(orc_FloatString, ".0", PosCompat(orc_FloatString, "e"));
      }
      else
      {
         orc_FloatString += ".0";
