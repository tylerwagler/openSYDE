...
{
public:
   [[nodiscard]] static std::error_code h_LoadFile(C_OscXceManifest & orc_Config, const std::string & orc_Path);
   [[nodiscard]] static std::error_code h_SaveFile(const C_OscXceManifest & orc_Config, const std::string & orc_Path);
   [[nodiscard]] static std::error_code h_LoadData(C_OscXceManifest & orc_Config, C_OscXmlParserBase & orc_XmlParser);
...
private:
   ...
   [[nodiscard]] static std::error_code mh_LoadUpdatePackageParameters(std::vector<C_OscXceUpdatePackageParameters> & orc_Config,
                                                                       C_OscXmlParserBase & orc_XmlParser);
   static void mh_SaveUpdatePackageParameters(const std::vector<C_OscXceUpdatePackageParameters> & orc_Config,
                                              C_OscXmlParserBase & orc_XmlParser);
   [[nodiscard]] static std::error_code mh_LoadUpdatePackageParameter(C_OscXceUpdatePackageParameters & orc_Config,
