...
{
public:
   [[nodiscard]] static std::error_code h_Import(const std::string & orc_FilePath, const uint8_t ou8_NodeId,
   ...
   [[nodiscard]] static std::error_code h_ParseSignalContent(const std::map<uint16_t,
...
private:
   ...
   [[nodiscard]] static std::error_code mh_ParseMessages(const uint32_t ou32_StartingId, const uint8_t ou8_NodeId, const std::map<uint16_t,
   ...
   [[nodiscard]] static std::error_code mh_DoesInformationDirectionMatchToParsedMessages(const uint32_t ou32_StartingId,
   ...
   [[nodiscard]] static std::error_code mh_ParseMessageContent(const uint32_t ou32_StartingId, const uint8_t ou8_NodeId,
   ...
   [[nodiscard]] static std::error_code mh_LoadMessageTransmissionType(const uint32_t ou32_StartingId, const uint32_t ou32_ItMessage,
                                                                       const uint8_t ou8_NodeId, const std::map<uint16_t,
   ...
   [[nodiscard]] static std::error_code mh_ParseSignals(const uint32_t ou32_CoMessageId, const uint16_t ou16_MappingOffset,
                                                        const uint8_t ou8_NodeId, const std::map<uint16_t,
                                                        C_OscCanOpenObject> & orc_CoObjects,
                                                        const std::vector<uint32_t> & orc_Dummies,
   ...
   [[nodiscard]] static std::error_code mh_GetIntegerValue(const std::string & orc_CoValue, const uint8_t ou8_NodeId,
                                                           uint32_t & oru32_Value, bool * const opq_IncludesNodeId = nullptr);
   [[nodiscard]] static std::error_code mh_GetUnsigned64IntegerValue(const std::string & orc_CoValue, int32_t & ors32_Value);
   [[nodiscard]] static std::error_code mh_Get64IntegerValue(const std::string & orc_CoValue, int64_t & ors64_Value);
   [[nodiscard]] static std::error_code mh_GetIntegerValueSimple(const std::string & orc_CoValue, uint32_t & oru32_Value);
   ...
   [[nodiscard]] static std::error_code mh_CalcMinMaxInit(const C_OscCanOpenObjectData * const opc_CoSignalObject,
