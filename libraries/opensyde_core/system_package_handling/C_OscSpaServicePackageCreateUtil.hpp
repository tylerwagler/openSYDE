...
{
public:
   [[nodiscard]] static std::error_code h_CheckPackagePathParam(const std::string & orc_PackagePath,
   ...
   [[nodiscard]] static std::error_code h_CreateTempFolderAndSubFolders(const std::string & orc_PackagePath,
                                                                        const std::string & orc_TemporaryDirectory,
                                                                        const std::string & orc_UseCase,
                                                                        const std::string & orc_PackageExtension,
                                                                        const std::string & orc_TemporaryPackageExtension,
   ...
   [[nodiscard]] static std::error_code h_SaveSystemDefinition(const C_OscSystemDefinition & orc_SystemDefinition,
                                                               ...
                                                               std::string & orc_ErrorMessage);
   [[nodiscard]] static std::error_code h_SaveDeviceDefinitionsAndIni(const C_OscSystemDefinition & orc_SystemDefinition,
                                                                      const std::string & orc_UseCase,
                                                                      const std::string & orc_UsedTempPath,
                                                                      const std::string & orc_OutFilePrefix,
                                                                      std::set<std::string> & orc_AllCreatedFiles,
                                                                      std::string & orc_ErrorMessage);
   [[nodiscard]] static std::error_code h_CreateZip(const std::string & orc_UseCase, const std::string & orc_UsedTempPath,
