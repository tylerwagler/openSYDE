...
public:
   ...
   // Utilities
   static int32_t h_StringToSecurityOptionDebugger(const std::string & orc_String,
                                                   C_OscViewNodeUpdate::E_StateDebugger & ore_State);
   static int32_t h_StringToSecurityOptionAuthentication(const std::string & orc_String,
                                                         C_OscViewNodeUpdate::E_StateSecureAuthentication & ore_State);
   static int32_t h_StringToSecurityOptionEncryption(const std::string & orc_String,
...
private:
   ...
   static int32_t mh_LoadNodeUpdateInformationSecurityStates(C_OscViewNodeUpdate & orc_NodeUpdateInformation,
                                                             C_OscXmlParserBase & orc_XmlParser);
   static int32_t mh_LoadViewFileOsc(C_OscViewData & orc_View, const std::string & orc_FilePath,
                                     const std::vector<stw::opensyde_core::C_OscNode> & orc_OscNodes);
