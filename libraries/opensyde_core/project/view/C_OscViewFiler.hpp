...
public:
   ...
   // Load
   [[nodiscard]] static std::error_code h_LoadSystemViewsFile(std::vector<C_OscViewData> & orc_Views,
                                                const std::string & orc_PathSystemViews,
                                                const std::vector<C_OscNode> & orc_OscNodes);
   [[nodiscard]] static std::error_code h_LoadViewsOsc(std::vector<C_OscViewData> & orc_Views,
                                         const std::vector<C_OscNode> & orc_OscNodes,
                                         C_OscXmlParserBase & orc_XmlParser, const std::string & orc_BasePath);
   [[nodiscard]] static std::error_code h_LoadViewOsc(C_OscViewData & orc_View,
   ...
   // Utilities
   [[nodiscard]] static std::error_code h_StringToSecurityOptionDebugger(const std::string & orc_String,
                                                           C_OscViewNodeUpdate::E_StateDebugger & ore_State);
   [[nodiscard]] static std::error_code h_StringToSecurityOptionAuthentication(
      const std::string & orc_String, C_OscViewNodeUpdate::E_StateSecureAuthentication & ore_State);
   [[nodiscard]] static std::error_code h_StringToSecurityOptionEncryption(const std::string & orc_String,
...
private:
   // Load
   [[nodiscard]] static std::error_code mh_LoadNodeActiveFlags(std::vector<uint8_t> & orc_NodeActiveFlags,
                                                 C_OscXmlParserBase & orc_XmlParser);
   [[nodiscard]] static std::error_code mh_LoadNodeUpdateInformation(std::vector<C_OscViewNodeUpdate> & orc_NodeUpdateInformation,
                                                       C_OscXmlParserBase & orc_XmlParser,
                                                       const std::vector<C_OscNode> & orc_OscNodes);
   ...
   static void mh_LoadNodeUpdateInformationPaths(std::vector<std::string> & orc_Paths,
                                                 ...
                                                 C_OscXmlParserBase & orc_XmlParser);
   [[nodiscard]] static std::error_code mh_LoadOneNodeUpdateInformation(C_OscViewNodeUpdate & orc_NodeUpdateInformation,
                                                          C_OscXmlParserBase & orc_XmlParser,
   ...
   static void mh_LoadNodeUpdateInformationSkipUpdateOfFiles(std::vector<bool> & orc_Flags,
                                                             C_OscXmlParserBase & orc_XmlParser);
   [[nodiscard]] static std::error_code mh_LoadNodeUpdateInformationSecurity(C_OscViewNodeUpdate & orc_NodeUpdateInformation,
                                                               C_OscXmlParserBase & orc_XmlParser);
   [[nodiscard]] static std::error_code mh_LoadNodeUpdateInformationSecurityStates(C_OscViewNodeUpdate & orc_NodeUpdateInformation,
                                                                     C_OscXmlParserBase & orc_XmlParser);
   [[nodiscard]] static std::error_code mh_LoadViewFileOsc(C_OscViewData & orc_View, const std::string & orc_FilePath,
                                             const std::vector<stw::opensyde_core::C_OscNode> & orc_OscNodes);
