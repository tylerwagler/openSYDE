...
public:
   ...
   ///load functions
   static int32_t h_LoadDataPoolFile(C_OscNodeDataPool & orc_NodeDataPool, const std::string & orc_FilePath);
   ...
   static int32_t h_StringToDataPool(const std::string & orc_String, C_OscNodeDataPool::E_Type & ore_Type);

   static void h_SaveDataPoolElementType(const C_OscNodeDataPoolContent & orc_NodeDataPoolContent,
                                         C_OscXmlParserBase & orc_XmlParser);
   static void h_SaveDataPoolElementValue(const std::string & orc_NodeName,
...
private:
   ...
   static int32_t mh_StringToNodeDataPoolContent(const std::string & orc_String,
   ...
   static int32_t mh_StringToNodeDataPoolElementAccess(const std::string & orc_String,
