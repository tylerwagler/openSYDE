...
{
public:
   static int32_t h_LoadNodeFile(C_OscNode & orc_Node, const std::string & orc_FilePath,
   ...
   static int32_t h_SaveNodeFile(const C_OscNode & orc_Node, const std::string & orc_FilePath,
...
private:
   ...
   static int32_t mh_StringToDiagnosticServer(const std::string & orc_String,
   ...
   static std::string mh_FlashLoaderToString(const C_OscNodeProperties::E_FlashLoaderProtocol &
                                                       ore_FlashLoader);
   static int32_t mh_StringToFlashLoader(const std::string & orc_String,
   ...
   static int32_t mh_StringToMaxServiceSizeModeType(const std::string & orc_String,
