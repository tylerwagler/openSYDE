...
*/
//----------------------------------------------------------------------------------------------------------------------
C_OscNodeDataPool h_MakeDataPool(const C_OscNodeDataPool::E_Type oe_Type)
{
...
*/
//----------------------------------------------------------------------------------------------------------------------
C_OscCanProtocol h_MakeProtocol(const C_OscCanProtocol::E_Type oe_Type)
{
...
template <typename T>
void h_ExpectSameHash(const T & orc_Source, const T & orc_Target, const std::string & orc_What)
{
   uint32_t u32_A = 0xFFFFFFFFUL;
   uint32_t u32_B = 0xFFFFFFFFUL;
...
C_OscNode h_MakeNode(const std::string & orc_Name, const uint8_t ou8_NodeId, const uint32_t ou32_BusIndex)
{
   C_OscNode c_Node;
...
namespace
{
C_OscHalcDefElement h_MakeHalcU16(const std::string & orc_Id, const uint16_t ou16_Initial, const uint16_t ou16_Min,
...
C_OscHalcDefDomain h_MakeHalcDomain(void)
{
...
void h_FillHalcBase(C_OscHalcDefBase & orc_Base)
{
...
void h_ExpectSameChannelConfig(const C_OscHalcConfigChannel & orc_S, const C_OscHalcConfigChannel & orc_T,
