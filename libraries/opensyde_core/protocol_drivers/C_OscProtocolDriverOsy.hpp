...
public:
   ...
   int32_t OsyReadDeviceName(stw::scl::C_SclString & orc_DeviceName, uint8_t * const opu8_NrCode = nullptr);
   int32_t OsyReadApplicationName(stw::scl::C_SclString & orc_ApplicationName, uint8_t * const opu8_NrCode = nullptr);
