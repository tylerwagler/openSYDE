...
private:
   ...
   public:
      ...
      [[nodiscard]] std::error_code DecodeHeader(const std::vector<uint8_t> & orc_Header);
...
public:
   ...
   [[nodiscard]] std::error_code SetDispatcher(C_OscIpDispatcher * const opc_Dispatcher, const uint32_t ou32_DispatcherHandle);
   ...
   [[nodiscard]] std::error_code BroadcastGetDeviceInfo(
   ...
   [[nodiscard]] std::error_code BroadcastNetReset(const uint8_t ou8_ResetType, const bool oq_SpecificSerialNumberOnly = false,
