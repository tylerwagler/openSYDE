...
public:
   ...
   static void h_SetScaledValueInContent(const double of64_ScaledValue,
                                         stw::opensyde_core::C_OscNodeDataPoolContent & orc_Content,
   ...
   static stw::opensyde_core::C_OscNodeDataPoolContent::E_Type h_GetMinimumTypeForRange(const double of64_Min,
   ...
   static void h_GetValueAsScaledString(const stw::opensyde_core::C_OscNodeDataPoolContent & orc_Content,
                                        const double of64_Factor, const double of64_Offset, QString & orc_Output,
