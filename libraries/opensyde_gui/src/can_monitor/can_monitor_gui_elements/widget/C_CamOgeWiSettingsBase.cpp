...
*/
//----------------------------------------------------------------------------------------------------------------------
C_OgePubToolTipBase * C_CamOgeWiSettingsBase::mh_GetButton(const QPair<C_CamMosSectionPopup *,
                                                                          C_OgePubToolTipBase *> & orc_Pair)
{
...
void C_CamOgeWiSettingsBase::m_PrepareMove() const
{
   for (std::vector<QPair<stw::opensyde_gui::C_CamMosSectionPopup *,
                          opensyde_gui_elements::C_OgePubToolTipBase *> >::const_iterator c_ItPair =
...
void C_CamOgeWiSettingsBase::m_InitSettingsSection(C_CamMosSectionPopup * const opc_PopUp,
                                                   C_OgePubToolTipBase * const opc_Button,
                                                   const QWidget * const opc_Parent, const QString & orc_Icon)
{
   const QPair<stw::opensyde_gui::C_CamMosSectionPopup *,
               opensyde_gui_elements::C_OgePubToolTipBase *> c_Pair(opc_PopUp, opc_Button);
   ...
   connect(opc_Button, &C_OgePubToolTipBase::toggled, this, &C_CamOgeWiSettingsBase::m_ShowAnyPopup);
}
...
*/
//----------------------------------------------------------------------------------------------------------------------
void C_CamOgeWiSettingsBase::mh_InitSettingsButton(C_OgePubToolTipBase & orc_Button, const QString & orc_Icon)
{
...
void C_CamOgeWiSettingsBase::m_ShowPopup(C_CamMosSectionPopup * const opc_Popup,
                                         const C_OgePubToolTipBase * const opc_Button) const
{
...
*/
//----------------------------------------------------------------------------------------------------------------------
QPoint C_CamOgeWiSettingsBase::m_GetPopupMovePoint(const C_OgePubToolTipBase * const opc_Button) const
{
