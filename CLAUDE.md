...
31 suites, 338 tests: `test_application_info_block`, `test_canopen_eds`,
...
`test_filer_roundtrip`, `test_hex_file`, `test_hex_string_parsing`, `test_logging`,
`test_md5`, `test_node_datapool_content`, `test_osc_error_category`,
...
`test_tgl_file`, `test_tgl_time`, `test_view_security_options`, `test_xml_float_locale`,
`test_xml_parser`.
